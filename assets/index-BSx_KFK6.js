...
`)+`
`+p);const M=b+g+s,_=b+p+a,I=zm(r,r.VERTEX_SHADER,M),D=zm(r,r.FRAGMENT_SHADER,_);r.attachShader(v,I),r.attachShader(v,D),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function B(T){if(t.debug.checkShaderErrors){const C=r.getProgramInfoLog(v)||"",X=r.getShaderInfoLog(I)||"",E=r.getShaderInfoLog(D)||"",k=C.trim(),R=X.trim(),N=E.trim();let O=!0,$=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(O=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,I,D);else{const G=$m(r,I,"vertex"),ne=$m(r,D,"fragment");_t("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
`}return te}),l=Re(()=>fu[n.def.category]?.color||"#888"),u=Re(()=>n.def.params?Object.values(n.def.params).some(te=>te.type==="float"||te.type==="int"):!1);function c(){if(n.def.params){for(const[te,L]of Object.entries(n.def.params))if(L.type==="float"||L.type==="int"){const j=te==="value"&&n.params.min!==void 0?n.params.min:L.min!==void 0?L.min:0,Q=te==="value"&&n.params.max!==void 0?n.params.max:L.max!==void 0?L.max:1,fe=n.params[`_randMin_${te}`]??j,Se=n.params[`_randMax_${te}`]??Q;let Te=fe+Math.random()*(Se-fe);L.type==="int"?Te=Math.floor(Te):L.step&&(Te=Math.round(Te/L.step)*L.step),i("paramChange",te,Te)}}}const d=Ce(null),f=Ce(!1),h=Ce(null),m=Re(()=>!!h.value);mn(()=>{if((n.nodeType==="imageInput"||n.nodeType==="uiImageSlot")&&!h.value){const te="/default_img.jpg";h.value=te;const L=new Image;L.crossOrigin="anonymous",L.src=te,L.onload=()=>{i("imageLoaded",{url:te,width:L.naturalWidth,height:L.naturalHeight,img:L})}}});const v=Ce(null),g=Ce([]),p=Ce(null);lt(()=>r.previewImages[n.nodeId],te=>{if(n.nodeType!=="preview"||!te||!p.value)return;const L=p.value,j=L.getContext("2d");(L.width!==te.width||L.height!==te.height)&&(L.width=te.width,L.height=te.height);const Q=document.createElement("canvas");Q.width=te.width,Q.height=te.height;const fe=Q.getContext("2d"),Se=new ImageData(new Uint8ClampedArray(te.pixels.buffer),te.width,te.height);fe.putImageData(Se,0,0),j.save(),j.scale(1,-1),j.drawImage(Q,0,-te.height),j.restore()});const b=Ce(!1),M=Ce(null);let _=null;async function I(){try{_=await navigator.mediaDevices.getUserMedia({video:{width:1280,height:720},audio:!1}),b.value=!0,setTimeout(()=>{M.value&&(M.value.srcObject=_,M.value.onloadedmetadata=()=>{M.value.play(),i("imageLoaded",{url:"webcam",width:M.value.videoWidth,height:M.value.videoHeight,img:M.value,isVideo:!0})})},50)}catch(te){console.error("Failed to access webcam:",te),alert("Could not access webcam. Please check permissions.")}}function D(){_&&(_.getTracks().forEach(te=>te.stop()),_=null),b.value=!1,i("imageLoaded",{url:"webcam",width:1,height:1,img:null,isVideo:!1})}const B=Ce(null),y=Re(()=>({left:(n.params.x??.5)*100+"%",top:(1-(n.params.y??.5))*100+"%"}));let x=!1;function A(te){x=!0,X(te),window.addEventListener("pointermove",T),window.addEventListener("pointerup",C)}function T(te){x&&X(te)}function C(){x=!1,window.removeEventListener("pointermove",T),window.removeEventListener("pointerup",C)}function X(te){const L=B.value;if(!L)return;const j=L.getBoundingClientRect(),Q=Math.max(0,Math.min(1,(te.clientX-j.left)/j.width)),fe=Math.max(0,Math.min(1,1-(te.clientY-j.top)/j.height));i("paramChange","x",Q),i("paramChange","y",fe)}const E=Ce(null),k=[];let R=null;n.nodeType==="lfo"&&mn(()=>{R=setInterval(()=>{const te=n.outputValues?.out??0;k.push(te),k.length>Md&&k.shift(),N()},50)});function N(){const te=E.value;if(!te||k.length<2)return;const L=te.getContext("2d"),j=te.width,Q=te.height;L.clearRect(0,0,j,Q);let fe=1/0,Se=-1/0;for(const H of k)H<fe&&(fe=H),H>Se&&(Se=H);Se===fe&&(fe-=.5,Se+=.5);const Te=Se-fe;L.strokeStyle="#00d4ff",L.lineWidth=1.5,L.lineJoin="round",L.beginPath();for(let H=0;H<k.length;H++){const W=H/(Md-1)*j,F=Q-(k[H]-fe)/Te*Q;H===0?L.moveTo(W,F):L.lineTo(W,F)}L.stroke(),L.lineTo((k.length-1)/(Md-1)*j,Q),L.lineTo(0,Q),L.closePath(),L.fillStyle="rgba(0, 212, 255, 0.08)",L.fill()}lr(()=>{D(),clearInterval(R)});function O(){d.value?.click()}function $(te){const L=te.target.files?.[0];L&&ne(L)}function G(te){f.value=!1;const L=te.dataTransfer.files?.[0];L&&L.type.startsWith("image/")&&ne(L)}function ne(te){const L=URL.createObjectURL(te);h.value=L;const j=new Image;j.onload=()=>{i("imageLoaded",{url:L,width:j.naturalWidth,height:j.naturalHeight,img:j})},j.src=L}function re(te){return te==null?"":typeof te=="number"?te.toFixed(2):String(te)}lt(()=>n.monitorValue,te=>{te!=null&&(g.value.push(te),g.value.length>av&&g.value.shift(),_e())});function _e(){const te=v.value;if(!te)return;const L=te.getContext("2d"),j=te.width,Q=te.height,fe=g.value;if(L.clearRect(0,0,j,Q),fe.length<2)return;const Se=Math.min(...fe),Te=Math.max(...fe),H=Te-Se||1;L.strokeStyle="#00d4ff",L.lineWidth=1.5,L.beginPath();for(let W=0;W<fe.length;W++){const F=W/(av-1)*j,U=Q-(fe[W]-Se)/H*(Q-4)-2;W===0?L.moveTo(F,U):L.lineTo(F,U)}if(L.stroke(),Se<=0&&Te>=0){const W=Q-(0-Se)/H*(Q-4)-2;L.strokeStyle="#ffffff30",L.lineWidth=.5,L.beginPath(),L.moveTo(0,W),L.lineTo(j,W),L.stroke()}}const we=Re(()=>{if(n.nodeType!=="webcamInput")return!1;const te=n.params?.enable===!0,L=r.dataOutputs[n.nodeId]?.trigger??0;return te||L>.5});return lt(we,te=>{te&&!b.value?I():!te&&b.value&&D()},{immediate:!0}),(te,L)=>(ce(),me("div",{class:ut(["flow-node",{"flow-node--selected":t.selected},{"flow-node--compact":t.def.compact},{"flow-node--bypassed":t.params._bypass},{"flow-node--collapsed":t.params._collapsed},{"flow-node--resizable":!t.params._collapsed&&["preview","knob","imageInput","webcamInput"].includes(t.nodeType)&&t.params._resizable}]),onClick:L[40]||(L[40]=j=>te.$emit("select")),onDblclick:L[41]||(L[41]=Oe(j=>te.$emit("paramChange","_collapsed",!t.params._collapsed),["stop"]))},[["preview","knob","imageInput","webcamInput"].includes(t.nodeType)&&t.params._resizable?(ce(),Jt(he(NB),{key:0,"min-width":60,"min-height":60,"max-width":540,"max-height":540,"keep-aspect-ratio":!0,"is-visible":t.selected,class:"nodrag"},null,8,["is-visible"])):He("",!0),q("div",{class:"flow-node__header",title:a.value},[t.params._collapsed&&o.value.length>0?(ce(),me("span",VB," ["+Ee(o.value.length)+"] ",1)):He("",!0),q("div",{class:"flow-node__category-dot",style:rt({background:l.value})},null,4),q("div",$B,Ee(t.def.label),1),t.params._collapsed&&s.value.length>0?(ce(),me("span",HB," ["+Ee(s.value.length)+"] ",1)):He("",!0),u.value?(ce(),me("button",{key:2,class:"flow-node__bypass-btn",style:{"margin-right":"4px"},onClick:Oe(c,["stop"]),title:"Randomize Parameters"}," 🎲 ")):He("",!0),q("button",{class:ut(["flow-node__bypass-btn",{"flow-node__bypass-btn--active":t.params._collapsed}]),style:{"margin-right":"4px"},onClick:L[0]||(L[0]=Oe(j=>te.$emit("paramChange","_collapsed",!t.params._collapsed),["stop"])),title:t.params._collapsed?"Expand Node":"Collapse Node"},Ee(t.params._collapsed?"▼":"▬"),11,GB),!t.params._collapsed&&["preview","knob","imageInput","webcamInput"].includes(t.nodeType)?(ce(),me("button",{key:3,class:ut(["flow-node__bypass-btn",{"flow-node__bypass-btn--active":t.params._resizable}]),style:{"margin-right":"4px"},onClick:L[1]||(L[1]=Oe(j=>te.$emit("paramChange","_resizable",!t.params._resizable),["stop"])),title:t.params._resizable?"Disable Resizing":"Enable Resizing"}," ⤢ ",10,WB)):He("",!0),t.def.shaderKey||t.def.category==="image"||t.def.category==="uv"?(ce(),me("button",{key:4,class:ut(["flow-node__bypass-btn",{"flow-node__bypass-btn--active":t.params._bypass}]),onClick:L[2]||(L[2]=Oe(j=>te.$emit("paramChange","_bypass",!t.params._bypass),["stop"])),title:t.params._bypass?"Enable (bypassed)":"Bypass"},Ee(t.params._bypass?"⊘":"⏵"),11,XB)):He("",!0),t.perfMs!==null?(ce(),me("span",{key:5,class:"flow-node__perf-badge",title:t.perfMs+"ms"},Ee(t.perfMs<1?"<1":t.perfMs.toFixed(1))+"ms ",9,YB)):He("",!0)],8,zB),q("div",qB,[q("div",KB,[(ce(!0),me(it,null,Ht(t.def.inputs,j=>(ce(),me("div",{key:"in-"+j.id,class:"flow-node__handle-row flow-node__handle-row--input"},[tt(he(xo),{type:"target",id:j.id,position:he(Xe).Left,style:rt({background:he(ad)(j.type)})},null,8,["id","position","style"]),q("span",ZB,Ee(j.label),1),q("span",jB,Ee(j.type),1),t.inputValues[j.id]!==void 0?(ce(),me("span",{key:0,class:"flow-node__handle-value",title:"Value: "+t.inputValues[j.id]},Ee(re(t.inputValues[j.id])),9,JB)):He("",!0)]))),128)),(ce(!0),me(it,null,Ht(t.exposedHandles,j=>(ce(),me("div",{key:"exp-"+j.id,class:"flow-node__handle-row flow-node__handle-row--input flow-node__handle-row--exposed"},[tt(he(xo),{type:"target",id:j.id,position:he(Xe).Left,style:rt({background:he(ad)(j.type)})},null,8,["id","position","style"]),q("span",QB,"⊕ "+Ee(j.label),1),q("span",ek,Ee(j.type),1)]))),128))]),t.params._collapsed?He("",!0):(ce(),me(it,{key:0},[t.nodeType==="imageInput"||t.nodeType==="uiImageSlot"?(ce(),me("div",{key:0,class:"flow-node__controls",onPointerdown:L[5]||(L[5]=Oe(()=>{},["stop"])),onMousedown:L[6]||(L[6]=Oe(()=>{},["stop"]))},[q("input",{ref_key:"fileInput",ref:d,type:"file",accept:"image/*",class:"file-input-hidden",onChange:$},null,544),m.value?(ce(),me("div",tk,[q("button",{class:"flow-node__inline-btn flow-node__inline-btn--sm",onClick:Oe(O,["stop"]),style:{"margin-bottom":"4px",width:"100%"}}," 📷 Replace Image "),t.nodeType==="imageInput"?(ce(),me("img",{key:0,src:h.value,class:"flow-node__image-preview"},null,8,nk)):(ce(),me("div",ik," Image Loaded ✓ "))])):(ce(),me("div",{key:0,class:ut(["flow-node__drop-zone",{"flow-node__drop-zone--active":f.value}]),onClick:Oe(O,["stop"]),onDragover:L[3]||(L[3]=Oe(j=>f.value=!0,["prevent"])),onDragleave:L[4]||(L[4]=j=>f.value=!1),onDrop:Oe(G,["prevent"])}," 📷 Drop image or click to browse ",34))],32)):He("",!0),t.nodeType==="webcamInput"?(ce(),me("div",{key:1,class:"flow-node__controls",onPointerdown:L[9]||(L[9]=Oe(()=>{},["stop"])),onMousedown:L[10]||(L[10]=Oe(()=>{},["stop"]))},[b.value?(ce(),me("div",rk,[q("button",{class:"flow-node__inline-btn flow-node__inline-btn--sm",onClick:L[8]||(L[8]=Oe(j=>te.$emit("paramChange","enable",!1),["stop"])),style:{"margin-bottom":"4px",width:"100%",background:"var(--bg-red-dim)","border-color":"var(--accent-danger)"}}," Stop Webcam "),q("video",{ref_key:"webcamVideo",ref:M,class:"flow-node__image-preview",autoplay:"",playsinline:"",muted:""},null,512)])):(ce(),me("button",{key:0,class:"flow-node__inline-btn flow-node__inline-btn--sm",onClick:L[7]||(L[7]=Oe(j=>te.$emit("paramChange","enable",!0),["stop"])),style:{width:"100%"}}," 🎥 Start Webcam "))],32)):He("",!0),t.nodeType==="imageOutput"?(ce(),me("div",{key:2,class:"flow-node__controls",onPointerdown:L[12]||(L[12]=Oe(()=>{},["stop"])),onMousedown:L[13]||(L[13]=Oe(()=>{},["stop"]))},[q("button",{class:"flow-node__inline-btn",onClick:L[11]||(L[11]=Oe(j=>te.$emit("export"),["stop"]))}," ⬇ Export "+Ee(t.params.format||"PNG"),1)],32)):He("",!0),t.nodeType==="button"||t.nodeType==="bang"?(ce(),me("div",{key:3,class:"flow-node__controls",onPointerdown:L[15]||(L[15]=Oe(()=>{},["stop"])),onMousedown:L[16]||(L[16]=Oe(()=>{},["stop"]))},[q("button",{class:"flow-node__inline-btn",onClick:L[14]||(L[14]=Oe(j=>te.$emit("trigger"),["stop"]))},Ee(t.params.label||"Bang!"),1)],32)):He("",!0),t.nodeType==="slider"?(ce(),me("div",{key:4,class:"flow-node__slider-container",onPointerdown:L[20]||(L[20]=Oe(()=>{},["stop"])),onMousedown:L[21]||(L[21]=Oe(()=>{},["stop"]))},[q("input",{type:"range",class:"flow-node__inline-slider",min:t.params.min??0,max:t.params.max??1,step:t.params.step??.01,value:t.params.value??.5,onInput:L[17]||(L[17]=Oe(j=>te.$emit("paramChange","value",Number(j.target.value)),["stop"])),onPointerdown:L[18]||(L[18]=Oe(()=>{},["stop"])),onMousedown:L[19]||(L[19]=Oe(()=>{},["stop"]))},null,40,ok),q("div",sk,Ee((t.params.value??.5).toFixed(3)),1)],32)):He("",!0),t.nodeType==="knob"?(ce(),me("div",{key:5,class:"flow-node__knob-container",onPointerdown:L[23]||(L[23]=Oe(()=>{},["stop"])),onMousedown:L[24]||(L[24]=Oe(()=>{},["stop"]))},[tt(sx,{modelValue:t.params.value??(t.def.params.value?t.def.params.value.default:.5),min:t.params.min??(t.def.params.min?t.def.params.min.default:0),max:t.params.max??(t.def.params.max?t.def.params.max.default:1),step:t.params.step??(t.def.params.step?t.def.params.step.default:.01),size:null,"onUpdate:modelValue":L[22]||(L[22]=j=>te.$emit("paramChange","value",j))},null,8,["modelValue","min","max","step"])],32)):He("",!0),t.nodeType==="lfo"?(ce(),me("div",{key:6,class:"flow-node__inline-params",onPointerdown:L[34]||(L[34]=Oe(()=>{},["stop"])),onMousedown:L[35]||(L[35]=Oe(()=>{},["stop"]))},[q("canvas",{ref_key:"lfoCanvasRef",ref:E,class:"flow-node__lfo-graph",width:"176",height:"40"},null,512),q("div",ak,[L[42]||(L[42]=q("span",{class:"flow-node__inline-param-label"},"wave",-1)),q("select",{class:"flow-node__inline-select",value:t.params.waveform??"sine",onChange:L[25]||(L[25]=Oe(j=>te.$emit("paramChange","waveform",j.target.value),["stop"])),onPointerdown:L[26]||(L[26]=Oe(()=>{},["stop"])),onMousedown:L[27]||(L[27]=Oe(()=>{},["stop"]))},[(ce(),me(it,null,Ht(["sine","saw","square","triangle"],j=>q("option",{key:j,value:j},Ee(j),9,uk)),64))],40,lk)]),q("div",ck,[L[43]||(L[43]=q("span",{class:"flow-node__inline-param-label"},"freq",-1)),q("input",{type:"range",class:"flow-node__inline-slider-sm",min:"0.01",max:"20",step:"0.01",value:t.params.frequency??1,onInput:L[28]||(L[28]=Oe(j=>te.$emit("paramChange","frequency",Number(j.target.value)),["stop"])),onPointerdown:L[29]||(L[29]=Oe(()=>{},["stop"])),onMousedown:L[30]||(L[30]=Oe(()=>{},["stop"]))},null,40,dk),q("span",fk,Ee((t.params.frequency??1).toFixed(2)),1)]),q("div",hk,[L[44]||(L[44]=q("span",{class:"flow-node__inline-param-label"},"amp",-1)),q("input",{type:"range",class:"flow-node__inline-slider-sm",min:"0",max:"10",step:"0.01",value:t.params.amplitude??1,onInput:L[31]||(L[31]=Oe(j=>te.$emit("paramChange","amplitude",Number(j.target.value)),["stop"])),onPointerdown:L[32]||(L[32]=Oe(()=>{},["stop"])),onMousedown:L[33]||(L[33]=Oe(()=>{},["stop"]))},null,40,pk),q("span",mk,Ee((t.params.amplitude??1).toFixed(2)),1)])],32)):He("",!0),t.nodeType==="xyPad"?(ce(),me("div",{key:7,class:"flow-node__xypad-wrapper",onPointerdown:L[36]||(L[36]=Oe(()=>{},["stop"])),onMousedown:L[37]||(L[37]=Oe(()=>{},["stop"]))},[q("div",{class:"flow-node__xypad",ref_key:"xyPadNodeRef",ref:B,onPointerdown:A},[q("div",{class:"flow-node__xypad-crosshair",style:rt(y.value)},null,4)],544),q("div",gk,[q("span",vk,"X: "+Ee((t.params.x??.5).toFixed(2)),1),q("span",_k,"Y: "+Ee((t.params.y??.5).toFixed(2)),1)])],32)):He("",!0),t.nodeType==="fft"?(ce(),me("div",{key:8,class:"flow-node__fft-container",onPointerdown:L[38]||(L[38]=Oe(()=>{},["stop"])),onMousedown:L[39]||(L[39]=Oe(()=>{},["stop"]))},[q("div",{class:"flow-node__fft-bar flow-node__fft-bar--bass",style:rt({height:Math.max(2,(t.outputValues.bass||0)*40)+"px"})},null,4),q("div",{class:"flow-node__fft-bar flow-node__fft-bar--low-mid",style:rt({height:Math.max(2,(t.outputValues.lowMid||0)*40)+"px"})},null,4),q("div",{class:"flow-node__fft-bar flow-node__fft-bar--mid",style:rt({height:Math.max(2,(t.outputValues.mid||0)*40)+"px"})},null,4),q("div",{class:"flow-node__fft-bar flow-node__fft-bar--high",style:rt({height:Math.max(2,(t.outputValues.high||0)*40)+"px"})},null,4)],32)):He("",!0),t.nodeType==="numberMonitor"?(ce(),me("div",yk,[q("div",{class:"flow-node__monitor-value",title:"Value: "+(t.monitorValue??0)},Ee(t.monitorValue!==null&&t.monitorValue!==void 0?t.monitorValue.toFixed(t.params.decimals??3):"—"),9,xk),t.params.showGraph!==!1?(ce(),me("canvas",{key:0,ref_key:"monitorCanvas",ref:v,class:"flow-node__monitor-graph",width:"176",height:"40"},null,512)):He("",!0)])):He("",!0),t.nodeType==="preview"?(ce(),me("div",bk,[q("canvas",{ref_key:"previewCanvas",ref:p,class:"flow-node__preview-canvas",width:"176",height:"100"},null,512),L[45]||(L[45]=q("div",{class:"flow-node__preview-label"},"Preview Node",-1))])):He("",!0)],64)),q("div",Sk,[(ce(!0),me(it,null,Ht(t.def.outputs,j=>(ce(),me("div",{key:"out-"+j.id,class:"flow-node__handle-row flow-node__handle-row--output"},[q("span",Mk,Ee(j.type),1),q("span",wk,Ee(j.label),1),t.outputValues[j.id]!==void 0?(ce(),me("span",{key:0,class:"flow-node__handle-value",title:"Value: "+t.outputValues[j.id]},Ee(re(t.outputValues[j.id])),9,Ek)):He("",!0),tt(he(xo),{type:"source",id:j.id,position:he(Xe).Right,style:rt({background:he(ad)(j.type)})},null,8,["id","position","style"])]))),128))])])],34))}},br=cr(Tk,[["__scopeId","data-v-3ed60a2c"]]),Ak={class:"editor-controls"},Ck={__name:"EditorCanvas",emits:["imageLoaded","exportImage"],setup(t,{expose:e,emit:n}){const i=Ao(),{viewport:r,dimensions:o,project:s,zoomIn:a,zoomOut:l,setViewport:u,fitView:c}=Dt();function d(){const{x:y,y:x}=r.value;u({x:y,y:x,zoom:1},{duration:600})}function f(){c({padding:.1,duration:600})}function h(y){["INPUT","TEXTAREA"].includes(y.target.tagName)||(y.key==="f"||y.key==="F")&&(i.selectedNodeId?c({nodes:[i.selectedNodeId],padding:.2,duration:600}):c({padding:.1,duration:600}))}mn(()=>{window.addEventListener("keydown",h)}),Hu(()=>{window.removeEventListener("keydown",h)});function m(y){const{x,y:A,zoom:T}=r.value,{width:C,height:X}=o.value,E=C||800,k=X||600,R=(E/2-x)/T,N=(k/2-A)/T;i.addNode(y,{x:R+(Math.random()-.5)*60,y:N+(Math.random()-.5)*60})}e({addNodeAtCenter:m});const v=["imageInput","uiImageSlot","webcamInput","imageOutput","button","slider"],g=Re(()=>Object.keys(FC()).filter(y=>!v.includes(y)));function p(y){for(const x of y)if(x.type==="position"&&x.position){const A=i.nodes.find(T=>T.id===x.id);A&&(A.position=x.position)}else x.type==="remove"&&i.removeNode(x.id)}function b(y){for(const x of y)x.type==="remove"&&i.removeEdge(x.id)}function M(y){i.addEdge(y)}function _({node:y}){i.selectNode(y.id)}function I(){i.selectNode(null)}function D({edge:y}){}function B(y){const x=y.dataTransfer.getData("application/node-type");if(!x)return;const A=y.currentTarget.getBoundingClientRect(),{x:T,y:C,zoom:X}=r.value,E=(y.clientX-A.left-T)/X,k=(y.clientY-A.top-C)/X;i.addNode(x,{x:E,y:k})}return(y,x)=>(ce(),me("div",{class:"editor-canvas",onDrop:Oe(B,["prevent"]),onDragover:x[2]||(x[2]=Oe(()=>{},["prevent"]))},[tt(he(qN),{nodes:he(i).nodes,edges:he(i).edges,"default-viewport":{zoom:1,x:0,y:0},"min-zoom":.2,"max-zoom":3,"fit-view-on-init":"",onNodesChange:p,onEdgesChange:b,onConnect:M,onNodeClick:_,onPaneClick:I,onEdgeClick:D},Tb({"node-imageInput":dn(A=>[tt(br,{"node-id":A.id,"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onImageLoaded:T=>y.$emit("imageLoaded",A.id,T)},null,8,["node-id","node-type","def","params","selected","onSelect","onImageLoaded"])]),"node-uiImageSlot":dn(A=>[tt(br,{"node-id":A.id,"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onImageLoaded:T=>y.$emit("imageLoaded",A.id,T)},null,8,["node-id","node-type","def","params","selected","onSelect","onImageLoaded"])]),"node-webcamInput":dn(A=>[tt(br,{"node-id":A.id,"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onImageLoaded:T=>y.$emit("imageLoaded",A.id,T),onParamChange:(T,C)=>he(i).setParam(A.id,T,C)},null,8,["node-id","node-type","def","params","selected","onSelect","onImageLoaded","onParamChange"])]),"node-imageOutput":dn(A=>[tt(br,{"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onExport:T=>y.$emit("exportImage",A.id)},null,8,["node-type","def","params","selected","onSelect","onExport"])]),"node-button":dn(A=>[tt(br,{"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onTrigger:T=>he(i).triggerButton(A.id)},null,8,["node-type","def","params","selected","onSelect","onTrigger"])]),"node-bang":dn(A=>[tt(br,{"node-id":A.id,"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onTrigger:T=>he(i).triggerButton(A.id),onParamChange:(T,C)=>he(i).setParam(A.id,T,C)},null,8,["node-id","node-type","def","params","selected","onSelect","onTrigger","onParamChange"])]),"node-slider":dn(A=>[tt(br,{"node-type":A.type,def:A.data.def,params:he(i).nodeParams[A.id]||{},selected:he(i).selectedNodeId===A.id,onSelect:T=>he(i).selectNode(A.id),onParamChange:(T,C)=>he(i).setParam(A.id,T,C)},null,8,["node-type","def","params","selected","onSelect","onParamChange"])]),default:dn(()=>[q("div",Ak,[q("button",{onClick:x[0]||(x[0]=A=>he(a)({duration:300})),title:"Zoom In (+)"},"+"),q("button",{onClick:x[1]||(x[1]=A=>he(l)({duration:300})),title:"Zoom Out (-)"},"−"),q("button",{onClick:d,title:"Zoom to 100% (1:1)"},"1:1"),q("button",{onClick:f,title:"Fit View to All"},"[ ]")]),tt(he(NU),{pannable:"",zoomable:"",position:"bottom-right"})]),_:2},[Ht(g.value,A=>({name:`node-${A}`,fn:dn(T=>[tt(br,{"node-id":T.id,"node-type":T.type,def:T.data.def,params:he(i).nodeParams[T.id]||{},selected:he(i).selectedNodeId===T.id,"exposed-handles":he(i).getExposedHandles(T.id),"monitor-value":T.type==="numberMonitor"?he(i).getDataOutput(T.id,"out"):null,"perf-ms":he(i).perfTimings[T.id]??null,onSelect:C=>he(i).selectNode(T.id),onParamChange:(C,X)=>he(i).setParam(T.id,C,X)},null,8,["node-id","node-type","def","params","selected","exposed-handles","monitor-value","perf-ms","onSelect","onParamChange"])])}))]),1032,["nodes","edges"])],32))}},Rk=cr(Ck,[["__scopeId","data-v-84e59669"]]),Ik={class:"preview-panel__toolbar"},Pk={class:"preview-panel__badge"},Nk={key:0,class:"preview-panel__badge",style:{color:"var(--accent-primary)"}},Dk={key:1,class:"preview-panel__badge",style:{color:"var(--accent-danger)"}},Lk={class:"preview-panel__zoom-level"},Fk={key:2,class:"preview-panel__histogram"},Uk={class:"preview-panel__info-row"},Ok={key:0},Bk={__name:"PreviewPanel",props:{hidden:{type:Boolean,default:!1},isRendering:{type:Boolean,default:!0},pipeline:{type:Object,default:null},fps:{type:Number,default:0},previewMode:{type:String,default:"anchored"}},setup(t,{expose:e}){const n=Ce(400),i=Ce(40),r=Ce(!1),o=Ce({x:0,y:0});function s(N){N.button===0&&(r.value=!0,o.value={x:N.clientX-n.value,y:N.clientY-i.value},window.addEventListener("pointermove",a),window.addEventListener("pointerup",l))}function a(N){r.value&&(n.value=N.clientX-o.value.x,i.value=N.clientY-o.value.y)}function l(){r.value=!1,window.removeEventListener("pointermove",a),window.removeEventListener("pointerup",l)}const u=Ce(300),c=Ce(!1);function d(N){if(N.button!==0)return;c.value=!0;const O=N.clientY,$=u.value;function G(re){if(!c.value)return;const _e=O-re.clientY;u.value=Math.max(100,Math.min(window.innerHeight*.8,$+_e))}function ne(){c.value=!1,window.removeEventListener("pointermove",G),window.removeEventListener("pointerup",ne)}window.addEventListener("pointermove",G),window.addEventListener("pointerup",ne)}const f=Ce(null),h=Ce(null),m=Ce(null),v=Ce(512),g=Ce(512),p=Ce(1),b=Ce(0),M=Ce(0),_=Ce(!1),I=Ce({x:0,y:0}),D=Ce(!1);let B=null;function y(){return f.value}e({canvasRef:f,width:v,height:g,getCanvas:y}),lt(D,N=>{N?(k(),B=setInterval(k,500)):(B&&clearInterval(B),B=null)}),lr(()=>{B&&clearInterval(B)});function x(){p.value=1,b.value=0,M.value=0}function A(){if(!m.value)return;const N=m.value.clientWidth,O=m.value.clientHeight,$=N/v.value,G=O/g.value;p.value=Math.min($,G,1)*.95,b.value=(N-v.value*p.value)/2,M.value=(O-g.value*p.value)/2}function T(N){const O=N.deltaY>0?.9:1.1,$=Math.max(.1,Math.min(10,p.value*O)),G=m.value.getBoundingClientRect(),ne=N.clientX-G.left,re=N.clientY-G.top;b.value=ne-(ne-b.value)*($/p.value),M.value=re-(re-M.value)*($/p.value),p.value=$}function C(N){(N.button===0||N.button===1)&&(_.value=!0,I.value={x:N.clientX,y:N.clientY},m.value?.setPointerCapture(N.pointerId))}function X(N){if(!_.value)return;const O=N.clientX-I.value.x,$=N.clientY-I.value.y;b.value+=O,M.value+=$,I.value={x:N.clientX,y:N.clientY}}function E(N){_.value=!1,m.value?.releasePointerCapture(N.pointerId)}function k(){if(!D.value||!h.value)return;const N=f.value;if(!N)return;const O=N.getContext("webgl2",{preserveDrawingBuffer:!0})||N.getContext("webgl",{preserveDrawingBuffer:!0});if(!O)return;const $=N.width,G=N.height;if($===0||G===0)return;const ne=new Uint8Array($*G*4);O.readPixels(0,0,$,G,O.RGBA,O.UNSIGNED_BYTE,ne);const re=new Uint32Array(256),_e=new Uint32Array(256),we=new Uint32Array(256);for(let fe=0;fe<ne.length;fe+=4)re[ne[fe]]++,_e[ne[fe+1]]++,we[ne[fe+2]]++;const te=h.value.getContext("2d"),L=256,j=80;te.clearRect(0,0,L,j);const Q=Math.max(...re.slice(1,255),..._e.slice(1,255),...we.slice(1,255),1);R(te,re,Q,L,j,"rgba(255,80,80,0.5)"),R(te,_e,Q,L,j,"rgba(80,255,80,0.5)"),R(te,we,Q,L,j,"rgba(80,80,255,0.5)")}function R(N,O,$,G,ne,re){N.fillStyle=re,N.beginPath(),N.moveTo(0,ne);for(let _e=0;_e<256;_e++){const we=O[_e]/$*(ne-2);N.lineTo(_e,ne-we)}N.lineTo(255,ne),N.closePath(),N.fill()}return(N,O)=>(ce(),me("div",{class:ut(["preview-panel",`preview-panel--${t.previewMode}`,{hidden:t.hidden}]),style:rt(t.previewMode==="floating"?{top:`${i.value}px`,left:`${n.value}px`}:t.previewMode==="anchored"?{height:`${u.value}px`}:{})},[t.previewMode==="anchored"?(ce(),me("div",{key:0,class:"preview-panel__resize-handle",onPointerdown:d},null,32)):He("",!0),t.previewMode==="floating"?(ce(),me("div",{key:1,class:"preview-panel__header",onPointerdown:s},[...O[1]||(O[1]=[q("span",{class:"preview-panel__header-title"},"Live Preview",-1)])],32)):He("",!0),q("div",Ik,[q("span",Pk,Ee(v.value)+"×"+Ee(g.value),1),t.fps&&t.isRendering?(ce(),me("span",Nk,Ee(t.fps)+" FPS",1)):He("",!0),t.isRendering?He("",!0):(ce(),me("span",Dk,"STOPPED")),O[2]||(O[2]=q("div",{style:{flex:"1"}},null,-1)),q("span",Lk,Ee(Math.round(p.value*100))+"%",1),q("button",{class:"preview-panel__tool-btn",onClick:A,title:"Fit"},"⊡"),q("button",{class:"preview-panel__tool-btn",onClick:x,title:"Reset Zoom"},"1:1"),q("button",{class:ut(["preview-panel__tool-btn",{active:D.value}]),onClick:O[0]||(O[0]=$=>D.value=!D.value),title:"Toggle Histogram"},"📊",2)]),q("div",{class:"preview-panel__viewport",ref_key:"viewportRef",ref:m,onWheel:Oe(T,["prevent"]),onPointerdown:C,onPointermove:X,onPointerup:E},[q("div",{class:"preview-panel__canvas-wrap",style:rt({transform:`translate(${b.value}px, ${M.value}px) scale(${p.value})`,transformOrigin:"0 0"})},[q("canvas",{ref_key:"canvasRef",ref:f,class:"preview-panel__canvas"},null,512)],4)],544),D.value?(ce(),me("div",Fk,[q("canvas",{ref_key:"histCanvas",ref:h,class:"preview-panel__hist-canvas",width:"256",height:"80"},null,512),q("div",Uk,[q("span",null,"Resolution: "+Ee(v.value)+"×"+Ee(g.value),1),t.fps?(ce(),me("span",Ok,Ee(t.fps)+" FPS",1)):He("",!0)])])):He("",!0)],6))}},kk=["title"],zk={class:"param-panel__collapse-label"},Vk={class:"param-panel__collapse-btn"},$k={class:"param-panel__header"},Hk={class:"param-panel__title"},Gk={class:"param-panel__type"},Wk={key:0,class:"param-panel__nickname-row"},Xk=["value"],Yk={key:1,class:"param-panel__section"},qk={class:"param-field__header"},Kk={class:"param-field__label"},Zk={style:{display:"flex",gap:"4px"}},jk=["onClick"],Jk=["onClick","title"],Qk=["min","max","step","value","onInput"],e4={class:"param-field__range-info"},t4=["step","value","onChange"],n4={class:"param-field__random-bounds-card"},i4={class:"param-field__random-bounds-inputs"},r4={style:{display:"flex","flex-direction":"column",gap:"2px"}},o4=["step","value","onChange"],s4={style:{display:"flex","flex-direction":"column",gap:"2px"}},a4=["step","value","onChange"],l4=["value","onChange"],u4=["value"],c4=["onClick"],d4={key:1,class:"param-field__checkbox"},f4=["checked","onChange"],h4=["value","onInput"],p4={class:"param-panel__section"},m4={class:"param-field"},g4={class:"mono",style:{"font-size":"10px",color:"var(--text-muted)"}},v4={class:"param-field"},_4={style:{"font-size":"11px"}},y4={class:"param-field"},x4={style:{"font-size":"11px"}},b4={class:"param-field"},S4={style:{"font-size":"11px"}},M4={key:1,class:"param-panel__empty"},w4={__name:"ParameterPanel",setup(t){const e=Ao(),n=Ce({}),i=Ce(window.innerWidth<768),r=Re(()=>e.selectedNodeDef||{label:"",type:"",params:{},inputs:[],outputs:[],category:""}),o=Re(()=>e.selectedNodeParams),s=Re(()=>fu[r.value.category]?.color||"#888"),a=Re(()=>e.selectedNodeId&&e.perfGridCells.find(c=>c.boundNodeId===e.selectedNodeId||c.boundTargetNodeId===e.selectedNodeId)||null);function l(c,d){e.selectedNodeId&&e.setParam(e.selectedNodeId,c,d)}function u(c,d){return d==="int"?Math.round(c).toString():typeof c=="number"?c.toFixed(3):String(c)}return(c,d)=>(ce(),me("div",{class:ut(["param-panel",{"param-panel--collapsed":i.value}])},[q("div",{class:"param-panel__collapse-bar",onClick:d[0]||(d[0]=f=>i.value=!i.value),title:i.value?"Expand inspector":"Collapse inspector"},[Dr(q("span",zk,"Inspector",512),[[Lr,!i.value]]),q("span",Vk,Ee(i.value?"‹":"›"),1)],8,kk),i.value?He("",!0):(ce(),me(it,{key:0},[he(e).selectedNode?(ce(),me(it,{key:0},[q("div",$k,[q("div",{class:"flow-node__category-dot",style:rt({background:s.value})},null,4),q("span",Hk,Ee(r.value.label),1),q("span",Gk,Ee(r.value.type),1)]),a.value?(ce(),me("div",Wk,[d[2]||(d[2]=q("label",{class:"param-panel__nickname-label"},"Nickname",-1)),q("input",{class:"param-panel__nickname-input",type:"text",value:a.value.nickname||"",placeholder:"Display name in Performance Mode",onInput:d[1]||(d[1]=f=>he(e).setPerfCellNickname(a.value.id,f.target.value))},null,40,Xk)])):He("",!0),Object.keys(r.value.params).length>0?(ce(),me("div",Yk,[d[7]||(d[7]=q("div",{class:"param-panel__section-title"},"Parameters",-1)),(ce(!0),me(it,null,Ht(r.value.params,(f,h)=>(ce(),me("div",{key:h,class:"param-field"},[q("div",qk,[q("label",Kk,Ee(f.label),1),q("div",Zk,[f.type==="float"||f.type==="int"?(ce(),me("button",{key:0,class:ut(["param-field__expose-btn",{"param-field__expose-btn--active":n.value[h]}]),onClick:m=>n.value[h]=!n.value[h],title:"Toggle Randomizer Bounds"}," 🎲 ",10,jk)):He("",!0),f.type==="float"||f.type==="int"?(ce(),me("button",{key:1,class:ut(["param-field__expose-btn",{"param-field__expose-btn--active":he(e).isParamExposed(he(e).selectedNodeId,h)}]),onClick:m=>he(e).toggleExposeParam(he(e).selectedNodeId,h),title:he(e).isParamExposed(he(e).selectedNodeId,h)?"Unexpose input":"Expose as input handle"},Ee(he(e).isParamExposed(he(e).selectedNodeId,h)?"🔗":"⊕"),11,Jk)):He("",!0)])]),f.type==="float"||f.type==="int"?(ce(),me(it,{key:0},[q("input",{type:"range",class:"param-field__input",min:h==="value"&&o.value.min!==void 0?o.value.min:f.min,max:h==="value"&&o.value.max!==void 0?o.value.max:f.max,step:h==="value"&&o.value.step!==void 0?o.value.step:f.step,value:o.value[h]??f.default,onInput:m=>l(h,f.type==="int"?parseInt(m.target.value):parseFloat(m.target.value))},null,40,Qk),q("div",e4,[q("span",null,Ee(h==="value"&&o.value.min!==void 0?o.value.min:f.min),1),q("input",{type:"number",class:"param-field__number-input mono",step:h==="value"&&o.value.step!==void 0?o.value.step:f.step,value:u(o.value[h]??f.default,f.type),onChange:m=>l(h,f.type==="int"?parseInt(m.target.value):parseFloat(m.target.value))},null,40,t4),q("span",null,Ee(h==="value"&&o.value.max!==void 0?o.value.max:f.max),1)]),Dr(q("div",n4,[d[6]||(d[6]=q("div",{class:"param-field__random-bounds-header"},"🎲 Randomizer Range",-1)),q("div",i4,[q("div",r4,[d[3]||(d[3]=q("span",{style:{"font-size":"9px",opacity:"0.7"}},"Min",-1)),q("input",{type:"number",class:"param-field__number-input mono",step:f.step,value:o.value[`_randMin_${h}`]??(h==="value"&&o.value.min!==void 0?o.value.min:f.min)??0,onChange:m=>l(`_randMin_${h}`,f.type==="int"?parseInt(m.target.value):parseFloat(m.target.value)),title:"Min random value"},null,40,o4)]),d[5]||(d[5]=q("span",{style:{opacity:"0.5","font-size":"10px","margin-top":"10px"}},"to",-1)),q("div",s4,[d[4]||(d[4]=q("span",{style:{"font-size":"9px",opacity:"0.7"}},"Max",-1)),q("input",{type:"number",class:"param-field__number-input mono",step:f.step,value:o.value[`_randMax_${h}`]??(h==="value"&&o.value.max!==void 0?o.value.max:f.max)??1,onChange:m=>l(`_randMax_${h}`,f.type==="int"?parseInt(m.target.value):parseFloat(m.target.value)),title:"Max random value"},null,40,a4)])])],512),[[Lr,n.value[h]]])],64)):f.type==="select"?(ce(),me("select",{key:1,class:"param-field__input",value:o.value[h]??f.default,onChange:m=>l(h,m.target.value)},[(ce(!0),me(it,null,Ht(f.options,m=>(ce(),me("option",{key:m,value:m},Ee(m),9,u4))),128))],40,l4)):f.type==="bool"?(ce(),me(it,{key:2},[f.ui==="button"?(ce(),me("button",{key:0,class:"flow-node__inline-btn",style:rt([{width:"100%","margin-top":"4px",padding:"6px"},{background:o.value[h]??f.default?"var(--bg-red-dim)":"var(--bg-tertiary)",borderColor:o.value[h]??f.default?"var(--accent-danger)":"var(--border-color)"}]),onClick:m=>l(h,!(o.value[h]??f.default))},Ee(o.value[h]??f.default?"Stop":"Start")+" "+Ee(f.label.replace("Enable","")),13,c4)):(ce(),me("label",d4,[q("input",{type:"checkbox",checked:o.value[h]??f.default,onChange:m=>l(h,m.target.checked)},null,40,f4),q("span",null,Ee(f.label),1)]))],64)):f.type==="string"?(ce(),me("input",{key:3,type:"text",class:"param-field__input",value:o.value[h]??f.default,onInput:m=>l(h,m.target.value)},null,40,h4)):He("",!0)]))),128))])):He("",!0),q("div",p4,[d[12]||(d[12]=q("div",{class:"param-panel__section-title"},"Info",-1)),q("div",m4,[d[8]||(d[8]=q("span",{class:"param-field__label"},"ID",-1)),q("span",g4,Ee(he(e).selectedNodeId),1)]),q("div",v4,[d[9]||(d[9]=q("span",{class:"param-field__label"},"Category",-1)),q("span",_4,Ee(r.value.category),1)]),q("div",y4,[d[10]||(d[10]=q("span",{class:"param-field__label"},"Inputs",-1)),q("span",x4,Ee(r.value.inputs.length),1)]),q("div",b4,[d[11]||(d[11]=q("span",{class:"param-field__label"},"Outputs",-1)),q("span",S4,Ee(r.value.outputs.length),1)])])],64)):(ce(),me("div",M4," Select a node to edit its parameters "))],64))],2))}},E4=cr(w4,[["__scopeId","data-v-ff86a86b"]]),T4=["draggable"],A4={class:"control-cell__unbound-icon"},C4={key:2,class:"control-cell__widget control-cell__anim-widget"},R4={class:"control-cell__lfo-readout"},I4={class:"control-cell__lfo-waveforms"},P4=["onClick"],N4={class:"control-cell__label"},D4={key:0,class:"control-cell__target-label"},L4={key:1,class:"control-cell__node-label"},F4={key:3,class:"control-cell__widget control-cell__anim-widget"},U4={class:"control-cell__value mono"},O4={class:"control-cell__label"},B4={key:0,class:"control-cell__target-label"},k4={key:1,class:"control-cell__node-label"},z4={key:4,class:"control-cell__widget control-cell__anim-widget"},V4={class:"control-cell__value mono"},$4={class:"control-cell__label"},H4={key:0,class:"control-cell__target-label"},G4={key:1,class:"control-cell__node-label"},W4={class:"control-cell__value mono"},X4={class:"control-cell__label"},Y4={key:0,class:"control-cell__target-label"},q4={key:1,class:"control-cell__node-label"},K4={key:2,class:"control-cell__pulse-ring"},Z4={key:6,class:"control-cell__widget control-cell__anim-widget"},j4={class:"control-cell__fft-bars"},J4={class:"control-cell__node-label"},Q4={class:"control-cell__label"},e5={class:"control-cell__node-label"},t5=["min","max","step","value"],n5={class:"control-cell__value mono"},i5={class:"control-cell__label"},r5={class:"control-cell__node-label"},o5={class:"control-cell__node-label"},s5={class:"control-cell__label"},a5={class:"control-cell__node-label"},l5={class:"control-cell__lfo-readout"},u5={key:0,class:"control-cell__xy-assignments"},c5={key:0,class:"control-cell__target-label"},d5={key:1,class:"control-cell__target-label"},f5={class:"control-cell__label"},h5={key:1,class:"control-cell__node-label"},p5={key:12,class:"control-cell__widget"},m5={class:"control-cell__accel-readout"},g5={class:"control-cell__accel-axis"},v5={class:"control-cell__accel-bar-track"},_5={class:"control-cell__accel-axis"},y5={class:"control-cell__accel-bar-track"},x5={class:"control-cell__node-label"},b5={class:"value-edit-popup"},S5={class:"value-edit-popup__title"},M5=["value","step"],w5={class:"value-edit-popup__actions"},wd=60,E5={__name:"ControlCell",props:{cell:{type:Object,required:!0},editMode:{type:Boolean,default:!1},index:{type:Number,default:0}},emits:["delete","assign","reorder"],setup(t,{emit:e}){const n=t,i=e,r=Ao(),o=Ce(!1),s=Ce(null),a=Ce(null),l=["lfo","timer","damper","fft","random"],u=Re(()=>l.includes(n.cell.controlType)),c=Re(()=>({knob:"🎛️",slider:"═══",bang:"💥",toggle:"⏻",lfo:"〰️",timer:"⏱️",damper:"🫧",fft:"🎵",random:"🎲",xypad:"✛",accelerometer:"📱"})[n.cell.controlType]||"?"),d=Re(()=>{if(!n.cell.boundNodeId)return"";const ue=r.nodes.find(Ae=>Ae.id===n.cell.boundNodeId);return ue?en(ue.type)?.label||ue.type:""}),f=Re(()=>n.cell.nickname?n.cell.nickname:n.cell.boundParamKey&&!n.cell.boundTargetNodeId?n.cell.boundParamKey.toUpperCase():n.cell.controlType.toUpperCase()),h=Re(()=>{if(!n.cell.boundTargetNodeId||!n.cell.boundParamKey)return"";const ue=r.nodes.find(oe=>oe.id===n.cell.boundTargetNodeId);if(!ue)return"";const se=en(ue.type),De=se?.params?.[n.cell.boundParamKey]?.label||n.cell.boundParamKey;return`→ ${se?.label||ue.type}.${De}`}),m=Re(()=>{if(!n.cell.boundTargetNodeId||!n.cell.boundParamKey)return"";const ue=r.nodes.find(De=>De.id===n.cell.boundTargetNodeId);return ue?`X → ${en(ue.type)?.params?.[n.cell.boundParamKey]?.label||n.cell.boundParamKey}`:""}),v=Re(()=>{if(!n.cell.boundTargetNodeIdY||!n.cell.boundParamKeyY)return"";const ue=r.nodes.find(De=>De.id===n.cell.boundTargetNodeIdY);return ue?`Y → ${en(ue.type)?.params?.[n.cell.boundParamKeyY]?.label||n.cell.boundParamKeyY}`:""}),g=Re(()=>{if(!n.cell.boundNodeId||!n.cell.boundParamKey)return null;const ue=r.nodes.find(Ae=>Ae.id===n.cell.boundNodeId);return ue&&en(ue.type)?.params?.[n.cell.boundParamKey]||null}),p=Re(()=>!n.cell.boundNodeId||!n.cell.boundParamKey?0:r.nodeParams[n.cell.boundNodeId]?.[n.cell.boundParamKey]??g.value?.default??0),b=Re(()=>g.value?.min??0),M=Re(()=>g.value?.max??1),_=Re(()=>g.value?.step??.01),I=Re(()=>n.cell.boundNodeId?r.dataOutputs[n.cell.boundNodeId]?.out??0:0),D=Re(()=>{if(!n.cell.boundNodeId)return{bass:0,lowMid:0,mid:0,high:0};const ue=r.dataOutputs[n.cell.boundNodeId];return{bass:ue?.bass??0,lowMid:ue?.lowMid??0,mid:ue?.mid??0,high:ue?.high??0}}),B=Ce([]);let y=null;mn(()=>{u.value&&n.cell.controlType!=="fft"&&(y=setInterval(x,50))}),lr(()=>{clearInterval(y)});function x(){if(!n.cell.boundNodeId)return;const ue=I.value,se=B.value;se.push(ue),se.length>wd&&se.shift(),B.value=se,A()}function A(){const ue=s.value;if(!ue)return;const se=ue.getContext("2d"),Ae=ue.width,De=ue.height,Qe=B.value;if(se.clearRect(0,0,Ae,De),Qe.length<2)return;let oe=1/0,Le=-1/0;for(const Be of Qe)Be<oe&&(oe=Be),Be>Le&&(Le=Be);Le===oe&&(oe-=.5,Le+=.5);const Fe=Le-oe;se.strokeStyle="#00d4ff",se.lineWidth=1.5,se.lineJoin="round",se.beginPath();for(let Be=0;Be<Qe.length;Be++){const Ne=Be/(wd-1)*Ae,Me=De-(Qe[Be]-oe)/Fe*De;Be===0?se.moveTo(Ne,Me):se.lineTo(Ne,Me)}se.stroke(),se.lineTo((Qe.length-1)/(wd-1)*Ae,De),se.lineTo(0,De),se.closePath(),se.fillStyle="rgba(0, 212, 255, 0.1)",se.fill()}const T=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.frequency??1:1),C=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.amplitude??1:1),X=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.waveform??"sine":"sine");function E(ue){return{sine:"∿",saw:"⩘",square:"⊓",triangle:"△"}[ue]||ue}function k(ue){n.cell.boundNodeId&&r.setParam(n.cell.boundNodeId,"waveform",ue)}let R=0,N=0,O=0,$=0,G=!1;function ne(ue){if(n.editMode)return;G=!0;const se=ue.touches?ue.touches[0]:ue;R=se.clientX,N=se.clientY,O=T.value,$=C.value,window.addEventListener("pointermove",re),window.addEventListener("pointerup",we),window.addEventListener("touchmove",_e,{passive:!1}),window.addEventListener("touchend",we)}function re(ue){if(!G||!n.cell.boundNodeId)return;const se=ue.clientX-R,Ae=-(ue.clientY-N),De=Math.max(.01,Math.min(5,O+se*.05)),Qe=Math.max(0,Math.min(5,$+Ae*.02));r.setParam(n.cell.boundNodeId,"frequency",De),r.setParam(n.cell.boundNodeId,"amplitude",Qe)}function _e(ue){ue.preventDefault();const se=ue.touches[0];re({clientX:se.clientX,clientY:se.clientY})}function we(){G=!1,window.removeEventListener("pointermove",re),window.removeEventListener("pointerup",we),window.removeEventListener("touchmove",_e),window.removeEventListener("touchend",we)}const te=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.triggerInterval??.5:.5),L=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.damping??0:0),j=Ce(!1);let Q=null;function fe(ue){n.cell.boundNodeId&&(j.value=!1,Te.value=ue,H.value=ue==="triggerInterval"?"Self-Trigger Interval (s)":"Damping",W.value=r.nodeParams[n.cell.boundNodeId]?.[ue]??(ue==="triggerInterval"?.5:0),F.value=ue==="triggerInterval"?.01:.001,Se.value=!0,rn(()=>U.value?.focus?.()))}const Se=Ce(!1),Te=Ce(""),H=Ce(""),W=Ce(0),F=Ce(.01),U=Ce(null);n.cell.controlType==="random"&&lt(I,ue=>{!Se.value&&Q!==null&&Math.abs(ue-Q)>.005&&(j.value=!0,setTimeout(()=>{j.value=!1},300)),Q=ue});function z(ue){n.cell.boundNodeId&&(Te.value=ue,H.value=ue==="frequency"?"Frequency (Hz)":"Amplitude",W.value=r.nodeParams[n.cell.boundNodeId]?.[ue]??1,F.value=.01,Se.value=!0,rn(()=>U.value?.focus?.()))}function Y(ue){n.cell.boundNodeId&&Te.value&&!isNaN(ue)&&r.setParam(n.cell.boundNodeId,Te.value,ue),Se.value=!1}function S(ue){n.cell.boundNodeId&&(Te.value=ue,H.value=ue==="x"?"X Value":"Y Value",W.value=r.nodeParams[n.cell.boundNodeId]?.[ue]??.5,F.value=.001,Se.value=!0,rn(()=>U.value?.focus?.()))}const Z=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.x??.5:.5),J=Re(()=>n.cell.boundNodeId?r.nodeParams[n.cell.boundNodeId]?.y??.5:.5),ee=Re(()=>({left:Z.value*100+"%",top:(1-J.value)*100+"%"})),ie=Re(()=>({left:Z.value*100+"%",top:(1-J.value)*100+"%"}));let P=!1;function w(ue){P=!0,ge(ue),window.addEventListener("pointermove",K),window.addEventListener("pointerup",ae)}function K(ue){P&&ge(ue)}function ae(){P=!1,window.removeEventListener("pointermove",K),window.removeEventListener("pointerup",ae)}function ge(ue){const se=a.value;if(!se||!n.cell.boundNodeId)return;const Ae=se.getBoundingClientRect(),De=Math.max(0,Math.min(1,(ue.clientX-Ae.left)/Ae.width)),Qe=Math.max(0,Math.min(1,1-(ue.clientY-Ae.top)/Ae.height));r.setParam(n.cell.boundNodeId,"x",De),r.setParam(n.cell.boundNodeId,"y",Qe)}function de(ue){if(!n.cell.boundNodeId)return 50;const Ae=r.dataOutputs[n.cell.boundNodeId]?.[ue]??0;return Math.max(0,Math.min(100,(Ae+1)*50))}function Ue(ue){n.cell.boundNodeId&&n.cell.boundParamKey&&r.setParam(n.cell.boundNodeId,n.cell.boundParamKey,ue)}function Ie(){n.cell.boundNodeId&&r.triggerButton(n.cell.boundNodeId)}function Ge(ue){o.value=!0,ue.dataTransfer.setData("text/plain",String(n.index)),ue.dataTransfer.effectAllowed="move"}function Ye(){o.value=!1}function Pe(ue){const se=parseInt(ue.dataTransfer.getData("text/plain"),10);!isNaN(se)&&se!==n.index&&i("reorder",se,n.index)}return(ue,se)=>(ce(),me("div",{class:ut(["control-cell",{"control-cell--edit":t.editMode,"control-cell--unbound":!t.cell.boundNodeId&&!u.value,"control-cell--dragging":o.value}]),draggable:t.editMode,onDragstart:Ge,onDragend:Ye,onDragover:se[26]||(se[26]=Oe(()=>{},["prevent"])),onDrop:Pe},[t.editMode?(ce(),me("button",{key:0,class:"control-cell__delete",onClick:se[0]||(se[0]=Oe(Ae=>ue.$emit("delete"),["stop"]))},"✕")):He("",!0),!t.cell.boundNodeId&&!u.value?(ce(),me("div",{key:1,class:"control-cell__unbound",onClick:se[1]||(se[1]=Oe(Ae=>ue.$emit("assign"),["stop"]))},[q("span",A4,Ee(c.value),1),se[27]||(se[27]=q("span",{class:"control-cell__unbound-label"},"Tap to assign",-1))])):t.cell.controlType==="lfo"?(ce(),me("div",C4,[q("canvas",{ref_key:"graphCanvas",ref:s,class:"control-cell__mini-graph control-cell__mini-graph--interactive",width:"120",height:"50",onPointerdown:ne,onTouchstart:Oe(ne,["prevent"])},null,544),q("div",R4,[q("span",{class:"control-cell__value mono",onClick:se[2]||(se[2]=Oe(Ae=>z("frequency"),["stop"])),title:"Tap to edit"},Ee(T.value.toFixed(2))+" Hz",1),q("span",{class:"control-cell__value mono",onClick:se[3]||(se[3]=Oe(Ae=>z("amplitude"),["stop"])),title:"Tap to edit"},"amp "+Ee(C.value.toFixed(2)),1)]),q("div",I4,[(ce(),me(it,null,Ht(["sine","saw","square","triangle"],Ae=>q("button",{key:Ae,class:ut(["control-cell__wf-btn",{"control-cell__wf-btn--active":X.value===Ae}]),onClick:Oe(De=>k(Ae),["stop"])},Ee(E(Ae)),11,P4)),64))]),q("div",N4,Ee(f.value),1),h.value?(ce(),me("div",D4,Ee(h.value),1)):(ce(),me("div",L4,Ee(d.value||"LFO"),1))])):t.cell.controlType==="timer"?(ce(),me("div",F4,[q("canvas",{ref_key:"graphCanvas",ref:s,class:"control-cell__mini-graph",width:"120",height:"50"},null,512),q("div",U4,Ee(I.value?.toFixed(2)??"0.00")+" s",1),q("div",O4,Ee(f.value),1),h.value?(ce(),me("div",B4,Ee(h.value),1)):(ce(),me("div",k4,Ee(d.value||"Timer"),1))])):t.cell.controlType==="damper"?(ce(),me("div",z4,[q("canvas",{ref_key:"graphCanvas",ref:s,class:"control-cell__mini-graph",width:"120",height:"50"},null,512),q("div",V4,Ee(I.value?.toFixed(3)??"0.000"),1),q("div",$4,Ee(f.value),1),h.value?(ce(),me("div",H4,Ee(h.value),1)):(ce(),me("div",G4,Ee(d.value||"Damper"),1))])):t.cell.controlType==="random"?(ce(),me("div",{key:5,class:ut(["control-cell__widget control-cell__anim-widget control-cell__random-widget",{"control-cell__random-widget--pulsing":j.value}])},[q("canvas",{ref_key:"graphCanvas",ref:s,class:"control-cell__mini-graph",width:"120",height:"50"},null,512),q("div",W4,Ee(I.value?.toFixed(3)??"0.000"),1),q("div",{class:"control-cell__lfo-readout",onPointerdown:se[6]||(se[6]=Oe(()=>{},["stop"])),onMousedown:se[7]||(se[7]=Oe(()=>{},["stop"]))},[q("span",{class:"control-cell__value mono control-cell__value--tappable",onClick:se[4]||(se[4]=Oe(Ae=>fe("triggerInterval"),["stop"])),title:"Tap to edit"},"⏱ "+Ee(te.value.toFixed(2))+"s",1),q("span",{class:"control-cell__value mono control-cell__value--tappable",onClick:se[5]||(se[5]=Oe(Ae=>fe("damping"),["stop"])),title:"Tap to edit"},"◈ "+Ee(L.value.toFixed(3)),1)],32),q("div",X4,Ee(f.value),1),h.value?(ce(),me("div",Y4,Ee(h.value),1)):(ce(),me("div",q4,Ee(d.value||"Random"),1)),j.value?(ce(),me("div",K4)):He("",!0)],2)):t.cell.controlType==="fft"?(ce(),me("div",Z4,[q("div",j4,[q("div",{class:"control-cell__fft-bar",style:rt({height:D.value.bass*100+"%"})},[...se[28]||(se[28]=[q("span",null,"B",-1)])],4),q("div",{class:"control-cell__fft-bar",style:rt({height:D.value.lowMid*100+"%"})},[...se[29]||(se[29]=[q("span",null,"LM",-1)])],4),q("div",{class:"control-cell__fft-bar",style:rt({height:D.value.mid*100+"%"})},[...se[30]||(se[30]=[q("span",null,"M",-1)])],4),q("div",{class:"control-cell__fft-bar",style:rt({height:D.value.high*100+"%"})},[...se[31]||(se[31]=[q("span",null,"H",-1)])],4)]),se[32]||(se[32]=q("div",{class:"control-cell__label"},"FFT",-1)),q("div",J4,Ee(d.value||"Audio FFT"),1)])):t.cell.controlType==="knob"?(ce(),me("div",{key:7,class:"control-cell__widget",onPointerdown:se[8]||(se[8]=Oe(()=>{},["stop"])),onMousedown:se[9]||(se[9]=Oe(()=>{},["stop"]))},[tt(sx,{modelValue:p.value,min:b.value,max:M.value,step:_.value,size:null,"onUpdate:modelValue":Ue},null,8,["modelValue","min","max","step"]),q("div",Q4,Ee(f.value),1),q("div",e5,Ee(d.value),1)],32)):t.cell.controlType==="slider"?(ce(),me("div",{key:8,class:"control-cell__widget",onPointerdown:se[11]||(se[11]=Oe(()=>{},["stop"])),onMousedown:se[12]||(se[12]=Oe(()=>{},["stop"]))},[q("input",{type:"range",class:"control-cell__slider",min:b.value,max:M.value,step:_.value,value:p.value,onInput:se[10]||(se[10]=Ae=>Ue(Number(Ae.target.value)))},null,40,t5),q("div",n5,Ee(p.value?.toFixed(2)),1),q("div",i5,Ee(f.value),1),q("div",r5,Ee(d.value),1)],32)):t.cell.controlType==="bang"?(ce(),me("div",{key:9,class:"control-cell__widget",onPointerdown:se[13]||(se[13]=Oe(()=>{},["stop"])),onMousedown:se[14]||(se[14]=Oe(()=>{},["stop"]))},[q("button",{class:"control-cell__bang-btn",onClick:Oe(Ie,["stop"])},Ee(f.value||"Bang!"),1),q("div",o5,Ee(d.value),1)],32)):t.cell.controlType==="toggle"?(ce(),me("div",{key:10,class:"control-cell__widget",onPointerdown:se[16]||(se[16]=Oe(()=>{},["stop"])),onMousedown:se[17]||(se[17]=Oe(()=>{},["stop"]))},[q("button",{class:ut(["control-cell__toggle-btn",{"control-cell__toggle-btn--active":!!p.value}]),onClick:se[15]||(se[15]=Oe(Ae=>Ue(!p.value),["stop"]))},Ee(p.value?"ON":"OFF"),3),q("div",s5,Ee(f.value),1),q("div",a5,Ee(d.value),1)],32)):t.cell.controlType==="xypad"?(ce(),me("div",{key:11,class:"control-cell__widget",onPointerdown:se[20]||(se[20]=Oe(()=>{},["stop"])),onMousedown:se[21]||(se[21]=Oe(()=>{},["stop"]))},[q("div",{class:"control-cell__xypad",ref_key:"xyPadRef",ref:a,onPointerdown:w},[q("div",{class:"control-cell__xypad-crosshair",style:rt(ee.value)},null,4),q("div",{class:"control-cell__xypad-glow",style:rt(ie.value)},null,4)],544),q("div",l5,[q("span",{class:"control-cell__value mono",onClick:se[18]||(se[18]=Oe(Ae=>S("x"),["stop"])),title:"Tap to edit"},"X: "+Ee(Z.value.toFixed(2)),1),q("span",{class:"control-cell__value mono",onClick:se[19]||(se[19]=Oe(Ae=>S("y"),["stop"])),title:"Tap to edit"},"Y: "+Ee(J.value.toFixed(2)),1)]),m.value||v.value?(ce(),me("div",u5,[m.value?(ce(),me("div",c5,Ee(m.value),1)):He("",!0),v.value?(ce(),me("div",d5,Ee(v.value),1)):He("",!0)])):He("",!0),q("div",f5,Ee(f.value),1),!m.value&&!v.value?(ce(),me("div",h5,Ee(d.value),1)):He("",!0)],32)):t.cell.controlType==="accelerometer"?(ce(),me("div",p5,[q("div",m5,[q("div",g5,[se[33]||(se[33]=q("span",{class:"control-cell__accel-label"},"X",-1)),q("div",v5,[q("div",{class:"control-cell__accel-bar",style:rt({width:de("x")+"%",background:"#ff4757"})},null,4)])]),q("div",_5,[se[34]||(se[34]=q("span",{class:"control-cell__accel-label"},"Y",-1)),q("div",y5,[q("div",{class:"control-cell__accel-bar",style:rt({width:de("y")+"%",background:"#2ed573"})},null,4)])])]),se[35]||(se[35]=q("div",{class:"control-cell__label"},"Accelerometer",-1)),q("div",x5,Ee(d.value),1)])):He("",!0),(ce(),Jt(_h,{to:"body"},[Se.value?(ce(),me("div",{key:0,class:"value-edit-overlay",onClick:se[25]||(se[25]=Oe(Ae=>Se.value=!1,["self"]))},[q("div",b5,[q("div",S5,Ee(H.value),1),q("input",{ref_key:"valueEditInput",ref:U,type:"number",class:"value-edit-popup__input",value:W.value,step:F.value,onKeydown:se[22]||(se[22]=z1(Ae=>Y(Number(Ae.target.value)),["enter"]))},null,40,M5),q("div",w5,[q("button",{class:"value-edit-popup__btn",onClick:se[23]||(se[23]=Ae=>Se.value=!1)},"Cancel"),q("button",{class:"value-edit-popup__btn value-edit-popup__btn--ok",onClick:se[24]||(se[24]=Ae=>Y(Number(ue.$refs.valueEditInput?.value)))},"OK")])])])):He("",!0)]))],42,T4))}},T5=cr(E5,[["__scopeId","data-v-d1dd8399"]]),A5={class:"radial-menu__center"},C5={class:"radial-menu__segment-icon"},R5={class:"radial-menu__segment-label"},I5={class:"radial-menu__segment-icon"},P5={class:"radial-menu__segment-label"},lv=100,Il=64,N5={__name:"RadialMenu",props:{categories:{type:Array,default:()=>[]}},emits:["select","cancel"],setup(t,{expose:e,emit:n}){const i=t,r=n,o=Ce(!1),s=Ce(0),a=Ce(0),l=Ce(null),u=Ce(null),c=Re(()=>u.value?i.categories.find(p=>p.id===u.value)?.items||[]:[]);function d(g,p){s.value=g,a.value=p,l.value=null,u.value=null,o.value=!0}function f(){o.value=!1,l.value=null,u.value=null}function h(g,p){const b=g/p*2*Math.PI-Math.PI/2,M=Math.cos(b)*lv,_=Math.sin(b)*lv;return{transform:`translate(${M-Il/2}px, ${_-Il/2}px)`,width:Il+"px",height:Il+"px"}}function m(g){const p=g.clientX-s.value,b=g.clientY-a.value;if(Math.sqrt(p*p+b*b)<30){l.value=null;return}const _=Math.atan2(b,p),I=u.value?c.value:i.categories,D=I.length;if(D===0)return;const B=(_+Math.PI/2+2*Math.PI)%(2*Math.PI),y=Math.floor(B/(2*Math.PI/D))%D;l.value=I[y]?.id||null}function v(){if(!l.value){if(u.value){u.value=null,l.value=null;return}r("cancel"),f();return}if(!u.value){u.value=l.value,l.value=null;return}r("select",l.value),f()}return e({show:d,hide:f,visible:o}),(g,p)=>(ce(),Jt(_h,{to:"body"},[o.value?(ce(),me("div",{key:0,class:"radial-overlay",onPointerup:v,onPointermove:m,onTouchmove:p[0]||(p[0]=Oe(()=>{},["prevent"]))},[q("div",{class:"radial-menu",style:rt({left:s.value+"px",top:a.value+"px"})},[q("div",A5,Ee(u.value?u.value:l.value||"⊕"),1),u.value?(ce(!0),me(it,{key:1},Ht(c.value,(b,M)=>(ce(),me("div",{key:b.id,class:ut(["radial-menu__segment",{"radial-menu__segment--active":l.value===b.id}]),style:rt(h(M,c.value.length))},[q("span",I5,Ee(b.icon),1),q("span",P5,Ee(b.label),1)],6))),128)):(ce(!0),me(it,{key:0},Ht(t.categories,(b,M)=>(ce(),me("div",{key:b.id,class:ut(["radial-menu__segment",{"radial-menu__segment--active":l.value===b.id}]),style:rt(h(M,t.categories.length))},[q("span",C5,Ee(b.icon),1),q("span",R5,Ee(b.label),1)],6))),128))],4)],32)):He("",!0)]))}},D5=cr(N5,[["__scopeId","data-v-ffb4e9d0"]]),L5={class:"control-drawer__handle-arrow"},F5={class:"control-drawer__handle-actions"},U5=["title"],O5={class:"control-drawer__grid"},B5={class:"assign-popup"},k5={class:"assign-popup__header"},z5={key:0,class:"assign-popup__empty"},V5=["onClick"],$5={class:"assign-popup__item-node"},H5={class:"assign-popup__item-param"},G5={key:1,class:"assign-popup__skip-row"},W5={__name:"ControlDrawer",setup(t){const e=Ao(),n=Ce(!1),i=Ce(null),r=Ce(!1),o=Ce(null),s=Ce(!1),a=Ce(null),l=Ce(null);let u=null,c=!1;const d=[{id:"controls",label:"Controls",icon:"🎛️",items:[{id:"knob",label:"Knob",icon:"🎛️"},{id:"slider",label:"Slider",icon:"═══"},{id:"bang",label:"Bang",icon:"💥"},{id:"toggle",label:"Toggle",icon:"⏻"},{id:"xypad",label:"XY Pad",icon:"✛"}]},{id:"animation",label:"Animation",icon:"🌊",items:[{id:"lfo",label:"LFO",icon:"〜️"},{id:"timer",label:"Timer",icon:"⏱️"},{id:"damper",label:"Damper",icon:"🫧"},{id:"fft",label:"FFT",icon:"🎵"}]}],f=Re(()=>e.getUnboundExposedParams()),h=Re(()=>l.value||(s.value?"Route Output To…":"Assign Parameter"));lt(()=>e.isPerformanceMode,x=>{x&&m()},{immediate:!0});function m(){const x=e.getControlNodes(),A=new Set(e.perfGridCells.map(T=>T.boundNodeId).filter(Boolean));for(const T of x){if(A.has(T.id))continue;const X={knob:"knob",slider:"slider",bang:"bang",button:"toggle",toggle:"toggle"}[T.type];if(!X)continue;const E=e.addPerfCell(X),k=T.data?.def;if(k?.params){const R=Object.keys(k.params)[0];R&&e.bindPerfCell(E,T.id,R)}}}function v(x){c=!1;const A=x.touches?x.touches[0]:x,T=A.clientX,C=A.clientY;u=setTimeout(()=>{c=!0,i.value?.show(T,C)},400)}function g(){clearTimeout(u)}function p(){if(c)return;const x=e.addPerfCell("knob");o.value=x,r.value=!0}function b(x){const A={lfo:"lfo",timer:"timer",damper:"damper",fft:"fft",random:"random",accelerometer:"accelerometer",xypad:"xyPad"};if(A[x]){const C=A[x],X=e.addNode(C,{x:100+Math.random()*200,y:100+Math.random()*200});if(X){const E=e.addPerfCell(x);e.bindPerfCell(E,X,null),x==="accelerometer"&&B(X),o.value=E,s.value=!0,r.value=!0}return}const T=e.addPerfCell(x);o.value=T,s.value=!1,r.value=!0}function M(x){o.value=x,r.value=!0}function _(x,A,T,C){const X=e.nodes.find(O=>O.id===A);if(!X)return;const k=en(X.type)?.params?.[T];if(!k)return;const R=k.min??0,N=k.max??1;C==="X"?(e.setParam(x,"minX",R),e.setParam(x,"maxX",N)):(e.setParam(x,"minY",R),e.setParam(x,"maxY",N))}function I(x){if(!o.value)return;const A=e.perfGridCells.find(T=>T.id===o.value);if(!A){r.value=!1;return}if(s.value)if(A.controlType==="xypad"&&!a.value){e.bindPerfCellTarget(A.id,x.nodeId,x.paramKey),_(A.boundNodeId,x.nodeId,x.paramKey,"X"),e.addEdge({source:A.boundNodeId,sourceHandle:"x",target:x.nodeId,targetHandle:x.paramKey}),a.value="y",l.value="Assign Y Axis To…";return}else if(A.controlType==="xypad"&&a.value==="y")e.bindPerfCellTargetY(A.id,x.nodeId,x.paramKey),_(A.boundNodeId,x.nodeId,x.paramKey,"Y"),e.addEdge({source:A.boundNodeId,sourceHandle:"y",target:x.nodeId,targetHandle:x.paramKey}),a.value=null,l.value=null;else{e.bindPerfCellTarget(A.id,x.nodeId,x.paramKey);const T=A.controlType==="fft"?"bass":A.controlType==="accelerometer"?"x":"out";e.addEdge({source:A.boundNodeId,sourceHandle:T,target:x.nodeId,targetHandle:x.paramKey})}else e.bindPerfCell(A.id,x.nodeId,x.paramKey);r.value=!1,o.value=null,a.value=null,l.value=null}function D(x,A){e.reorderPerfCells(x,A)}function B(x){typeof DeviceMotionEvent<"u"&&(typeof DeviceMotionEvent.requestPermission=="function"?DeviceMotionEvent.requestPermission().then(A=>{A==="granted"&&y(x)}).catch(console.warn):y(x))}function y(x){window.addEventListener("devicemotion",A=>{const T=e.nodes.find(X=>X.id===x);if(!T)return;const C=A.accelerationIncludingGravity;C&&(T._accelX=(C.x??0)/9.81,T._accelY=(C.y??0)/9.81,T._accelZ=(C.z??0)/9.81)})}return(x,A)=>(ce(),me("div",{class:ut(["control-drawer",{"control-drawer--collapsed":n.value}])},[q("div",{class:"control-drawer__handle",onClick:A[1]||(A[1]=T=>n.value=!n.value)},[q("span",L5,Ee(n.value?"▲":"▼"),1),A[5]||(A[5]=q("span",{class:"control-drawer__handle-title"},"Controls",-1)),q("div",F5,[q("button",{class:ut(["control-drawer__lock-btn",{"control-drawer__lock-btn--unlocked":he(e).isPerfEditMode}]),onClick:A[0]||(A[0]=Oe(T=>he(e).togglePerfEditMode(),["stop"])),title:he(e).isPerfEditMode?"Lock Controls":"Unlock to Edit"},Ee(he(e).isPerfEditMode?"🔓":"🔒"),11,U5)])]),Dr(q("div",O5,[(ce(!0),me(it,null,Ht(he(e).perfGridCells,(T,C)=>(ce(),Jt(T5,{key:T.id,cell:T,"edit-mode":he(e).isPerfEditMode,index:C,onDelete:X=>he(e).removePerfCell(T.id),onAssign:X=>M(T.id),onReorder:D},null,8,["cell","edit-mode","index","onDelete","onAssign"]))),128)),he(e).isPerfEditMode?(ce(),me("div",{key:0,class:"control-drawer__add-cell",onPointerdown:v,onPointerup:g,onPointerleave:g,onTouchstart:Oe(v,["prevent"]),onClick:p},[...A[6]||(A[6]=[q("span",{class:"control-drawer__add-icon"},"➕",-1),q("span",{class:"control-drawer__add-label"},[hi("Hold for menu"),q("br"),hi("Tap to quick-add")],-1)])],32)):He("",!0)],512),[[Lr,!n.value]]),tt(D5,{ref_key:"radialMenuRef",ref:i,categories:d,onSelect:b,onCancel:()=>{}},null,512),(ce(),Jt(_h,{to:"body"},[r.value?(ce(),me("div",{key:0,class:"assign-overlay",onClick:A[4]||(A[4]=Oe(T=>r.value=!1,["self"]))},[q("div",B5,[q("div",k5,Ee(h.value),1),f.value.length===0?(ce(),me("div",z5,[A[7]||(A[7]=hi(" No unbound exposed parameters available. ",-1)),A[8]||(A[8]=q("br",null,null,-1)),A[9]||(A[9]=q("br",null,null,-1)),A[10]||(A[10]=q("span",{style:{"font-size":"11px",opacity:"0.7"}}," Expose parameters in Editor Mode first (🔗 icon in the inspector). ",-1)),A[11]||(A[11]=q("br",null,null,-1)),A[12]||(A[12]=q("br",null,null,-1)),s.value?(ce(),me("button",{key:0,class:"assign-popup__skip-btn",onClick:A[2]||(A[2]=T=>r.value=!1)},"Skip — use standalone")):He("",!0)])):He("",!0),(ce(!0),me(it,null,Ht(f.value,T=>(ce(),me("div",{key:`${T.nodeId}::${T.paramKey}`,class:"assign-popup__item",onClick:C=>I(T)},[q("span",$5,Ee(T.nodeLabel),1),A[13]||(A[13]=q("span",{class:"assign-popup__item-sep"},"→",-1)),q("span",H5,Ee(T.paramLabel),1)],8,V5))),128)),s.value&&f.value.length>0?(ce(),me("div",G5,[q("button",{class:"assign-popup__skip-btn",onClick:A[3]||(A[3]=T=>r.value=!1)},"Skip — use standalone")])):He("",!0)])])):He("",!0)]))],2))}},X5=cr(W5,[["__scopeId","data-v-6a70db30"]]),Y5={class:"perf-view"},q5={class:"perf-view__toolbar"},K5={class:"perf-view__badge mono"},Z5={class:"perf-view__zoom-level mono"},j5={key:0,class:"perf-view__histogram"},J5={__name:"PerformanceView",props:{fps:{type:Number,default:0}},setup(t,{expose:e}){const n=Ao(),i=Ce(null),r=Ce(null),o=Ce(null),s=Ce(!1),a=Ce(1),l=Ce(0),u=Ce(0);let c=!1,d=0,f=0,h=0,m=0;const v=Re(()=>{const x=i.value;return x?`${x.width}×${x.height}`:"—"});function g(x){const A=x.deltaY>0?.9:1.1,T=Math.max(.1,Math.min(10,a.value*A)),C=r.value?.getBoundingClientRect();if(C){const X=x.clientX-C.left,E=x.clientY-C.top;l.value=X-(X-l.value)*(T/a.value),u.value=E-(E-u.value)*(T/a.value)}a.value=T}function p(x){(x.button===1||x.button===0)&&(c=!0,d=x.clientX,f=x.clientY,h=l.value,m=u.value,x.currentTarget?.setPointerCapture?.(x.pointerId))}function b(x){c&&(l.value=h+(x.clientX-d),u.value=m+(x.clientY-f))}function M(){c=!1}function _(){const x=r.value,A=i.value;if(!x||!A||!A.width||!A.height)return;const T=x.clientWidth,C=x.clientHeight,X=Math.min(T/A.width,C/A.height);a.value=X,l.value=(T-A.width*X)/2,u.value=(C-A.height*X)/2}function I(){a.value=1;const x=r.value,A=i.value;x&&A&&(l.value=(x.clientWidth-A.width)/2,u.value=(x.clientHeight-A.height)/2)}lt(s,async x=>{x&&(await rn(),D())});function D(){const x=i.value,A=o.value;if(!x||!A||!x.width)return;const T=document.createElement("canvas");T.width=x.width,T.height=x.height;const C=T.getContext("2d");C.drawImage(x,0,0);const E=C.getImageData(0,0,T.width,T.height).data,k=new Array(256).fill(0),R=new Array(256).fill(0),N=new Array(256).fill(0);for(let _e=0;_e<E.length;_e+=4)k[E[_e]]++,R[E[_e+1]]++,N[E[_e+2]]++;const O=Math.max(...k,...R,...N,1),$=A.getContext("2d"),G=A.width,ne=A.height;$.clearRect(0,0,G,ne);function re(_e,we){$.strokeStyle=we,$.lineWidth=1,$.globalAlpha=.6,$.beginPath();for(let te=0;te<256;te++){const L=te/255*G,j=ne-_e[te]/O*ne;te===0?$.moveTo(L,j):$.lineTo(L,j)}$.stroke()}re(k,"#ff4757"),re(R,"#2ed573"),re(N,"#1e90ff"),$.globalAlpha=1}let B=null;lt(s,x=>{x?B=setInterval(D,500):clearInterval(B)},{immediate:!0});function y(){setTimeout(()=>_(),100)}return mn(async()=>{await rn(),_(),window.addEventListener("resize",y),window.addEventListener("orientationchange",y)}),lr(()=>{window.removeEventListener("resize",y),window.removeEventListener("orientationchange",y),clearInterval(B)}),e({perfCanvasRef:i}),(x,A)=>(ce(),me("div",Y5,[q("div",{class:"perf-view__renderer",ref_key:"viewportRef",ref:r,onWheel:Oe(g,["prevent"]),onPointerdown:p,onPointermove:b,onPointerup:M},[q("div",{class:"perf-view__canvas-wrap",style:rt({transform:`translate(${l.value}px, ${u.value}px) scale(${a.value})`,transformOrigin:"0 0"})},[q("canvas",{ref_key:"perfCanvasRef",ref:i,class:"perf-view__canvas"},null,512)],4)],544),q("div",q5,[q("span",K5,Ee(v.value),1),q("span",{class:ut(["perf-view__badge perf-view__fps mono",{"perf-view__fps--ok":t.fps>=50}])},Ee(t.fps)+" FPS",3),A[2]||(A[2]=q("div",{style:{flex:"1"}},null,-1)),q("span",Z5,Ee(Math.round(a.value*100))+"%",1),q("button",{class:"perf-view__tool-btn",onClick:_,title:"Fit to viewport"},"⊡"),q("button",{class:"perf-view__tool-btn",onClick:I,title:"1:1 pixel zoom"},"1:1"),q("button",{class:ut(["perf-view__tool-btn",{active:s.value}]),onClick:A[0]||(A[0]=T=>s.value=!s.value),title:"Toggle Histogram"},"📊",2),A[3]||(A[3]=q("div",{class:"perf-view__divider"},null,-1)),q("button",{class:"perf-view__exit-btn",onClick:A[1]||(A[1]=T=>he(n).togglePerformanceMode()),title:"Exit Performance Mode"}," ✕ Editor ")]),s.value?(ce(),me("div",j5,[q("canvas",{ref_key:"histCanvas",ref:o,class:"perf-view__hist-canvas",width:"256",height:"60"},null,512)])):He("",!0),tt(X5)]))}},Q5=cr(J5,[["__scopeId","data-v-04047ee9"]]),ez=`// Passthrough — renders texture as-is\r
...
void main()`),r=r.replace(/gl_FragColor\s*=\s*([^;]+);([^;]*)$/,`vec4 effectColor = $1;
  ...
  `),I.document.close(),setTimeout(()=>{const O=I.document.getElementById("out");O&&(D=O.getContext("2d"))},50),m&&(m.customWindow=I),I.addEventListener("beforeunload",()=>{m&&(m.customWindow=null),I=null,D=null})}mn(async()=>{await rn(),window.addEventListener("click",f),window.addEventListener("keydown",f),window.addEventListener("keydown",y),c&&(e.isPerformanceMode=!0);const O=i.value?.getCanvas?.();O&&(h=new Ez,h.init(O,512,512)),r.value&&(_=r.value.getContext("2d")),e.onNodeRemoved($=>{h&&h.removeNodeResources($),delete M[$]}),b=performance.now(),m=new Tz,v=m.onFrame(($,G)=>{if(!e.isRendering)return;p++;const ne=performance.now();ne-b>=500&&(g.value=Math.round(p/(ne-b)*1e3),p=0,b=ne),x($)}),m.start(),await e.loadFromLocalStorage()}),lr(()=>{v&&v(),m&&m.stop(),h&&h.dispose(),window.removeEventListener("keydown",y),window.removeEventListener("orientationchange",checkPortrait),window.removeEventListener("resize",checkPortrait),clearTimeout(rotateHintTimer)});function y(O){O.target.tagName==="INPUT"||O.target.tagName==="TEXTAREA"||O.target.tagName==="SELECT"||(O.key==="p"||O.key==="P")&&(O.preventDefault(),e.togglePerformanceMode())}function x(O,$){if(!h?.isInitialized)return;const G=e.nodes,ne=e.edges,re=e.nodeParams;if(G.length===0){_&&r.value&&_.clearRect(0,0,r.value.width,r.value.height);return}const _e=Az(G,ne),we=Rz(_e,G,ne,re,O);e.dataOutputs=we;const te=["lfo","timer","damper","fft","xypad","accelerometer"];for(const Q of e.perfGridCells){if(!Q.boundNodeId||!te.includes(Q.controlType))continue;const fe=we[Q.boundNodeId];fe&&(Q.controlType==="xypad"?(Q.boundParamKey&&Q.boundTargetNodeId&&e.setParam(Q.boundTargetNodeId,Q.boundParamKey,fe.x??.5),Q.boundParamKeyY&&Q.boundTargetNodeIdY&&e.setParam(Q.boundTargetNodeIdY,Q.boundParamKeyY,fe.y??.5)):Q.controlType==="fft"?Q.boundParamKey&&Q.boundTargetNodeId&&e.setParam(Q.boundTargetNodeId,Q.boundParamKey,fe.bass??0):Q.controlType==="accelerometer"?Q.boundParamKey&&Q.boundTargetNodeId&&e.setParam(Q.boundTargetNodeId,Q.boundParamKey,fe.x??0):Q.boundParamKey&&Q.boundTargetNodeId&&e.setParam(Q.boundTargetNodeId,Q.boundParamKey,fe.out??0))}const L=Iz(_e,G),j=h.execute(L,G,ne,re,we,e.previewNodeId,O);if(e.perfTimings=j||{},e.previewMode==="background"&&_&&r.value){const Q=i.value?.getCanvas?.();Q&&Q.width>0&&Q.height>0&&((r.value.width!==Q.width||r.value.height!==Q.height)&&(r.value.width=Q.width,r.value.height=Q.height),_.clearRect(0,0,r.value.width,r.value.height),_.drawImage(Q,0,0))}if(I&&!I.closed&&D){const Q=i.value?.getCanvas?.();if(Q&&Q.width>0&&Q.height>0){const fe=D.canvas;(fe.width!==Q.width||fe.height!==Q.height)&&(fe.width=Q.width,fe.height=Q.height),D.clearRect(0,0,fe.width,fe.height),D.drawImage(Q,0,0)}}if(e.isPerformanceMode&&o.value?.perfCanvasRef){const Q=i.value?.getCanvas?.(),fe=o.value.perfCanvasRef;if(Q&&Q.width>0&&Q.height>0){(fe.width!==Q.width||fe.height!==Q.height)&&(fe.width=Q.width,fe.height=Q.height);const Se=fe.getContext("2d");Se.clearRect(0,0,fe.width,fe.height),Se.drawImage(Q,0,0)}}}function A(O){if(n.value&&n.value.addNodeAtCenter)n.value.addNodeAtCenter(O);else{const $=300+Math.random()*200,G=200+Math.random()*200;e.addNode(O,{x:$,y:G})}}function T(O,$){if(!h)return;M[O]=$;let G;$.isVideo?(G=new aM($.img),G.minFilter=Rt,G.magFilter=Rt,G.format=bn):(G=new on($.img),G.needsUpdate=!0),h.setInputTexture(O,G),C(O),h.resize($.width,$.height),i.value&&(i.value.width=$.width,i.value.height=$.height)}function C(O){if(!h)return;const $=new Set,G=[O];for(;G.length;){const ne=G.shift();if(!$.has(ne)){$.add(ne);for(const re of e.edges)re.source===ne&&!$.has(re.target)&&(h.fbos[re.target]&&(h.fbos[re.target].dispose(),delete h.fbos[re.target]),h.materials[re.target]&&(h.materials[re.target].dispose(),delete h.materials[re.target]),G.push(re.target))}}}function X(O){if(!h)return;const $=e.edges.filter(Te=>Te.target===O);let G=null;for(const Te of $)if(Te.targetHandle==="in"){G=Te.source;break}if(!G){alert("No image connected to output node");return}const ne=h.readPixels(G);if(!ne){alert("Could not read pixels — make sure an image is connected and the pipeline has run");return}const{pixels:re,width:_e,height:we}=ne,L=(e.nodeParams[O]||{}).filename||e.projectTitle||"output",j=document.createElement("canvas");j.width=_e,j.height=we;const Q=j.getContext("2d"),fe=Q.createImageData(_e,we);for(let Te=0;Te<we;Te++)for(let H=0;H<_e;H++){const W=((we-1-Te)*_e+H)*4,F=(Te*_e+H)*4;fe.data[F]=re[W],fe.data[F+1]=re[W+1],fe.data[F+2]=re[W+2],fe.data[F+3]=re[W+3]}Q.putImageData(fe,0,0);const Se=L.replace(/[^a-zA-Z0-9_-]/g,"_");j.toBlob(Te=>{if(!Te)return;const H=URL.createObjectURL(Te),W=document.createElement("a");W.href=H,W.download=`${Se}.png`,W.click(),URL.revokeObjectURL(H)},"image/png")}function E(){e.saveToLocalStorage()}async function k(){await e.loadFromLocalStorage()||alert("No saved graph found")}function R(O){e.loadGraph(O)||alert("Failed to import graph — invalid JSON")}function N(){confirm("Clear entire graph? This cannot be undone.")&&(e.resetGraph(),Object.keys(M).forEach(O=>delete M[O]))}return(O,$)=>(ce(),me("div",Pz,[Dr(tt(PC,{"is-rendering":he(e).isRendering,"preview-mode":he(e).previewMode,"project-title":he(e).projectTitle,"show-shadows":he(e).showShadows,"is-performance-mode":he(e).isPerformanceMode,onSave:E,onLoad:k,onDownload:$[0]||($[0]=G=>he(e).downloadGraph()),onImport:R,onReset:N,onToggleRender:$[1]||($[1]=G=>he(e).toggleRendering()),onTogglePreview:$[2]||($[2]=G=>he(e).togglePreviewMode()),onToggleShadows:$[3]||($[3]=G=>he(e).showShadows=!he(e).showShadows),onOpenPopup:B,onUpdateTitle:$[4]||($[4]=G=>he(e).projectTitle=G),onUpdateBgOpacity:$[5]||($[5]=G=>he(e).bgOpacity=G),onTogglePerformance:$[6]||($[6]=G=>he(e).togglePerformanceMode())},null,8,["is-rendering","preview-mode","project-title","show-shadows","is-performance-mode"]),[[Lr,!he(e).isPerformanceMode]]),he(e).isPerformanceMode?(ce(),Jt(Q5,{key:0,ref_key:"perfViewRef",ref:o,fps:g.value},null,8,["fps"])):He("",!0),Dr(q("div",Nz,[tt(HC,{onAddNode:A}),q("div",{class:ut(["editor-area",{"editor-area--bg-mode":he(e).previewMode==="background"}])},[Dr(q("div",Dz,[q("canvas",{ref_key:"bgCanvasRef",ref:r},null,512),q("div",{class:"preview-background__overlay",style:rt({opacity:he(e).bgOpacity})},null,4)],512),[[Lr,he(e).previewMode==="background"]]),tt(Rk,{ref_key:"editorRef",ref:n,class:ut({"editor-canvas--no-shadows":!he(e).showShadows}),onImageLoaded:T,onExportImage:X},null,8,["class"]),Dr(tt(Bk,{ref_key:"previewRef",ref:i,"is-rendering":he(e).isRendering,fps:g.value,"preview-mode":he(e).previewMode},null,8,["is-rendering","fps","preview-mode"]),[[Lr,he(e).previewMode==="anchored"||he(e).previewMode==="floating"]])],2),tt(E4)],512),[[Lr,!he(e).isPerformanceMode]]),tt(Bp,{name:"rotate-hint"},{default:dn(()=>[s.value?(ce(),me("div",Lz,[...$[7]||($[7]=[q("div",{class:"rotate-hint__icon",style:{"animation-name":"hint-rotate-landscape"}},"📱",-1),q("div",{class:"rotate-hint__text"},"Rotate to landscape for Editor mode",-1)])])):He("",!0)]),_:1}),tt(Bp,{name:"rotate-hint"},{default:dn(()=>[a.value?(ce(),me("div",Fz,[...$[8]||($[8]=[q("div",{class:"rotate-hint__icon"},"📱",-1),q("div",{class:"rotate-hint__text"},"Rotate to portrait for Performance mode",-1)])])):He("",!0)]),_:1})]))}},lx=H1(Uz);lx.use(X1());lx.mount("#app");
