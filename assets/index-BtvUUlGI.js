...
`)+`
`+p);const v=b+m+s,x=b+p+a,L=Xp(r,r.VERTEX_SHADER,v),O=Xp(r,r.FRAGMENT_SHADER,x);r.attachShader(_,L),r.attachShader(_,O),n.index0AttributeName!==void 0?r.bindAttribLocation(_,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function U(N){if(t.debug.checkShaderErrors){const I=r.getProgramInfoLog(_)||"",q=r.getShaderInfoLog(L)||"",M=r.getShaderInfoLog(O)||"",D=I.trim(),T=q.trim(),C=M.trim();let V=!0,X=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(V=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,_,L,O);else{const k=qp(r,L,"vertex"),Y=qp(r,O,"fragment");gt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
