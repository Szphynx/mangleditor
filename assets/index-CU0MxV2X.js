...
`)+`
`+p);const v=b+m+s,x=b+p+a,D=Xp(r,r.VERTEX_SHADER,v),O=Xp(r,r.FRAGMENT_SHADER,x);r.attachShader(_,D),r.attachShader(_,O),n.index0AttributeName!==void 0?r.bindAttribLocation(_,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function U(N){if(t.debug.checkShaderErrors){const I=r.getProgramInfoLog(_)||"",q=r.getShaderInfoLog(D)||"",M=r.getShaderInfoLog(O)||"",L=I.trim(),T=q.trim(),C=M.trim();let V=!0,X=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(V=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,_,D,O);else{const k=qp(r,D,"vertex"),Y=qp(r,O,"fragment");gt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
Edge: ${t}`,USEVUEFLOW_OPTIONS:()=>"The options parameter is deprecated and will be removed in the next major version. Please use the id parameter instead"};class Wt extends Error{constructor(e,...n){var i;super((i=Dm[e])==null?void 0:i.call(Dm,...n)),this.name="VueFlowError",this.code=e,this.args=n}}function ch(t){return"clientX"in t}function vP(t){return"sourceEvent"in t}function li(t,e){const n=ch(t);let i,r;return n?(i=t.clientX,r=t.clientY):"touches"in t&&t.touches.length>0?(i=t.touches[0].clientX,r=t.touches[0].clientY):"changedTouches"in t&&t.changedTouches.length>0?(i=t.changedTouches[0].clientX,r=t.changedTouches[0].clientY):(i=0,r=0),{x:i-(e?.left??0),y:r-(e?.top??0)}}const na=()=>{var t;return typeof navigator<"u"&&((t=navigator?.userAgent)==null?void 0:t.indexOf("Mac"))>=0};function _P(t){var e,n;return{width:((e=t.dimensions)==null?void 0:e.width)??t.width??0,height:((n=t.dimensions)==null?void 0:n.height)??t.height??0}}function Cc(t,e=[1,1]){return{x:e[0]*Math.round(t.x/e[0]),y:e[1]*Math.round(t.y/e[1])}}const xP=()=>!0;function Bu(t){t?.classList.remove("valid","connecting","vue-flow__handle-valid","vue-flow__handle-connecting")}function yP(t,e,n){const i=[],r={x:t.x-n,y:t.y-n,width:n*2,height:n*2};for(const o of e.values())Kl(r,ql(o))>0&&i.push(o);return i}const bP=250;function SP(t,e,n,i){var r,o;let s=[],a=Number.POSITIVE_INFINITY;const l=yP(t,n,e+bP);for(const c of l){const u=[...((r=c.handleBounds)==null?void 0:r.source)??[],...((o=c.handleBounds)==null?void 0:o.target)??[]];for(const f of u){if(i.nodeId===f.nodeId&&i.type===f.type&&i.id===f.id)continue;const{x:d,y:h}=Qo(c,f,f.position,!0),g=Math.sqrt((d-t.x)**2+(h-t.y)**2);g>e||(g<a?(s=[{...f,x:d,y:h}],a=g):g===a&&s.push({...f,x:d,y:h}))}}if(!s.length)return null;if(s.length>1){const c=i.type==="source"?"target":"source";return s.find(u=>u.type===c)??s[0]}return s[0]}function Lm(t,{handle:e,connectionMode:n,fromNodeId:i,fromHandleId:r,fromType:o,doc:s,lib:a,flowId:l,isValidConnection:c=xP},u,f,d,h){const g=o==="target",_=e?s.querySelector(`.${a}-flow__handle[data-id="${l}-${e?.nodeId}-${e?.id}-${e?.type}"]`):null,{x:m,y:p}=li(t),b=s.elementFromPoint(m,p),v=b?.classList.contains(`${a}-flow__handle`)?b:_,x={handleDomNode:v,isValid:!1,connection:null,toHandle:null};if(v){const D=e_(void 0,v),O=v.getAttribute("data-nodeid"),U=v.getAttribute("data-handleid"),y=v.classList.contains("connectable"),w=v.classList.contains("connectableend");if(!O||!D)return x;const H={source:g?O:i,sourceHandle:g?U:r,target:g?i:O,targetHandle:g?r:U};x.connection=H;const I=y&&w&&(n===Rr.Strict?g&&D==="source"||!g&&D==="target":O!==i||U!==r);x.isValid=I&&c(H,{nodes:f,edges:u,sourceNode:d(H.source),targetNode:d(H.target)}),x.toHandle=t_(O,D,U,h,n,!0)}return x}function e_(t,e){return t||(e?.classList.contains("target")?"target":e?.classList.contains("source")?"source":null)}function MP(t,e){let n=null;return e?n="valid":t&&!e&&(n="invalid"),n}function EP(t,e){let n=null;return e?n=!0:t&&!e&&(n=!1),n}function t_(t,e,n,i,r,o=!1){var s,a,l;const c=i.get(t);if(!c)return null;const u=r===Rr.Strict?(s=c.handleBounds)==null?void 0:s[e]:[...((a=c.handleBounds)==null?void 0:a.source)??[],...((l=c.handleBounds)==null?void 0:l.target)??[]],f=(n?u?.find(d=>d.id===n):u?.[0])??null;return f&&o?{...f,...Qo(c,f,f.position,!0)}:f}const ld={[Ve.Left]:Ve.Right,[Ve.Right]:Ve.Left,[Ve.Top]:Ve.Bottom,[Ve.Bottom]:Ve.Top},wP=["production","prod"];function va(t,...e){n_()&&console.warn(`[Vue Flow]: ${t}`,...e)}function n_(){return!wP.includes("production")}function Um(t,e,n,i,r){const o=e.querySelectorAll(`.vue-flow__handle.${t}`);return o?.length?Array.from(o).map(s=>{const a=s.getBoundingClientRect();return{id:s.getAttribute("data-handleid"),type:t,nodeId:r,position:s.getAttribute("data-handlepos"),x:(a.left-n.left)/i,y:(a.top-n.top)/i,...Ac(s)}}):null}function cd(t,e,n,i,r,o=!1,s){r.value=!1,t.selected?(o||t.selected&&e)&&(i([t]),In(()=>{s.blur()})):n([t])}function Vt(t){return typeof me(t)<"u"}function TP(t,e,n,i){if(!t||!t.source||!t.target)return n(new Wt(Ht.EDGE_INVALID,t?.id??"[ID UNKNOWN]")),!1;let r;return Pr(t)?r=t:r={...t,id:Y0(t)},r=W0(r,void 0,i),sP(r,e)?!1:r}function AP(t,e,n,i,r){if(!e.source||!e.target)return r(new Wt(Ht.EDGE_INVALID,t.id)),!1;if(!n)return r(new Wt(Ht.EDGE_NOT_FOUND,t.id)),!1;const{id:o,...s}=t;return{...s,id:i?Y0(e):o,source:e.source,target:e.target,sourceHandle:e.sourceHandle,targetHandle:e.targetHandle}}function Fm(t,e,n){const i={},r=[];for(let o=0;o<t.length;++o){const s=t[o];if(!no(s)){n(new Wt(Ht.NODE_INVALID,s?.id)||`[ID UNKNOWN|INDEX ${o}]`);continue}const a=iP(s,e(s.id),s.parentNode);s.parentNode&&(i[s.parentNode]=!0),r[o]=a}for(const o of r){const s=e(o.parentNode)||r.find(a=>a.id===o.parentNode);o.parentNode&&!s&&n(new Wt(Ht.NODE_MISSING_PARENT,o.id,o.parentNode)),(o.parentNode||i[o.id])&&(i[o.id]&&(o.isParent=!0),s&&(s.isParent=!0))}return r}function Om(t,e,n,i,r,o){let s=r;const a=i.get(s)||new Map;i.set(s,a.set(n,e)),s=`${r}-${t}`;const l=i.get(s)||new Map;if(i.set(s,l.set(n,e)),o){s=`${r}-${t}-${o}`;const c=i.get(s)||new Map;i.set(s,c.set(n,e))}}function ku(t,e,n){t.clear();for(const i of n){const{source:r,target:o,sourceHandle:s=null,targetHandle:a=null}=i,l={edgeId:i.id,source:r,target:o,sourceHandle:s,targetHandle:a},c=`${r}-${s}--${o}-${a}`,u=`${o}-${a}--${r}-${s}`;Om("source",l,u,t,r,s),Om("target",l,c,t,o,a)}}function Bm(t,e){if(t.size!==e.size)return!1;for(const n of t)if(!e.has(n))return!1;return!0}function zu(t,e,n,i,r,o,s,a){const l=[];for(const c of t){const u=Pr(c)?c:TP(c,a,r,o);if(!u)continue;const f=n(u.source),d=n(u.target);if(!f||!d){r(new Wt(Ht.EDGE_SOURCE_TARGET_MISSING,u.id,u.source,u.target));continue}if(!f){r(new Wt(Ht.EDGE_SOURCE_MISSING,u.id,u.source));continue}if(!d){r(new Wt(Ht.EDGE_TARGET_MISSING,u.id,u.target));continue}if(e&&!e(u,{edges:a,nodes:s,sourceNode:f,targetNode:d})){r(new Wt(Ht.EDGE_INVALID,u.id));continue}const h=i(u.id);l.push({...W0(u,h,o),sourceNode:f,targetNode:d})}return l}const km=Symbol("vueFlow"),i_=Symbol("nodeId"),r_=Symbol("nodeRef"),CP=Symbol("edgeId"),RP=Symbol("edgeRef"),Rc=Symbol("slots");function o_(t){const{vueFlowRef:e,snapToGrid:n,snapGrid:i,noDragClassName:r,nodeLookup:o,nodeExtent:s,nodeDragThreshold:a,viewport:l,autoPanOnNodeDrag:c,autoPanSpeed:u,nodesDraggable:f,panBy:d,findNode:h,multiSelectionActive:g,nodesSelectionActive:_,selectNodesOnDrag:m,removeSelectedElements:p,addSelectedNodes:b,updateNodePositions:v,emits:x}=Lt(),{onStart:D,onDrag:O,onStop:U,onClick:y,el:w,disabled:H,id:N,selectable:I,dragHandle:q}=t,M=Mr(!1);let L=[],T,C=null,V={x:void 0,y:void 0},X={x:0,y:0},k=null,Y=!1,j=!1,fe=0,_e=!1;const he=NP(),K=({x:z,y:$})=>{V={x:z,y:$};let R=!1;if(L=L.map(P=>{const B={x:z-P.distance.x,y:$-P.distance.y},{computedPosition:G}=lh(P,n.value?Cc(B,i.value):B,x.error,s.value,P.parentNode?h(P.parentNode):void 0);return R=R||P.position.x!==G.x||P.position.y!==G.y,P.position=G,P}),j=j||R,!!R&&(v(L,!0,!0),M.value=!0,k)){const[P,B]=Ou({id:N,dragItems:L,findNode:h});O({event:k,node:P,nodes:B})}},ne=()=>{if(!C)return;const[z,$]=J0(X,C,u.value);if(z!==0||$!==0){const R={x:(V.x??0)-z/l.value.zoom,y:(V.y??0)-$/l.value.zoom};d({x:z,y:$})&&K(R)}fe=requestAnimationFrame(ne)},le=(z,$)=>{Y=!0;const R=h(N);!m.value&&!g.value&&R&&(R.selected||p()),R&&at(I)&&m.value&&cd(R,g.value,b,p,_,!1,$);const P=he(z.sourceEvent);if(V=P,L=fP(o.value,f.value,P,N),L.length){const[B,G]=Ou({id:N,dragItems:L,findNode:h});D({event:z.sourceEvent,node:B,nodes:G})}},Te=(z,$)=>{var R;z.sourceEvent.type==="touchmove"&&z.sourceEvent.touches.length>1||(j=!1,a.value===0&&le(z,$),V=he(z.sourceEvent),C=((R=e.value)==null?void 0:R.getBoundingClientRect())||null,X=li(z.sourceEvent,C))},xe=(z,$)=>{const R=he(z.sourceEvent);if(!_e&&Y&&c.value&&(_e=!0,ne()),!Y){const P=R.xSnapped-(V.x??0),B=R.ySnapped-(V.y??0);Math.sqrt(P*P+B*B)>a.value&&le(z,$)}(V.x!==R.xSnapped||V.y!==R.ySnapped)&&L.length&&Y&&(k=z.sourceEvent,X=li(z.sourceEvent,C),K(R))},Re=z=>{let $=!1;if(!Y&&!M.value&&!g.value){const R=z.sourceEvent,P=he(R),B=P.xSnapped-(V.x??0),G=P.ySnapped-(V.y??0),E=Math.sqrt(B*B+G*G);E!==0&&E<=a.value&&(y?.(R),$=!0)}if(L.length&&!$){j&&(v(L,!1,!1),j=!1);const[R,P]=Ou({id:N,dragItems:L,findNode:h});U({event:z.sourceEvent,node:R,nodes:P})}L=[],M.value=!1,_e=!1,Y=!1,V={x:void 0,y:void 0},cancelAnimationFrame(fe)};return ut([()=>at(H),w],([z,$],R,P)=>{if($){const B=Vn($);z||(T=nR().on("start",G=>Te(G,$)).on("drag",G=>xe(G,$)).on("end",G=>Re(G)).filter(G=>{const E=G.target,ie=at(q);return!G.button&&(!r.value||!Im(E,`.${r.value}`,$)&&(!ie||Im(E,ie,$)))}),B.call(T)),P(()=>{B.on(".drag",null),T&&(T.on("start",null),T.on("drag",null),T.on("end",null))})}}),M}function PP(){return{doubleClick:Oe(),click:Oe(),mouseEnter:Oe(),mouseMove:Oe(),mouseLeave:Oe(),contextMenu:Oe(),updateStart:Oe(),update:Oe(),updateEnd:Oe()}}function IP(t,e){const n=PP();return n.doubleClick.on(i=>{var r,o;e.edgeDoubleClick(i),(o=(r=t.events)==null?void 0:r.doubleClick)==null||o.call(r,i)}),n.click.on(i=>{var r,o;e.edgeClick(i),(o=(r=t.events)==null?void 0:r.click)==null||o.call(r,i)}),n.mouseEnter.on(i=>{var r,o;e.edgeMouseEnter(i),(o=(r=t.events)==null?void 0:r.mouseEnter)==null||o.call(r,i)}),n.mouseMove.on(i=>{var r,o;e.edgeMouseMove(i),(o=(r=t.events)==null?void 0:r.mouseMove)==null||o.call(r,i)}),n.mouseLeave.on(i=>{var r,o;e.edgeMouseLeave(i),(o=(r=t.events)==null?void 0:r.mouseLeave)==null||o.call(r,i)}),n.contextMenu.on(i=>{var r,o;e.edgeContextMenu(i),(o=(r=t.events)==null?void 0:r.contextMenu)==null||o.call(r,i)}),n.updateStart.on(i=>{var r,o;e.edgeUpdateStart(i),(o=(r=t.events)==null?void 0:r.updateStart)==null||o.call(r,i)}),n.update.on(i=>{var r,o;e.edgeUpdate(i),(o=(r=t.events)==null?void 0:r.update)==null||o.call(r,i)}),n.updateEnd.on(i=>{var r,o;e.edgeUpdateEnd(i),(o=(r=t.events)==null?void 0:r.updateEnd)==null||o.call(r,i)}),Object.entries(n).reduce((i,[r,o])=>(i.emit[r]=o.trigger,i.on[r]=o.on,i),{emit:{},on:{}})}function NP(){const{viewport:t,snapGrid:e,snapToGrid:n,vueFlowRef:i}=Lt();return r=>{var o;const s=((o=i.value)==null?void 0:o.getBoundingClientRect())??{left:0,top:0},a=vP(r)?r.sourceEvent:r,{x:l,y:c}=li(a,s),u=ea({x:l,y:c},t.value),{x:f,y:d}=n.value?Cc(u,e.value):u;return{xSnapped:f,ySnapped:d,...u}}}function el(){return!0}function s_({handleId:t,nodeId:e,type:n,isValidConnection:i,edgeUpdaterType:r,onEdgeUpdate:o,onEdgeUpdateEnd:s}){const{id:a,vueFlowRef:l,connectionMode:c,connectionRadius:u,connectOnClick:f,connectionClickStartHandle:d,nodesConnectable:h,autoPanOnConnect:g,autoPanSpeed:_,findNode:m,panBy:p,startConnection:b,updateConnection:v,endConnection:x,emits:D,viewport:O,edges:U,nodes:y,isValidConnection:w,nodeLookup:H}=Lt();let N=null,I=!1,q=null;function M(T){var C;const V=at(n)==="target",X=ch(T),k=Mm(T.target),Y=T.currentTarget;if(Y&&(X&&T.button===0||!X)){let j=function(te){R=li(te,Re),K=SP(ea(R,O.value,!1,[1,1]),u.value,H.value,G),P||(B(),P=!0);const A=Lm(te,{handle:K,connectionMode:c.value,fromNodeId:at(e),fromHandleId:at(t),fromType:V?"target":"source",isValidConnection:he,doc:k,lib:"vue",flowId:a,nodeLookup:H.value},U.value,y.value,m,H.value);q=A.handleDomNode,N=A.connection,I=EP(!!K,A.isValid);const S={...J,isValid:I,to:A.toHandle&&I?Qs({x:A.toHandle.x,y:A.toHandle.y},O.value):R,toHandle:A.toHandle,toPosition:I&&A.toHandle?A.toHandle.position:ld[G.position],toNode:A.toHandle?H.value.get(A.toHandle.nodeId):null};if(I&&K&&J?.toHandle&&S.toHandle&&J.toHandle.type===S.toHandle.type&&J.toHandle.nodeId===S.toHandle.nodeId&&J.toHandle.id===S.toHandle.id&&J.to.x===S.to.x&&J.to.y===S.to.y)return;const W=K??A.toHandle;if(v(W&&I?Qs({x:W.x,y:W.y},O.value):R,W,MP(!!W,I)),J=S,!K&&!I&&!q)return Bu($);N&&N.source!==N.target&&q&&(Bu($),$=q,q.classList.add("connecting","vue-flow__handle-connecting"),q.classList.toggle("valid",!!I),q.classList.toggle("vue-flow__handle-valid",!!I))},fe=function(te){"touches"in te&&te.touches.length>0||((K||q)&&N&&I&&(o?o(te,N):D.connect(N)),D.connectEnd(te),r&&s?.(te),Bu($),cancelAnimationFrame(ne),x(te),P=!1,I=!1,N=null,q=null,k.removeEventListener("mousemove",j),k.removeEventListener("mouseup",fe),k.removeEventListener("touchmove",j),k.removeEventListener("touchend",fe))};const _e=m(at(e));let he=at(i)||w.value||el;!he&&_e&&(he=(V?_e.isValidSourcePos:_e.isValidTargetPos)||el);let K,ne=0;const{x:le,y:Te}=li(T),xe=e_(at(r),Y),Re=(C=l.value)==null?void 0:C.getBoundingClientRect();if(!Re||!xe)return;const z=t_(at(e),xe,at(t),H.value,c.value);if(!z)return;let $,R=li(T,Re),P=!1;const B=()=>{if(!g.value)return;const[te,A]=J0(R,Re,_.value);p({x:te,y:A}),ne=requestAnimationFrame(B)},G={...z,nodeId:at(e),type:xe,position:z.position},E=H.value.get(at(e)),Q={inProgress:!0,isValid:null,from:Qo(E,G,Ve.Left,!0),fromHandle:G,fromPosition:G.position,fromNode:E,to:R,toHandle:null,toPosition:ld[G.position],toNode:null};b({nodeId:at(e),id:at(t),type:xe,position:Y?.getAttribute("data-handlepos")||Ve.Top,...R},{x:le-Re.left,y:Te-Re.top}),D.connectStart({event:T,nodeId:at(e),handleId:at(t),handleType:xe});let J=Q;k.addEventListener("mousemove",j),k.addEventListener("mouseup",fe),k.addEventListener("touchmove",j),k.addEventListener("touchend",fe)}}function L(T){var C,V;if(!f.value)return;const X=at(n)==="target";if(!d.value){D.clickConnectStart({event:T,nodeId:at(e),handleId:at(t)}),b({nodeId:at(e),type:at(n),id:at(t),position:Ve.Top,...li(T)},void 0,!0);return}let k=at(i)||w.value||el;const Y=m(at(e));if(!k&&Y&&(k=(X?Y.isValidSourcePos:Y.isValidTargetPos)||el),Y&&(typeof Y.connectable>"u"?h.value:Y.connectable)===!1)return;const j=Mm(T.target),fe=Lm(T,{handle:{nodeId:at(e),id:at(t),type:at(n),position:Ve.Top,...li(T)},connectionMode:c.value,fromNodeId:d.value.nodeId,fromHandleId:d.value.id??null,fromType:d.value.type,isValidConnection:k,doc:j,lib:"vue",flowId:a,nodeLookup:H.value},U.value,y.value,m,H.value),_e=((C=fe.connection)==null?void 0:C.source)===((V=fe.connection)==null?void 0:V.target);fe.isValid&&fe.connection&&!_e&&D.connect(fe.connection),D.clickConnectEnd(T),x(T,!0)}return{handlePointerDown:M,handleClick:L}}function DP(){return Nn(i_,"")}function a_(t){const e=t??DP()??"",n=Nn(r_,Ke(null)),{findNode:i,edges:r,emits:o}=Lt(),s=i(e);return s||o.error(new Wt(Ht.NODE_NOT_FOUND,e)),{id:e,nodeEl:n,node:s,parentNode:He(()=>i(s.parentNode)),connectedEdges:He(()=>Xr([s],r.value))}}function LP(){return{doubleClick:Oe(),click:Oe(),mouseEnter:Oe(),mouseMove:Oe(),mouseLeave:Oe(),contextMenu:Oe(),dragStart:Oe(),drag:Oe(),dragStop:Oe()}}function UP(t,e){const n=LP();return n.doubleClick.on(i=>{var r,o;e.nodeDoubleClick(i),(o=(r=t.events)==null?void 0:r.doubleClick)==null||o.call(r,i)}),n.click.on(i=>{var r,o;e.nodeClick(i),(o=(r=t.events)==null?void 0:r.click)==null||o.call(r,i)}),n.mouseEnter.on(i=>{var r,o;e.nodeMouseEnter(i),(o=(r=t.events)==null?void 0:r.mouseEnter)==null||o.call(r,i)}),n.mouseMove.on(i=>{var r,o;e.nodeMouseMove(i),(o=(r=t.events)==null?void 0:r.mouseMove)==null||o.call(r,i)}),n.mouseLeave.on(i=>{var r,o;e.nodeMouseLeave(i),(o=(r=t.events)==null?void 0:r.mouseLeave)==null||o.call(r,i)}),n.contextMenu.on(i=>{var r,o;e.nodeContextMenu(i),(o=(r=t.events)==null?void 0:r.contextMenu)==null||o.call(r,i)}),n.dragStart.on(i=>{var r,o;e.nodeDragStart(i),(o=(r=t.events)==null?void 0:r.dragStart)==null||o.call(r,i)}),n.drag.on(i=>{var r,o;e.nodeDrag(i),(o=(r=t.events)==null?void 0:r.drag)==null||o.call(r,i)}),n.dragStop.on(i=>{var r,o;e.nodeDragStop(i),(o=(r=t.events)==null?void 0:r.dragStop)==null||o.call(r,i)}),Object.entries(n).reduce((i,[r,o])=>(i.emit[r]=o.trigger,i.on[r]=o.on,i),{emit:{},on:{}})}function l_(){const{getSelectedNodes:t,nodeExtent:e,updateNodePositions:n,findNode:i,snapGrid:r,snapToGrid:o,nodesDraggable:s,emits:a}=Lt();return(l,c=!1)=>{const u=o.value?r.value[0]:5,f=o.value?r.value[1]:5,d=c?4:1,h=l.x*u*d,g=l.y*f*d,_=[];for(const m of t.value)if(m.draggable||s&&typeof m.draggable>"u"){const p={x:m.computedPosition.x+h,y:m.computedPosition.y+g},{position:b}=lh(m,p,a.error,e.value,m.parentNode?i(m.parentNode):void 0);_.push({id:m.id,position:b,from:m.position,distance:{x:l.x,y:l.y},dimensions:m.dimensions})}n(_,!0,!1)}}const tl=.1,FP=t=>((t*=2)<=1?t*t*t:(t-=2)*t*t+2)/2;function dr(){return va("Viewport not initialized yet."),Promise.resolve(!1)}const OP={zoomIn:dr,zoomOut:dr,zoomTo:dr,fitView:dr,setCenter:dr,fitBounds:dr,project:t=>t,screenToFlowCoordinate:t=>t,flowToScreenCoordinate:t=>t,setViewport:dr,setTransform:dr,getViewport:()=>({x:0,y:0,zoom:1}),getTransform:()=>({x:0,y:0,zoom:1}),viewportInitialized:!1};function BP(t){function e(i,r){return new Promise(o=>{t.d3Selection&&t.d3Zoom?t.d3Zoom.interpolate(r?.interpolate==="linear"?Fs:vl).scaleBy(Vu(t.d3Selection,r?.duration,r?.ease,()=>{o(!0)}),i):o(!1)})}function n(i,r,o,s){return new Promise(a=>{var l;const{x:c,y:u}=$0({x:-i,y:-r},t.translateExtent),f=Jo.translate(-c,-u).scale(o);t.d3Selection&&t.d3Zoom?(l=t.d3Zoom)==null||l.interpolate(s?.interpolate==="linear"?Fs:vl).transform(Vu(t.d3Selection,s?.duration,s?.ease,()=>{a(!0)}),f):a(!1)})}return He(()=>t.d3Zoom&&t.d3Selection&&t.dimensions.width&&t.dimensions.height?{viewportInitialized:!0,zoomIn:r=>e(1.2,r),zoomOut:r=>e(1/1.2,r),zoomTo:(r,o)=>new Promise(s=>{t.d3Selection&&t.d3Zoom?t.d3Zoom.interpolate(o?.interpolate==="linear"?Fs:vl).scaleTo(Vu(t.d3Selection,o?.duration,o?.ease,()=>{s(!0)}),r):s(!1)}),setViewport:(r,o)=>n(r.x,r.y,r.zoom,o),setTransform:(r,o)=>n(r.x,r.y,r.zoom,o),getViewport:()=>({x:t.viewport.x,y:t.viewport.y,zoom:t.viewport.zoom}),getTransform:()=>({x:t.viewport.x,y:t.viewport.y,zoom:t.viewport.zoom}),fitView:(r={padding:tl,includeHiddenNodes:!1,duration:0})=>{var o,s;const a=[];for(const d of t.nodes)d.dimensions.width&&d.dimensions.height&&(r?.includeHiddenNodes||!d.hidden)&&(!((o=r.nodes)!=null&&o.length)||(s=r.nodes)!=null&&s.length&&r.nodes.includes(d.id))&&a.push(d);if(!a.length)return Promise.resolve(!1);const l=ah(a),{x:c,y:u,zoom:f}=Em(l,t.dimensions.width,t.dimensions.height,r.minZoom??t.minZoom,r.maxZoom??t.maxZoom,r.padding??tl);return n(c,u,f,r)},setCenter:(r,o,s)=>{const a=typeof s?.zoom<"u"?s.zoom:t.maxZoom,l=t.dimensions.width/2-r*a,c=t.dimensions.height/2-o*a;return n(l,c,a,s)},fitBounds:(r,o={padding:tl})=>{const{x:s,y:a,zoom:l}=Em(r,t.dimensions.width,t.dimensions.height,t.minZoom,t.maxZoom,o.padding??tl);return n(s,a,l,o)},project:r=>ea(r,t.viewport,t.snapToGrid,t.snapGrid),screenToFlowCoordinate:r=>{if(t.vueFlowRef){const{x:o,y:s}=t.vueFlowRef.getBoundingClientRect(),a={x:r.x-o,y:r.y-s};return ea(a,t.viewport,t.snapToGrid,t.snapGrid)}return{x:0,y:0}},flowToScreenCoordinate:r=>{if(t.vueFlowRef){const{x:o,y:s}=t.vueFlowRef.getBoundingClientRect(),a={x:r.x+o,y:r.y+s};return Qs(a,t.viewport)}return{x:0,y:0}}}:OP)}function Vu(t,e=0,n=FP,i=()=>{}){const r=typeof e=="number"&&e>0;return r||i(),r?t.transition().duration(e).ease(n).on("end",i):t}function kP(t,e,n){const i=lc(!0);return i.run(()=>{const r=()=>{i.run(()=>{let _,m,p=!!(n.nodes.value.length||n.edges.value.length);_=Po([t.modelValue,()=>{var b,v;return(v=(b=t.modelValue)==null?void 0:b.value)==null?void 0:v.length}],([b])=>{b&&Array.isArray(b)&&(m?.pause(),n.setElements(b),!m&&!p&&b.length?p=!0:m?.resume())}),m=Po([n.nodes,n.edges,()=>n.edges.value.length,()=>n.nodes.value.length],([b,v])=>{var x;(x=t.modelValue)!=null&&x.value&&Array.isArray(t.modelValue.value)&&(_?.pause(),t.modelValue.value=[...b,...v],In(()=>{_?.resume()}))},{immediate:p}),Rs(()=>{_?.stop(),m?.stop()})})},o=()=>{i.run(()=>{let _,m,p=!!n.nodes.value.length;_=Po([t.nodes,()=>{var b,v;return(v=(b=t.nodes)==null?void 0:b.value)==null?void 0:v.length}],([b])=>{b&&Array.isArray(b)&&(m?.pause(),n.setNodes(b),!m&&!p&&b.length?p=!0:m?.resume())}),m=Po([n.nodes,()=>n.nodes.value.length],([b])=>{var v;(v=t.nodes)!=null&&v.value&&Array.isArray(t.nodes.value)&&(_?.pause(),t.nodes.value=[...b],In(()=>{_?.resume()}))},{immediate:p}),Rs(()=>{_?.stop(),m?.stop()})})},s=()=>{i.run(()=>{let _,m,p=!!n.edges.value.length;_=Po([t.edges,()=>{var b,v;return(v=(b=t.edges)==null?void 0:b.value)==null?void 0:v.length}],([b])=>{b&&Array.isArray(b)&&(m?.pause(),n.setEdges(b),!m&&!p&&b.length?p=!0:m?.resume())}),m=Po([n.edges,()=>n.edges.value.length],([b])=>{var v;(v=t.edges)!=null&&v.value&&Array.isArray(t.edges.value)&&(_?.pause(),t.edges.value=[...b],In(()=>{_?.resume()}))},{immediate:p}),Rs(()=>{_?.stop(),m?.stop()})})},a=()=>{i.run(()=>{ut(()=>e.maxZoom,()=>{e.maxZoom&&Vt(e.maxZoom)&&n.setMaxZoom(e.maxZoom)},{immediate:!0})})},l=()=>{i.run(()=>{ut(()=>e.minZoom,()=>{e.minZoom&&Vt(e.minZoom)&&n.setMinZoom(e.minZoom)},{immediate:!0})})},c=()=>{i.run(()=>{ut(()=>e.translateExtent,()=>{e.translateExtent&&Vt(e.translateExtent)&&n.setTranslateExtent(e.translateExtent)},{immediate:!0})})},u=()=>{i.run(()=>{ut(()=>e.nodeExtent,()=>{e.nodeExtent&&Vt(e.nodeExtent)&&n.setNodeExtent(e.nodeExtent)},{immediate:!0})})},f=()=>{i.run(()=>{ut(()=>e.applyDefault,()=>{Vt(e.applyDefault)&&(n.applyDefault.value=e.applyDefault)},{immediate:!0})})},d=()=>{i.run(()=>{const _=async m=>{let p=m;typeof e.autoConnect=="function"&&(p=await e.autoConnect(m)),p!==!1&&n.addEdges([p])};ut(()=>e.autoConnect,()=>{Vt(e.autoConnect)&&(n.autoConnect.value=e.autoConnect)},{immediate:!0}),ut(n.autoConnect,(m,p,b)=>{m?n.onConnect(_):n.hooks.value.connect.off(_),b(()=>{n.hooks.value.connect.off(_)})},{immediate:!0})})},h=()=>{const _=["id","modelValue","translateExtent","nodeExtent","edges","nodes","maxZoom","minZoom","applyDefault","autoConnect"];for(const m of Object.keys(e)){const p=m;if(!_.includes(p)){const b=wt(()=>e[p]),v=n[p];Nt(v)&&i.run(()=>{ut(b,x=>{Vt(x)&&(v.value=x)},{immediate:!0})})}}};r(),o(),s(),l(),a(),c(),u(),f(),d(),h()}),()=>i.stop()}function zP(){return{edgesChange:Oe(),nodesChange:Oe(),nodeDoubleClick:Oe(),nodeClick:Oe(),nodeMouseEnter:Oe(),nodeMouseMove:Oe(),nodeMouseLeave:Oe(),nodeContextMenu:Oe(),nodeDragStart:Oe(),nodeDrag:Oe(),nodeDragStop:Oe(),nodesInitialized:Oe(),miniMapNodeClick:Oe(),miniMapNodeDoubleClick:Oe(),miniMapNodeMouseEnter:Oe(),miniMapNodeMouseMove:Oe(),miniMapNodeMouseLeave:Oe(),connect:Oe(),connectStart:Oe(),connectEnd:Oe(),clickConnectStart:Oe(),clickConnectEnd:Oe(),paneReady:Oe(),init:Oe(),move:Oe(),moveStart:Oe(),moveEnd:Oe(),selectionDragStart:Oe(),selectionDrag:Oe(),selectionDragStop:Oe(),selectionContextMenu:Oe(),selectionStart:Oe(),selectionEnd:Oe(),viewportChangeStart:Oe(),viewportChange:Oe(),viewportChangeEnd:Oe(),paneScroll:Oe(),paneClick:Oe(),paneContextMenu:Oe(),paneMouseEnter:Oe(),paneMouseMove:Oe(),paneMouseLeave:Oe(),edgeContextMenu:Oe(),edgeMouseEnter:Oe(),edgeMouseMove:Oe(),edgeMouseLeave:Oe(),edgeDoubleClick:Oe(),edgeClick:Oe(),edgeUpdateStart:Oe(),edgeUpdate:Oe(),edgeUpdateEnd:Oe(),updateNodeInternals:Oe(),error:Oe(t=>va(t.message))}}function VP(t,e){const n=nr();qg(()=>{for(const[r,o]of Object.entries(e.value)){const s=a=>{t(r,a)};o.setEmitter(s),qs(o.removeEmitter),o.setHasEmitListeners(()=>i(r)),qs(o.removeHasEmitListeners)}});function i(r){var o;const s=HP(r);return!!((o=n?.vnode.props)==null?void 0:o[s])}}function HP(t){const[e,...n]=t.split(":");return`on${e.replace(/(?:^|-)(\w)/g,(r,o)=>o.toUpperCase())}${n.length?`:${n.join(":")}`:""}`}function c_(){return{vueFlowRef:null,viewportRef:null,nodes:[],edges:[],connectionLookup:new Map,nodeTypes:{},edgeTypes:{},initialized:!1,dimensions:{width:0,height:0},viewport:{x:0,y:0,zoom:1},d3Zoom:null,d3Selection:null,d3ZoomHandler:null,minZoom:.5,maxZoom:2,translateExtent:[[Number.NEGATIVE_INFINITY,Number.NEGATIVE_INFINITY],[Number.POSITIVE_INFINITY,Number.POSITIVE_INFINITY]],nodeExtent:[[Number.NEGATIVE_INFINITY,Number.NEGATIVE_INFINITY],[Number.POSITIVE_INFINITY,Number.POSITIVE_INFINITY]],selectionMode:sh.Full,paneDragging:!1,preventScrolling:!0,zoomOnScroll:!0,zoomOnPinch:!0,zoomOnDoubleClick:!0,panOnScroll:!1,panOnScrollSpeed:.5,panOnScrollMode:Os.Free,paneClickDistance:0,panOnDrag:!0,edgeUpdaterRadius:10,onlyRenderVisibleElements:!1,defaultViewport:{x:0,y:0,zoom:1},nodesSelectionActive:!1,userSelectionActive:!1,userSelectionRect:null,defaultMarkerColor:"#b1b1b7",connectionLineStyle:{},connectionLineType:null,connectionLineOptions:{type:Wr.Bezier,style:{}},connectionMode:Rr.Loose,connectionStartHandle:null,connectionEndHandle:null,connectionClickStartHandle:null,connectionPosition:{x:Number.NaN,y:Number.NaN},connectionRadius:20,connectOnClick:!0,connectionStatus:null,isValidConnection:null,snapGrid:[15,15],snapToGrid:!1,edgesUpdatable:!1,edgesFocusable:!0,nodesFocusable:!0,nodesConnectable:!0,nodesDraggable:!0,nodeDragThreshold:1,elementsSelectable:!0,selectNodesOnDrag:!0,multiSelectionActive:!1,selectionKeyCode:"Shift",multiSelectionKeyCode:na()?"Meta":"Control",zoomActivationKeyCode:na()?"Meta":"Control",deleteKeyCode:"Backspace",panActivationKeyCode:"Space",hooks:zP(),applyDefault:!0,autoConnect:!1,fitViewOnInit:!1,fitViewOnInitDone:!1,noDragClassName:"nodrag",noWheelClassName:"nowheel",noPanClassName:"nopan",defaultEdgeOptions:void 0,elevateEdgesOnSelect:!1,elevateNodesOnSelect:!0,autoPanOnNodeDrag:!0,autoPanOnConnect:!0,autoPanSpeed:15,disableKeyboardA11y:!1,ariaLiveMessage:""}}const GP=["id","vueFlowRef","viewportRef","initialized","modelValue","nodes","edges","maxZoom","minZoom","translateExtent","hooks","defaultEdgeOptions"];function $P(t,e,n){const i=BP(t),r=R=>{const P=R??[];t.hooks.updateNodeInternals.trigger(P)},o=R=>oP(R,t.nodes,t.edges),s=R=>rP(R,t.nodes,t.edges),a=R=>Xr(R,t.edges),l=({id:R,type:P,nodeId:B})=>{var G;const E=R?`-${P}-${R}`:`-${P}`;return Array.from(((G=t.connectionLookup.get(`${B}${E}`))==null?void 0:G.values())??[])},c=R=>{if(R)return e.value.get(R)},u=R=>{if(R)return n.value.get(R)},f=(R,P,B)=>{var G,E;const ie=[];for(const Q of R){const J={id:Q.id,type:"position",dragging:B,from:Q.from};if(P&&(J.position=Q.position,Q.parentNode)){const te=c(Q.parentNode);J.position={x:J.position.x-(((G=te?.computedPosition)==null?void 0:G.x)??0),y:J.position.y-(((E=te?.computedPosition)==null?void 0:E.y)??0)}}ie.push(J)}ie?.length&&t.hooks.nodesChange.trigger(ie)},d=R=>{if(!t.vueFlowRef)return;const P=t.vueFlowRef.querySelector(".vue-flow__transformationpane");if(!P)return;const B=window.getComputedStyle(P),{m22:G}=new window.DOMMatrixReadOnly(B.transform),E=[];for(const ie of R){const Q=ie,J=c(Q.id);if(J){const te=Ac(Q.nodeElement);if(!!(te.width&&te.height&&(J.dimensions.width!==te.width||J.dimensions.height!==te.height||Q.forceUpdate))){const S=Q.nodeElement.getBoundingClientRect();J.dimensions=te,J.handleBounds.source=Um("source",Q.nodeElement,S,G,J.id),J.handleBounds.target=Um("target",Q.nodeElement,S,G,J.id),E.push({id:J.id,type:"dimensions",dimensions:te})}}}!t.fitViewOnInitDone&&t.fitViewOnInit&&i.value.fitView().then(()=>{t.fitViewOnInitDone=!0}),E.length&&t.hooks.nodesChange.trigger(E)},h=(R,P)=>{const B=new Set,G=new Set;for(const Q of R)no(Q)?B.add(Q.id):Pr(Q)&&G.add(Q.id);const E=_r(e.value,B,!0),ie=_r(n.value,G);if(t.multiSelectionActive){for(const Q of B)E.push(pr(Q,P));for(const Q of G)ie.push(pr(Q,P))}E.length&&t.hooks.nodesChange.trigger(E),ie.length&&t.hooks.edgesChange.trigger(ie)},g=R=>{if(t.multiSelectionActive){const P=R.map(B=>pr(B.id,!0));t.hooks.nodesChange.trigger(P);return}t.hooks.nodesChange.trigger(_r(e.value,new Set(R.map(P=>P.id)),!0)),t.hooks.edgesChange.trigger(_r(n.value))},_=R=>{if(t.multiSelectionActive){const P=R.map(B=>pr(B.id,!0));t.hooks.edgesChange.trigger(P);return}t.hooks.edgesChange.trigger(_r(n.value,new Set(R.map(P=>P.id)))),t.hooks.nodesChange.trigger(_r(e.value,new Set,!0))},m=R=>{h(R,!0)},p=R=>{const B=(R||t.nodes).map(G=>(G.selected=!1,pr(G.id,!1)));t.hooks.nodesChange.trigger(B)},b=R=>{const B=(R||t.edges).map(G=>(G.selected=!1,pr(G.id,!1)));t.hooks.edgesChange.trigger(B)},v=R=>{if(!R||!R.length)return h([],!1);const P=R.reduce((B,G)=>{const E=pr(G.id,!1);return no(G)?B.nodes.push(E):B.edges.push(E),B},{nodes:[],edges:[]});P.nodes.length&&t.hooks.nodesChange.trigger(P.nodes),P.edges.length&&t.hooks.edgesChange.trigger(P.edges)},x=R=>{var P;(P=t.d3Zoom)==null||P.scaleExtent([R,t.maxZoom]),t.minZoom=R},D=R=>{var P;(P=t.d3Zoom)==null||P.scaleExtent([t.minZoom,R]),t.maxZoom=R},O=R=>{var P;(P=t.d3Zoom)==null||P.translateExtent(R),t.translateExtent=R},U=R=>{t.nodeExtent=R,r()},y=R=>{var P;(P=t.d3Zoom)==null||P.clickDistance(R)},w=R=>{t.nodesDraggable=R,t.nodesConnectable=R,t.elementsSelectable=R},H=R=>{const P=R instanceof Function?R(t.nodes):R;!t.initialized&&!P.length||(t.nodes=Fm(P,c,t.hooks.error.trigger))},N=R=>{const P=R instanceof Function?R(t.edges):R;if(!t.initialized&&!P.length)return;const B=zu(P,t.isValidConnection,c,u,t.hooks.error.trigger,t.defaultEdgeOptions,t.nodes,t.edges);ku(t.connectionLookup,n.value,B),t.edges=B},I=R=>{const P=R instanceof Function?R([...t.nodes,...t.edges]):R;!t.initialized&&!P.length||(H(P.filter(no)),N(P.filter(Pr)))},q=R=>{let P=R instanceof Function?R(t.nodes):R;P=Array.isArray(P)?P:[P];const B=Fm(P,c,t.hooks.error.trigger),G=[];for(const E of B)G.push(Am(E));G.length&&t.hooks.nodesChange.trigger(G)},M=R=>{let P=R instanceof Function?R(t.edges):R;P=Array.isArray(P)?P:[P];const B=zu(P,t.isValidConnection,c,u,t.hooks.error.trigger,t.defaultEdgeOptions,t.nodes,t.edges),G=[];for(const E of B)G.push(Am(E));G.length&&t.hooks.edgesChange.trigger(G)},L=(R,P=!0,B=!1)=>{const G=R instanceof Function?R(t.nodes):R,E=Array.isArray(G)?G:[G],ie=[],Q=[];function J(A){const S=a(A);for(const W of S)(!Vt(W.deletable)||W.deletable)&&Q.push(Rm(W.id,W.source,W.target,W.sourceHandle,W.targetHandle))}function te(A){const S=[];for(const W of t.nodes)W.parentNode===A&&S.push(W);if(S.length){for(const W of S)ie.push(Cm(W.id));P&&J(S);for(const W of S)te(W.id)}}for(const A of E){const S=typeof A=="string"?c(A):A;S&&(Vt(S.deletable)&&!S.deletable||(ie.push(Cm(S.id)),P&&J([S]),B&&te(S.id)))}Q.length&&t.hooks.edgesChange.trigger(Q),ie.length&&t.hooks.nodesChange.trigger(ie)},T=R=>{const P=R instanceof Function?R(t.edges):R,B=Array.isArray(P)?P:[P],G=[];for(const E of B){const ie=typeof E=="string"?u(E):E;ie&&(Vt(ie.deletable)&&!ie.deletable||G.push(Rm(typeof E=="string"?E:E.id,ie.source,ie.target,ie.sourceHandle,ie.targetHandle)))}t.hooks.edgesChange.trigger(G)},C=(R,P,B=!0)=>{const G=u(R.id);if(!G)return!1;const E=t.edges.indexOf(G),ie=AP(R,P,G,B,t.hooks.error.trigger);if(ie){const[Q]=zu([ie],t.isValidConnection,c,u,t.hooks.error.trigger,t.defaultEdgeOptions,t.nodes,t.edges);return t.edges=t.edges.map((J,te)=>te===E?Q:J),ku(t.connectionLookup,n.value,[Q]),Q}return!1},V=(R,P,B={replace:!1})=>{const G=u(R);if(!G)return;const E=typeof P=="function"?P(G):P;G.data=B.replace?E:{...G.data,...E}},X=R=>Tm(R,t.nodes),k=R=>{const P=Tm(R,t.edges);return ku(t.connectionLookup,n.value,P),P},Y=(R,P,B={replace:!1})=>{const G=c(R);if(!G)return;const E=typeof P=="function"?P(G):P;B.replace?t.nodes.splice(t.nodes.indexOf(G),1,E):Object.assign(G,E)},j=(R,P,B={replace:!1})=>{const G=c(R);if(!G)return;const E=typeof P=="function"?P(G):P;G.data=B.replace?E:{...G.data,...E}},fe=(R,P,B=!1)=>{B?t.connectionClickStartHandle=R:t.connectionStartHandle=R,t.connectionEndHandle=null,t.connectionStatus=null,P&&(t.connectionPosition=P)},_e=(R,P=null,B=null)=>{t.connectionStartHandle&&(t.connectionPosition=R,t.connectionEndHandle=P,t.connectionStatus=B)},he=(R,P)=>{t.connectionPosition={x:Number.NaN,y:Number.NaN},t.connectionEndHandle=null,t.connectionStatus=null,P?t.connectionClickStartHandle=null:t.connectionStartHandle=null},K=R=>{const P=nP(R),B=P?null:ws(R)?R:c(R.id);return!P&&!B?[null,null,P]:[P?R:ql(B),B,P]},ne=(R,P=!0,B=t.nodes)=>{const[G,E,ie]=K(R);if(!G)return[];const Q=[];for(const J of B||t.nodes){if(!ie&&(J.id===E.id||!J.computedPosition))continue;const te=ql(J),A=Kl(te,G);(P&&A>0||A>=te.width*te.height||A>=Number(G.width)*Number(G.height))&&Q.push(J)}return Q},le=(R,P,B=!0)=>{const[G]=K(R);if(!G)return!1;const E=Kl(G,P);return B&&E>0||E>=Number(G.width)*Number(G.height)},Te=R=>{const{viewport:P,dimensions:B,d3Zoom:G,d3Selection:E,translateExtent:ie}=t;if(!G||!E||!R.x&&!R.y)return!1;const Q=Jo.translate(P.x+R.x,P.y+R.y).scale(P.zoom),J=[[0,0],[B.width,B.height]],te=G.constrain()(Q,J,ie),A=t.viewport.x!==te.x||t.viewport.y!==te.y||t.viewport.zoom!==te.k;return G.transform(E,te),A},xe=R=>{const P=R instanceof Function?R(t):R,B=["d3Zoom","d3Selection","d3ZoomHandler","viewportRef","vueFlowRef","dimensions","hooks"];Vt(P.defaultEdgeOptions)&&(t.defaultEdgeOptions=P.defaultEdgeOptions);const G=P.modelValue||P.nodes||P.edges?[]:void 0;G&&(P.modelValue&&G.push(...P.modelValue),P.nodes&&G.push(...P.nodes),P.edges&&G.push(...P.edges),I(G));const E=()=>{Vt(P.maxZoom)&&D(P.maxZoom),Vt(P.minZoom)&&x(P.minZoom),Vt(P.translateExtent)&&O(P.translateExtent)};for(const ie of Object.keys(P)){const Q=ie,J=P[Q];![...GP,...B].includes(Q)&&Vt(J)&&(t[Q]=J)}Zf(()=>t.d3Zoom).not.toBeNull().then(E),t.initialized||(t.initialized=!0)};return{updateNodePositions:f,updateNodeDimensions:d,setElements:I,setNodes:H,setEdges:N,addNodes:q,addEdges:M,removeNodes:L,removeEdges:T,findNode:c,findEdge:u,updateEdge:C,updateEdgeData:V,updateNode:Y,updateNodeData:j,applyEdgeChanges:k,applyNodeChanges:X,addSelectedElements:m,addSelectedNodes:g,addSelectedEdges:_,setMinZoom:x,setMaxZoom:D,setTranslateExtent:O,setNodeExtent:U,setPaneClickDistance:y,removeSelectedElements:v,removeSelectedNodes:p,removeSelectedEdges:b,startConnection:fe,updateConnection:_e,endConnection:he,setInteractive:w,setState:xe,getIntersectingNodes:ne,getIncomers:o,getOutgoers:s,getConnectedEdges:a,getHandleConnections:l,isNodeIntersecting:le,panBy:Te,fitView:R=>i.value.fitView(R),zoomIn:R=>i.value.zoomIn(R),zoomOut:R=>i.value.zoomOut(R),zoomTo:(R,P)=>i.value.zoomTo(R,P),setViewport:(R,P)=>i.value.setViewport(R,P),setTransform:(R,P)=>i.value.setTransform(R,P),getViewport:()=>i.value.getViewport(),getTransform:()=>i.value.getTransform(),setCenter:(R,P,B)=>i.value.setCenter(R,P,B),fitBounds:(R,P)=>i.value.fitBounds(R,P),project:R=>i.value.project(R),screenToFlowCoordinate:R=>i.value.screenToFlowCoordinate(R),flowToScreenCoordinate:R=>i.value.flowToScreenCoordinate(R),toObject:()=>{const R=[],P=[];for(const B of t.nodes){const{computedPosition:G,handleBounds:E,selected:ie,dimensions:Q,isParent:J,resizing:te,dragging:A,events:S,...W}=B;R.push(W)}for(const B of t.edges){const{selected:G,sourceNode:E,targetNode:ie,events:Q,...J}=B;P.push(J)}return JSON.parse(JSON.stringify({nodes:R,edges:P,position:[t.viewport.x,t.viewport.y],zoom:t.viewport.zoom,viewport:t.viewport}))},fromObject:R=>new Promise(P=>{const{nodes:B,edges:G,position:E,zoom:ie,viewport:Q}=R;B&&H(B),G&&N(G);const[J,te]=Q?.x&&Q?.y?[Q.x,Q.y]:E??[null,null];if(J&&te){const A=Q?.zoom||ie||t.viewport.zoom;return Zf(()=>i.value.viewportInitialized).toBe(!0).then(()=>{i.value.setViewport({x:J,y:te,zoom:A}).then(()=>{P(!0)})})}else P(!0)}),updateNodeInternals:r,viewportHelper:i,$reset:()=>{const R=c_();if(t.edges=[],t.nodes=[],t.d3Zoom&&t.d3Selection){const P=Jo.translate(R.defaultViewport.x??0,R.defaultViewport.y??0).scale(lo(R.defaultViewport.zoom??1,R.minZoom,R.maxZoom)),B=t.viewportRef.getBoundingClientRect(),G=[[0,0],[B.width,B.height]],E=t.d3Zoom.constrain()(P,G,R.translateExtent);t.d3Zoom.transform(t.d3Selection,E)}xe(R)},$destroy:()=>{}}}const WP=["data-id","data-handleid","data-nodeid","data-handlepos"],XP={name:"Handle",compatConfig:{MODE:3}},io=Dt({...XP,props:{id:{default:null},type:{},position:{default:()=>Ve.Top},isValidConnection:{type:Function},connectable:{type:[Boolean,Number,String,Function],default:void 0},connectableStart:{type:Boolean,default:!0},connectableEnd:{type:Boolean,default:!0}},setup(t,{expose:e}){const n=cy(t,["position","connectable","connectableStart","connectableEnd","id"]),i=wt(()=>n.type??"source"),r=wt(()=>n.isValidConnection??null),{id:o,connectionStartHandle:s,connectionClickStartHandle:a,connectionEndHandle:l,vueFlowRef:c,nodesConnectable:u,noDragClassName:f,noPanClassName:d}=Lt(),{id:h,node:g,nodeEl:_,connectedEdges:m}=a_(),p=Ke(),b=wt(()=>typeof t.connectableStart<"u"?t.connectableStart:!0),v=wt(()=>typeof t.connectableEnd<"u"?t.connectableEnd:!0),x=wt(()=>{var N,I,q,M,L,T;return((N=s.value)==null?void 0:N.nodeId)===h&&((I=s.value)==null?void 0:I.id)===t.id&&((q=s.value)==null?void 0:q.type)===i.value||((M=l.value)==null?void 0:M.nodeId)===h&&((L=l.value)==null?void 0:L.id)===t.id&&((T=l.value)==null?void 0:T.type)===i.value}),D=wt(()=>{var N,I,q;return((N=a.value)==null?void 0:N.nodeId)===h&&((I=a.value)==null?void 0:I.id)===t.id&&((q=a.value)==null?void 0:q.type)===i.value}),{handlePointerDown:O,handleClick:U}=s_({nodeId:h,handleId:t.id,isValidConnection:r,type:i}),y=He(()=>typeof t.connectable=="string"&&t.connectable==="single"?!m.value.some(N=>{const I=N[`${i.value}Handle`];return N[i.value]!==h?!1:I?I===t.id:!0}):typeof t.connectable=="number"?m.value.filter(N=>{const I=N[`${i.value}Handle`];return N[i.value]!==h?!1:I?I===t.id:!0}).length<t.connectable:typeof t.connectable=="function"?t.connectable(g,m.value):Vt(t.connectable)?t.connectable:u.value);Kn(()=>{var N;if(!g.dimensions.width||!g.dimensions.height)return;const I=(N=g.handleBounds[i.value])==null?void 0:N.find(X=>X.id===t.id);if(!c.value||I)return;const q=c.value.querySelector(".vue-flow__transformationpane");if(!_.value||!p.value||!q||!t.id)return;const M=_.value.getBoundingClientRect(),L=p.value.getBoundingClientRect(),T=window.getComputedStyle(q),{m22:C}=new window.DOMMatrixReadOnly(T.transform),V={id:t.id,position:t.position,x:(L.left-M.left)/C,y:(L.top-M.top)/C,type:i.value,nodeId:h,...Ac(p.value)};g.handleBounds[i.value]=[...g.handleBounds[i.value]??[],V]});function w(N){const I=ch(N);y.value&&b.value&&(I&&N.button===0||!I)&&O(N)}function H(N){!h||!a.value&&!b.value||y.value&&U(N)}return e({handleClick:U,handlePointerDown:O,onClick:H,onPointerDown:w}),(N,I)=>(Se(),Ce("div",{ref_key:"handle",ref:p,"data-id":`${me(o)}-${me(h)}-${t.id}-${i.value}`,"data-handleid":t.id,"data-nodeid":me(h),"data-handlepos":N.position,class:Gt(["vue-flow__handle",[`vue-flow__handle-${N.position}`,`vue-flow__handle-${t.id}`,me(f),me(d),i.value,{connectable:y.value,connecting:D.value,connectablestart:b.value,connectableend:v.value,connectionindicator:y.value&&(b.value&&!x.value||v.value&&x.value)}]]),onMousedown:w,onTouchstartPassive:w,onClick:H},[Wn(N.$slots,"default",{id:N.id})],42,WP))}}),Pc=function({sourcePosition:t=Ve.Bottom,targetPosition:e=Ve.Top,label:n,connectable:i=!0,isValidTargetPos:r,isValidSourcePos:o,data:s}){const a=s.label??n;return[_t(io,{type:"target",position:e,connectable:i,isValidConnection:r}),typeof a!="string"&&a?_t(a):_t(ft,[a]),_t(io,{type:"source",position:t,connectable:i,isValidConnection:o})]};Pc.props=["sourcePosition","targetPosition","label","isValidTargetPos","isValidSourcePos","connectable","data"];Pc.inheritAttrs=!1;Pc.compatConfig={MODE:3};const YP=Pc,Ic=function({targetPosition:t=Ve.Top,label:e,connectable:n=!0,isValidTargetPos:i,data:r}){const o=r.label??e;return[_t(io,{type:"target",position:t,connectable:n,isValidConnection:i}),typeof o!="string"&&o?_t(o):_t(ft,[o])]};Ic.props=["targetPosition","label","isValidTargetPos","connectable","data"];Ic.inheritAttrs=!1;Ic.compatConfig={MODE:3};const qP=Ic,Nc=function({sourcePosition:t=Ve.Bottom,label:e,connectable:n=!0,isValidSourcePos:i,data:r}){const o=r.label??e;return[typeof o!="string"&&o?_t(o):_t(ft,[o]),_t(io,{type:"source",position:t,connectable:n,isValidConnection:i})]};Nc.props=["sourcePosition","label","isValidSourcePos","connectable","data"];Nc.inheritAttrs=!1;Nc.compatConfig={MODE:3};const KP=Nc,ZP=["transform"],jP=["width","height","x","y","rx","ry"],JP=["y"],QP={name:"EdgeText",compatConfig:{MODE:3}},eI=Dt({...QP,props:{x:{},y:{},label:{},labelStyle:{default:()=>({})},labelShowBg:{type:Boolean,default:!0},labelBgStyle:{default:()=>({})},labelBgPadding:{default:()=>[2,4]},labelBgBorderRadius:{default:2}},setup(t){const e=Ke({x:0,y:0,width:0,height:0}),n=Ke(null),i=He(()=>`translate(${t.x-e.value.width/2} ${t.y-e.value.height/2})`);Kn(r),ut([()=>t.x,()=>t.y,n,()=>t.label],r);function r(){if(!n.value)return;const o=n.value.getBBox();(o.width!==e.value.width||o.height!==e.value.height)&&(e.value=o)}return(o,s)=>(Se(),Ce("g",{transform:i.value,class:"vue-flow__edge-textwrapper"},[o.labelShowBg?(Se(),Ce("rect",{key:0,class:"vue-flow__edge-textbg",width:`${e.value.width+2*o.labelBgPadding[0]}px`,height:`${e.value.height+2*o.labelBgPadding[1]}px`,x:-o.labelBgPadding[0],y:-o.labelBgPadding[1],style:It(o.labelBgStyle),rx:o.labelBgBorderRadius,ry:o.labelBgBorderRadius},null,12,jP)):lt("",!0),ge("text",Gs(o.$attrs,{ref_key:"el",ref:n,class:"vue-flow__edge-text",y:e.value.height/2,dy:"0.3em",style:o.labelStyle}),[Wn(o.$slots,"default",{},()=>[typeof o.label!="string"?(Se(),_n(Jg(o.label),{key:0})):(Se(),Ce(ft,{key:1},[Bd(Ze(o.label),1)],64))])],16,JP)],8,ZP))}}),tI=["id","d","marker-end","marker-start"],nI=["d","stroke-width"],iI={name:"BaseEdge",inheritAttrs:!1,compatConfig:{MODE:3}},Dc=Dt({...iI,props:{id:{},labelX:{},labelY:{},path:{},label:{},markerStart:{},markerEnd:{},interactionWidth:{default:20},labelStyle:{},labelShowBg:{type:Boolean},labelBgStyle:{},labelBgPadding:{},labelBgBorderRadius:{}},setup(t,{expose:e}){const n=Ke(null),i=Ke(null),r=Ke(null),o=Ud();return e({pathEl:n,interactionEl:i,labelEl:r}),(s,a)=>(Se(),Ce(ft,null,[ge("path",Gs(me(o),{id:s.id,ref_key:"pathEl",ref:n,d:s.path,class:"vue-flow__edge-path","marker-end":s.markerEnd,"marker-start":s.markerStart}),null,16,tI),s.interactionWidth?(Se(),Ce("path",{key:0,ref_key:"interactionEl",ref:i,fill:"none",d:s.path,"stroke-width":s.interactionWidth,"stroke-opacity":0,class:"vue-flow__edge-interaction"},null,8,nI)):lt("",!0),s.label&&s.labelX&&s.labelY?(Se(),_n(eI,{key:1,ref_key:"labelEl",ref:r,x:s.labelX,y:s.labelY,label:s.label,"label-show-bg":s.labelShowBg,"label-bg-style":s.labelBgStyle,"label-bg-padding":s.labelBgPadding,"label-bg-border-radius":s.labelBgBorderRadius,"label-style":s.labelStyle},null,8,["x","y","label","label-show-bg","label-bg-style","label-bg-padding","label-bg-border-radius","label-style"])):lt("",!0)],64))}});function u_({sourceX:t,sourceY:e,targetX:n,targetY:i}){const r=Math.abs(n-t)/2,o=n<t?n+r:n-r,s=Math.abs(i-e)/2,a=i<e?i+s:i-s;return[o,a,r,s]}function f_({sourceX:t,sourceY:e,targetX:n,targetY:i,sourceControlX:r,sourceControlY:o,targetControlX:s,targetControlY:a}){const l=t*.125+r*.375+s*.375+n*.125,c=e*.125+o*.375+a*.375+i*.125,u=Math.abs(l-t),f=Math.abs(c-e);return[l,c,u,f]}function nl(t,e){return t>=0?.5*t:e*25*Math.sqrt(-t)}function zm({pos:t,x1:e,y1:n,x2:i,y2:r,c:o}){let s,a;switch(t){case Ve.Left:s=e-nl(e-i,o),a=n;break;case Ve.Right:s=e+nl(i-e,o),a=n;break;case Ve.Top:s=e,a=n-nl(n-r,o);break;case Ve.Bottom:s=e,a=n+nl(r-n,o);break}return[s,a]}function d_(t){const{sourceX:e,sourceY:n,sourcePosition:i=Ve.Bottom,targetX:r,targetY:o,targetPosition:s=Ve.Top,curvature:a=.25}=t,[l,c]=zm({pos:i,x1:e,y1:n,x2:r,y2:o,c:a}),[u,f]=zm({pos:s,x1:r,y1:o,x2:e,y2:n,c:a}),[d,h,g,_]=f_({sourceX:e,sourceY:n,targetX:r,targetY:o,sourceControlX:l,sourceControlY:c,targetControlX:u,targetControlY:f});return[`M${e},${n} C${l},${c} ${u},${f} ${r},${o}`,d,h,g,_]}function Vm({pos:t,x1:e,y1:n,x2:i,y2:r}){let o,s;switch(t){case Ve.Left:case Ve.Right:o=.5*(e+i),s=n;break;case Ve.Top:case Ve.Bottom:o=e,s=.5*(n+r);break}return[o,s]}function h_(t){const{sourceX:e,sourceY:n,sourcePosition:i=Ve.Bottom,targetX:r,targetY:o,targetPosition:s=Ve.Top}=t,[a,l]=Vm({pos:i,x1:e,y1:n,x2:r,y2:o}),[c,u]=Vm({pos:s,x1:r,y1:o,x2:e,y2:n}),[f,d,h,g]=f_({sourceX:e,sourceY:n,targetX:r,targetY:o,sourceControlX:a,sourceControlY:l,targetControlX:c,targetControlY:u});return[`M${e},${n} C${a},${l} ${c},${u} ${r},${o}`,f,d,h,g]}const Hm={[Ve.Left]:{x:-1,y:0},[Ve.Right]:{x:1,y:0},[Ve.Top]:{x:0,y:-1},[Ve.Bottom]:{x:0,y:1}};function rI({source:t,sourcePosition:e=Ve.Bottom,target:n}){return e===Ve.Left||e===Ve.Right?t.x<n.x?{x:1,y:0}:{x:-1,y:0}:t.y<n.y?{x:0,y:1}:{x:0,y:-1}}function Gm(t,e){return Math.sqrt((e.x-t.x)**2+(e.y-t.y)**2)}function oI({source:t,sourcePosition:e=Ve.Bottom,target:n,targetPosition:i=Ve.Top,center:r,offset:o}){const s=Hm[e],a=Hm[i],l={x:t.x+s.x*o,y:t.y+s.y*o},c={x:n.x+a.x*o,y:n.y+a.y*o},u=rI({source:l,sourcePosition:e,target:c}),f=u.x!==0?"x":"y",d=u[f];let h,g,_;const m={x:0,y:0},p={x:0,y:0},[b,v,x,D]=u_({sourceX:t.x,sourceY:t.y,targetX:n.x,targetY:n.y});if(s[f]*a[f]===-1){g=r.x??b,_=r.y??v;const U=[{x:g,y:l.y},{x:g,y:c.y}],y=[{x:l.x,y:_},{x:c.x,y:_}];s[f]===d?h=f==="x"?U:y:h=f==="x"?y:U}else{const U=[{x:l.x,y:c.y}],y=[{x:c.x,y:l.y}];if(f==="x"?h=s.x===d?y:U:h=s.y===d?U:y,e===i){const q=Math.abs(t[f]-n[f]);if(q<=o){const M=Math.min(o-1,o-q);s[f]===d?m[f]=(l[f]>t[f]?-1:1)*M:p[f]=(c[f]>n[f]?-1:1)*M}}if(e!==i){const q=f==="x"?"y":"x",M=s[f]===a[q],L=l[q]>c[q],T=l[q]<c[q];(s[f]===1&&(!M&&L||M&&T)||s[f]!==1&&(!M&&T||M&&L))&&(h=f==="x"?U:y)}const w={x:l.x+m.x,y:l.y+m.y},H={x:c.x+p.x,y:c.y+p.y},N=Math.max(Math.abs(w.x-h[0].x),Math.abs(H.x-h[0].x)),I=Math.max(Math.abs(w.y-h[0].y),Math.abs(H.y-h[0].y));N>=I?(g=(w.x+H.x)/2,_=h[0].y):(g=h[0].x,_=(w.y+H.y)/2)}return[[t,{x:l.x+m.x,y:l.y+m.y},...h,{x:c.x+p.x,y:c.y+p.y},n],g,_,x,D]}function sI(t,e,n,i){const r=Math.min(Gm(t,e)/2,Gm(e,n)/2,i),{x:o,y:s}=e;if(t.x===o&&o===n.x||t.y===s&&s===n.y)return`L${o} ${s}`;if(t.y===s){const c=t.x<n.x?-1:1,u=t.y<n.y?1:-1;return`L ${o+r*c},${s}Q ${o},${s} ${o},${s+r*u}`}const a=t.x<n.x?1:-1,l=t.y<n.y?-1:1;return`L ${o},${s+r*l}Q ${o},${s} ${o+r*a},${s}`}function ud(t){const{sourceX:e,sourceY:n,sourcePosition:i=Ve.Bottom,targetX:r,targetY:o,targetPosition:s=Ve.Top,borderRadius:a=5,centerX:l,centerY:c,offset:u=20}=t,[f,d,h,g,_]=oI({source:{x:e,y:n},sourcePosition:i,target:{x:r,y:o},targetPosition:s,center:{x:l,y:c},offset:u});return[f.reduce((p,b,v)=>{let x;return v>0&&v<f.length-1?x=sI(f[v-1],b,f[v+1],a):x=`${v===0?"M":"L"}${b.x} ${b.y}`,p+=x,p},""),d,h,g,_]}function aI(t){const{sourceX:e,sourceY:n,targetX:i,targetY:r}=t,[o,s,a,l]=u_({sourceX:e,sourceY:n,targetX:i,targetY:r});return[`M ${e},${n}L ${i},${r}`,o,s,a,l]}const lI=Dt({name:"StraightEdge",props:["label","labelStyle","labelShowBg","labelBgStyle","labelBgPadding","labelBgBorderRadius","sourceY","sourceX","targetX","targetY","markerEnd","markerStart","interactionWidth"],compatConfig:{MODE:3},setup(t,{attrs:e}){return()=>{const[n,i,r]=aI(t);return _t(Dc,{path:n,labelX:i,labelY:r,...e,...t})}}}),cI=lI,uI=Dt({name:"SmoothStepEdge",props:["sourcePosition","targetPosition","label","labelStyle","labelShowBg","labelBgStyle","labelBgPadding","labelBgBorderRadius","sourceY","sourceX","targetX","targetY","borderRadius","markerEnd","markerStart","interactionWidth","offset"],compatConfig:{MODE:3},setup(t,{attrs:e}){return()=>{const[n,i,r]=ud({...t,sourcePosition:t.sourcePosition??Ve.Bottom,targetPosition:t.targetPosition??Ve.Top});return _t(Dc,{path:n,labelX:i,labelY:r,...e,...t})}}}),p_=uI,fI=Dt({name:"StepEdge",props:["sourcePosition","targetPosition","label","labelStyle","labelShowBg","labelBgStyle","labelBgPadding","labelBgBorderRadius","sourceY","sourceX","targetX","targetY","markerEnd","markerStart","interactionWidth"],setup(t,{attrs:e}){return()=>_t(p_,{...t,...e,borderRadius:0})}}),dI=fI,hI=Dt({name:"BezierEdge",props:["sourcePosition","targetPosition","label","labelStyle","labelShowBg","labelBgStyle","labelBgPadding","labelBgBorderRadius","sourceY","sourceX","targetX","targetY","curvature","markerEnd","markerStart","interactionWidth"],compatConfig:{MODE:3},setup(t,{attrs:e}){return()=>{const[n,i,r]=d_({...t,sourcePosition:t.sourcePosition??Ve.Bottom,targetPosition:t.targetPosition??Ve.Top});return _t(Dc,{path:n,labelX:i,labelY:r,...e,...t})}}}),pI=hI,mI=Dt({name:"SimpleBezierEdge",props:["sourcePosition","targetPosition","label","labelStyle","labelShowBg","labelBgStyle","labelBgPadding","labelBgBorderRadius","sourceY","sourceX","targetX","targetY","markerEnd","markerStart","interactionWidth"],compatConfig:{MODE:3},setup(t,{attrs:e}){return()=>{const[n,i,r]=h_({...t,sourcePosition:t.sourcePosition??Ve.Bottom,targetPosition:t.targetPosition??Ve.Top});return _t(Dc,{path:n,labelX:i,labelY:r,...e,...t})}}}),gI=mI,vI={input:KP,default:YP,output:qP},_I={default:pI,straight:cI,step:dI,smoothstep:p_,simplebezier:gI};function xI(t,e,n){const i=He(()=>_=>e.value.get(_)),r=He(()=>_=>n.value.get(_)),o=He(()=>{const _={..._I,...t.edgeTypes},m=Object.keys(_);for(const p of t.edges)p.type&&!m.includes(p.type)&&(_[p.type]=p.type);return _}),s=He(()=>{const _={...vI,...t.nodeTypes},m=Object.keys(_);for(const p of t.nodes)p.type&&!m.includes(p.type)&&(_[p.type]=p.type);return _}),a=He(()=>t.onlyRenderVisibleElements?Z0(t.nodes,{x:0,y:0,width:t.dimensions.width,height:t.dimensions.height},t.viewport,!0):t.nodes),l=He(()=>{if(t.onlyRenderVisibleElements){const _=[];for(const m of t.edges){const p=e.value.get(m.source),b=e.value.get(m.target);mP({sourcePos:p.computedPosition||{x:0,y:0},targetPos:b.computedPosition||{x:0,y:0},sourceWidth:p.dimensions.width,sourceHeight:p.dimensions.height,targetWidth:b.dimensions.width,targetHeight:b.dimensions.height,width:t.dimensions.width,height:t.dimensions.height,viewport:t.viewport})&&_.push(m)}return _}return t.edges}),c=He(()=>[...a.value,...l.value]),u=He(()=>{const _=[];for(const m of t.nodes)m.selected&&_.push(m);return _}),f=He(()=>{const _=[];for(const m of t.edges)m.selected&&_.push(m);return _}),d=He(()=>[...u.value,...f.value]),h=He(()=>{const _=[];for(const m of t.nodes)m.dimensions.width&&m.dimensions.height&&m.handleBounds!==void 0&&_.push(m);return _}),g=He(()=>a.value.length>0&&h.value.length===a.value.length);return{getNode:i,getEdge:r,getElements:c,getEdgeTypes:o,getNodeTypes:s,getEdges:l,getNodes:a,getSelectedElements:d,getSelectedNodes:u,getSelectedEdges:f,getNodesInitialized:h,areNodesInitialized:g}}class Yr{constructor(){this.currentId=0,this.flows=new Map}static getInstance(){var e;const n=(e=nr())==null?void 0:e.appContext.app,i=n?.config.globalProperties.$vueFlowStorage??Yr.instance;return Yr.instance=i??new Yr,n&&(n.config.globalProperties.$vueFlowStorage=Yr.instance),Yr.instance}set(e,n){return this.flows.set(e,n)}get(e){return this.flows.get(e)}remove(e){return this.flows.delete(e)}create(e,n){const i=c_(),r=wr(i),o={};for(const[d,h]of Object.entries(r.hooks)){const g=`on${d.charAt(0).toUpperCase()+d.slice(1)}`;o[g]=h.on}const s={};for(const[d,h]of Object.entries(r.hooks))s[d]=h.trigger;const a=He(()=>{const d=new Map;for(const h of r.nodes)d.set(h.id,h);return d}),l=He(()=>{const d=new Map;for(const h of r.edges)d.set(h.id,h);return d}),c=xI(r,a,l),u=$P(r,a,l);u.setState({...r,...n});const f={...o,...c,...u,...fA(r),nodeLookup:a,edgeLookup:l,emits:s,id:e,vueFlowVersion:"1.48.2",$destroy:()=>{this.remove(e)}};return this.set(e,f),f}getId(){return`vue-flow-${this.currentId++}`}}function Lt(t){const e=Yr.getInstance(),n=cc(),i=typeof t=="object",r=i?t:{id:t},o=r.id,s=o??n?.vueFlowId;let a;if(n){const l=Nn(km,null);typeof l<"u"&&l!==null&&(!s||l.id===s)&&(a=l)}if(a||s&&(a=e.get(s)),!a||s&&a.id!==s){const l=o??e.getId(),c=e.create(l,r);a=c,(n??lc(!0)).run(()=>{ut(c.applyDefault,(f,d,h)=>{const g=m=>{c.applyNodeChanges(m)},_=m=>{c.applyEdgeChanges(m)};f?(c.onNodesChange(g),c.onEdgesChange(_)):(c.hooks.value.nodesChange.off(g),c.hooks.value.edgesChange.off(_)),h(()=>{c.hooks.value.nodesChange.off(g),c.hooks.value.edgesChange.off(_)})},{immediate:!0}),qs(()=>{if(a){const f=e.get(a.id);f?f.$destroy():va(`No store instance found for id ${a.id} in storage.`)}})})}else i&&a.setState(r);if(n&&(Tr(km,a),n.vueFlowId=a.id),i){const l=nr();l?.type.name!=="VueFlow"&&a.emits.error(new Wt(Ht.USEVUEFLOW_OPTIONS))}return a}function yI(t){const{emits:e,dimensions:n}=Lt();let i;Kn(()=>{const r=()=>{var o,s;if(!t.value||!(((s=(o=t.value).checkVisibility)==null?void 0:s.call(o))??!0))return;const a=Ac(t.value);(a.width===0||a.height===0)&&e.error(new Wt(Ht.MISSING_VIEWPORT_DIMENSIONS)),n.value={width:a.width||500,height:a.height||500}};r(),window.addEventListener("resize",r),t.value&&(i=new ResizeObserver(()=>r()),i.observe(t.value)),ca(()=>{window.removeEventListener("resize",r),i&&t.value&&i.unobserve(t.value)})})}const bI={name:"UserSelection",compatConfig:{MODE:3}},SI=Dt({...bI,props:{userSelectionRect:{}},setup(t){return(e,n)=>(Se(),Ce("div",{class:"vue-flow__selection vue-flow__container",style:It({width:`${e.userSelectionRect.width}px`,height:`${e.userSelectionRect.height}px`,transform:`translate(${e.userSelectionRect.x}px, ${e.userSelectionRect.y}px)`})},null,4))}}),MI=["tabIndex"],EI={name:"NodesSelection",compatConfig:{MODE:3}},wI=Dt({...EI,setup(t){const{emits:e,viewport:n,getSelectedNodes:i,noPanClassName:r,disableKeyboardA11y:o,userSelectionActive:s}=Lt(),a=l_(),l=Ke(null),c=o_({el:l,onStart(g){e.selectionDragStart(g),e.nodeDragStart(g)},onDrag(g){e.selectionDrag(g),e.nodeDrag(g)},onStop(g){e.selectionDragStop(g),e.nodeDragStop(g)}});Kn(()=>{var g;o.value||(g=l.value)==null||g.focus({preventScroll:!0})});const u=He(()=>ah(i.value)),f=He(()=>({width:`${u.value.width}px`,height:`${u.value.height}px`,top:`${u.value.y}px`,left:`${u.value.x}px`}));function d(g){e.selectionContextMenu({event:g,nodes:i.value})}function h(g){o.value||Vo[g.key]&&(g.preventDefault(),a({x:Vo[g.key].x,y:Vo[g.key].y},g.shiftKey))}return(g,_)=>!me(s)&&u.value.width&&u.value.height?(Se(),Ce("div",{key:0,class:Gt(["vue-flow__nodesselection vue-flow__container",me(r)]),style:It({transform:`translate(${me(n).x}px,${me(n).y}px) scale(${me(n).zoom})`})},[ge("div",{ref_key:"el",ref:l,class:Gt([{dragging:me(c)},"vue-flow__nodesselection-rect"]),style:It(f.value),tabIndex:me(o)?void 0:-1,onContextmenu:d,onKeydown:h},null,46,MI)],6)):lt("",!0)}});function TI(t,e){return{x:t.clientX-e.left,y:t.clientY-e.top}}const AI={name:"Pane",compatConfig:{MODE:3}},CI=Dt({...AI,props:{isSelecting:{type:Boolean},selectionKeyPressed:{type:Boolean}},setup(t){const{vueFlowRef:e,nodes:n,viewport:i,emits:r,userSelectionActive:o,removeSelectedElements:s,userSelectionRect:a,elementsSelectable:l,nodesSelectionActive:c,getSelectedEdges:u,getSelectedNodes:f,removeNodes:d,removeEdges:h,selectionMode:g,deleteKeyCode:_,multiSelectionKeyCode:m,multiSelectionActive:p,edgeLookup:b,nodeLookup:v,connectionLookup:x,defaultEdgeOptions:D,connectionStartHandle:O,panOnDrag:U}=Lt(),y=Mr(null),w=Mr(new Set),H=Mr(new Set),N=Mr(null),I=wt(()=>l.value&&(t.isSelecting||o.value)),q=wt(()=>O.value!==null);let M=!1,L=!1;const T=Bs(_,{actInsideInputWithModifier:!1}),C=Bs(m);ut(T,he=>{he&&(d(f.value),h(u.value),c.value=!1)}),ut(C,he=>{p.value=he});function V(he,K){return ne=>{ne.target===K&&he?.(ne)}}function X(he){if(M||q.value){M=!1;return}r.paneClick(he),s(),c.value=!1}function k(he){var K;if(Array.isArray(U.value)&&((K=U.value)!=null&&K.includes(2))){he.preventDefault();return}r.paneContextMenu(he)}function Y(he){r.paneScroll(he)}function j(he){var K,ne,le;if(N.value=((K=e.value)==null?void 0:K.getBoundingClientRect())??null,!l.value||!t.isSelecting||he.button!==0||he.target!==y.value||!N.value)return;(le=(ne=he.target)==null?void 0:ne.setPointerCapture)==null||le.call(ne,he.pointerId);const{x:Te,y:xe}=TI(he,N.value);L=!0,M=!1,s(),a.value={width:0,height:0,startX:Te,startY:xe,x:Te,y:xe},r.selectionStart(he)}function fe(he){var K;if(!N.value||!a.value)return;M=!0;const{x:ne,y:le}=li(he,N.value),{startX:Te=0,startY:xe=0}=a.value,Re={startX:Te,startY:xe,x:ne<Te?ne:Te,y:le<xe?le:xe,width:Math.abs(ne-Te),height:Math.abs(le-xe)},z=w.value,$=H.value;w.value=new Set(Z0(n.value,Re,i.value,g.value===sh.Partial,!0).map(P=>P.id)),H.value=new Set;const R=((K=D.value)==null?void 0:K.selectable)??!0;for(const P of w.value){const B=x.value.get(P);if(B)for(const{edgeId:G}of B.values()){const E=b.value.get(G);E&&(E.selectable??R)&&H.value.add(G)}}if(!Bm(z,w.value)){const P=_r(v.value,w.value,!0);r.nodesChange(P)}if(!Bm($,H.value)){const P=_r(b.value,H.value);r.edgesChange(P)}a.value=Re,o.value=!0,c.value=!1}function _e(he){var K;he.button!==0||!L||((K=he.target)==null||K.releasePointerCapture(he.pointerId),!o.value&&a.value&&he.target===y.value&&X(he),o.value=!1,a.value=null,c.value=w.value.size>0,r.selectionEnd(he),t.selectionKeyPressed&&(M=!1),L=!1)}return(he,K)=>(Se(),Ce("div",{ref_key:"container",ref:y,class:Gt(["vue-flow__pane vue-flow__container",{selection:he.isSelecting}]),onClick:K[0]||(K[0]=ne=>I.value?void 0:V(X,y.value)(ne)),onContextmenu:K[1]||(K[1]=ne=>V(k,y.value)(ne)),onWheelPassive:K[2]||(K[2]=ne=>V(Y,y.value)(ne)),onPointerenter:K[3]||(K[3]=ne=>I.value?void 0:me(r).paneMouseEnter(ne)),onPointerdown:K[4]||(K[4]=ne=>I.value?j(ne):me(r).paneMouseMove(ne)),onPointermove:K[5]||(K[5]=ne=>I.value?fe(ne):me(r).paneMouseMove(ne)),onPointerup:K[6]||(K[6]=ne=>I.value?_e(ne):void 0),onPointerleave:K[7]||(K[7]=ne=>me(r).paneMouseLeave(ne))},[Wn(he.$slots,"default"),me(o)&&me(a)?(Se(),_n(SI,{key:0,"user-selection-rect":me(a)},null,8,["user-selection-rect"])):lt("",!0),me(c)&&me(f).length?(Se(),_n(wI,{key:1})):lt("",!0)],34))}}),RI={name:"Transform",compatConfig:{MODE:3}},PI=Dt({...RI,setup(t){const{viewport:e,fitViewOnInit:n,fitViewOnInitDone:i}=Lt(),r=He(()=>n.value?!i.value:!1),o=He(()=>`translate(${e.value.x}px,${e.value.y}px) scale(${e.value.zoom})`);return(s,a)=>(Se(),Ce("div",{class:"vue-flow__transformationpane vue-flow__container",style:It({transform:o.value,opacity:r.value?0:void 0})},[Wn(s.$slots,"default")],4))}}),II={name:"Viewport",compatConfig:{MODE:3}},NI=Dt({...II,setup(t){const{minZoom:e,maxZoom:n,defaultViewport:i,translateExtent:r,zoomActivationKeyCode:o,selectionKeyCode:s,panActivationKeyCode:a,panOnScroll:l,panOnScrollMode:c,panOnScrollSpeed:u,panOnDrag:f,zoomOnDoubleClick:d,zoomOnPinch:h,zoomOnScroll:g,preventScrolling:_,noWheelClassName:m,noPanClassName:p,emits:b,connectionStartHandle:v,userSelectionActive:x,paneDragging:D,d3Zoom:O,d3Selection:U,d3ZoomHandler:y,viewport:w,viewportRef:H,paneClickDistance:N}=Lt();yI(H);const I=Mr(!1),q=Mr(!1);let M=null,L=!1,T=0,C={x:0,y:0,zoom:0};const V=Bs(a),X=Bs(s),k=Bs(o),Y=wt(()=>(!X.value||X.value&&s.value===!0)&&(V.value||f.value)),j=wt(()=>V.value||l.value),fe=wt(()=>s.value===!0&&Y.value!==!0),_e=wt(()=>X.value&&s.value!==!0||x.value||fe.value),he=wt(()=>v.value!==null);Kn(()=>{if(!H.value){va("Viewport element is missing");return}const xe=H.value,Re=xe.getBoundingClientRect(),z=K2().clickDistance(N.value).scaleExtent([e.value,n.value]).translateExtent(r.value),$=Vn(xe).call(z),R=$.on("wheel.zoom"),P=Jo.translate(i.value.x??0,i.value.y??0).scale(lo(i.value.zoom??1,e.value,n.value)),B=[[0,0],[Re.width,Re.height]],G=z.constrain()(P,B,r.value);z.transform($,G),z.wheelDelta(ad),O.value=z,U.value=$,y.value=R,w.value={x:G.x,y:G.y,zoom:G.k},z.on("start",E=>{var ie;if(!E.sourceEvent)return null;T=E.sourceEvent.button,I.value=!0;const Q=le(E.transform);((ie=E.sourceEvent)==null?void 0:ie.type)==="mousedown"&&(D.value=!0),C=Q,b.viewportChangeStart(Q),b.moveStart({event:E,flowTransform:Q})}),z.on("end",E=>{if(!E.sourceEvent)return null;if(I.value=!1,D.value=!1,K(Y.value,T??0)&&!L&&b.paneContextMenu(E.sourceEvent),L=!1,ne(C,E.transform)){const ie=le(E.transform);C=ie,b.viewportChangeEnd(ie),b.moveEnd({event:E,flowTransform:ie})}}),z.filter(E=>{var ie;const Q=k.value||g.value,J=h.value&&E.ctrlKey,te=E.button,A=E.type==="wheel";if(te===1&&E.type==="mousedown"&&(Te(E,"vue-flow__node")||Te(E,"vue-flow__edge")))return!0;if(!Y.value&&!Q&&!j.value&&!d.value&&!h.value||x.value||he.value&&!A||!d.value&&E.type==="dblclick"||Te(E,m.value)&&A||Te(E,p.value)&&(!A||j.value&&A&&!k.value)||!h.value&&E.ctrlKey&&A||!Q&&!j.value&&!J&&A)return!1;if(!h&&E.type==="touchstart"&&((ie=E.touches)==null?void 0:ie.length)>1)return E.preventDefault(),!1;if(!Y.value&&(E.type==="mousedown"||E.type==="touchstart")||fe.value&&Array.isArray(f.value)&&f.value.includes(0)&&te===0||Array.isArray(f.value)&&!f.value.includes(te)&&(E.type==="mousedown"||E.type==="touchstart"))return!1;const S=Array.isArray(f.value)&&f.value.includes(te)||s.value===!0&&Array.isArray(f.value)&&!f.value.includes(0)||!te||te<=1;return(!E.ctrlKey||V.value||A)&&S}),ut([x,Y],()=>{x.value&&!I.value?z.on("zoom",null):x.value||z.on("zoom",E=>{w.value={x:E.transform.x,y:E.transform.y,zoom:E.transform.k};const ie=le(E.transform);L=K(Y.value,T??0),b.viewportChange(ie),b.move({event:E,flowTransform:ie})})},{immediate:!0}),ut([x,j,c,k,h,_,m],()=>{j.value&&!k.value&&!x.value?$.on("wheel.zoom",E=>{if(Te(E,m.value))return!1;const ie=k.value||g.value,Q=h.value&&E.ctrlKey;if(!(!_.value||j.value||ie||Q))return!1;E.preventDefault(),E.stopImmediatePropagation();const te=$.property("__zoom").k||1,A=na();if(!V.value&&E.ctrlKey&&h.value&&A){const oe=ii(E),Pe=ad(E),ye=te*2**Pe;z.scaleTo($,ye,oe,E);return}const S=E.deltaMode===1?20:1;let W=c.value===Os.Vertical?0:E.deltaX*S,re=c.value===Os.Horizontal?0:E.deltaY*S;!A&&E.shiftKey&&c.value!==Os.Vertical&&!W&&re&&(W=re,re=0),z.translateBy($,-(W/te)*u.value,-(re/te)*u.value);const ue=le($.property("__zoom"));M&&clearTimeout(M),q.value?(b.move({event:E,flowTransform:ue}),b.viewportChange(ue),M=setTimeout(()=>{b.moveEnd({event:E,flowTransform:ue}),b.viewportChangeEnd(ue),q.value=!1},150)):(q.value=!0,b.moveStart({event:E,flowTransform:ue}),b.viewportChangeStart(ue))},{passive:!1}):typeof R<"u"&&$.on("wheel.zoom",function(E,ie){const Q=!_.value&&E.type==="wheel"&&!E.ctrlKey,J=k.value||g.value,te=h.value&&E.ctrlKey;if(!J&&!l.value&&!te&&E.type==="wheel"||Q||Te(E,m.value))return null;E.preventDefault(),R.call(this,E,ie)},{passive:!1})},{immediate:!0})});function K(xe,Re){return Re===2&&Array.isArray(xe)&&xe.includes(2)}function ne(xe,Re){return xe.x!==Re.x&&!Number.isNaN(Re.x)||xe.y!==Re.y&&!Number.isNaN(Re.y)||xe.zoom!==Re.k&&!Number.isNaN(Re.k)}function le(xe){return{x:xe.x,y:xe.y,zoom:xe.k}}function Te(xe,Re){return xe.target.closest(`.${Re}`)}return(xe,Re)=>(Se(),Ce("div",{ref_key:"viewportRef",ref:H,class:"vue-flow__viewport vue-flow__container"},[st(CI,{"is-selecting":_e.value,"selection-key-pressed":me(X),class:Gt({connecting:he.value,dragging:me(D),draggable:me(f)===!0||Array.isArray(me(f))&&me(f).includes(0)})},{default:Bn(()=>[st(PI,null,{default:Bn(()=>[Wn(xe.$slots,"default")]),_:3})]),_:3},8,["is-selecting","selection-key-pressed","class"])],512))}}),DI=["id"],LI=["id"],UI=["id"],FI={name:"A11yDescriptions",compatConfig:{MODE:3}},OI=Dt({...FI,setup(t){const{id:e,disableKeyboardA11y:n,ariaLiveMessage:i}=Lt();return(r,o)=>(Se(),Ce(ft,null,[ge("div",{id:`${me(V0)}-${me(e)}`,style:{display:"none"}}," Press enter or space to select a node. "+Ze(me(n)?"":"You can then use the arrow keys to move the node around.")+" You can then use the arrow keys to move the node around, press delete to remove it and press escape to cancel. ",9,DI),ge("div",{id:`${me(H0)}-${me(e)}`,style:{display:"none"}}," Press enter or space to select an edge. You can then press delete to remove it or press escape to cancel. ",8,LI),me(n)?lt("",!0):(Se(),Ce("div",{key:0,id:`${me(tP)}-${me(e)}`,"aria-live":"assertive","aria-atomic":"true",style:{position:"absolute",width:"1px",height:"1px",margin:"-1px",border:"0",padding:"0",overflow:"hidden",clip:"rect(0px, 0px, 0px, 0px)","clip-path":"inset(100%)"}},Ze(me(i)),9,UI))],64))}});function BI(){const t=Lt();ut(()=>t.viewportHelper.value.viewportInitialized,e=>{e&&setTimeout(()=>{t.emits.init(t),t.emits.paneReady(t)},1)})}function kI(t,e,n){return n===Ve.Left?t-e:n===Ve.Right?t+e:t}function zI(t,e,n){return n===Ve.Top?t-e:n===Ve.Bottom?t+e:t}const uh=function({radius:t=10,centerX:e=0,centerY:n=0,position:i=Ve.Top,type:r}){return _t("circle",{class:`vue-flow__edgeupdater vue-flow__edgeupdater-${r}`,cx:kI(e,t,i),cy:zI(n,t,i),r:t,stroke:"transparent",fill:"transparent"})};uh.props=["radius","centerX","centerY","position","type"];uh.compatConfig={MODE:3};const $m=uh,VI=Dt({name:"Edge",compatConfig:{MODE:3},props:["id"],setup(t){const{id:e,addSelectedEdges:n,connectionMode:i,edgeUpdaterRadius:r,emits:o,nodesSelectionActive:s,noPanClassName:a,getEdgeTypes:l,removeSelectedEdges:c,findEdge:u,findNode:f,isValidConnection:d,multiSelectionActive:h,disableKeyboardA11y:g,elementsSelectable:_,edgesUpdatable:m,edgesFocusable:p,hooks:b}=Lt(),v=He(()=>u(t.id)),{emit:x,on:D}=IP(v.value,o),O=Nn(Rc),U=nr(),y=Ke(!1),w=Ke(!1),H=Ke(""),N=Ke(null),I=Ke("source"),q=Ke(null),M=wt(()=>typeof v.value.selectable>"u"?_.value:v.value.selectable),L=wt(()=>typeof v.value.updatable>"u"?m.value:v.value.updatable),T=wt(()=>typeof v.value.focusable>"u"?p.value:v.value.focusable);Tr(CP,t.id),Tr(RP,q);const C=He(()=>v.value.class instanceof Function?v.value.class(v.value):v.value.class),V=He(()=>v.value.style instanceof Function?v.value.style(v.value):v.value.style),X=He(()=>{const P=v.value.type||"default",B=O?.[`edge-${P}`];if(B)return B;let G=v.value.template??l.value[P];if(typeof G=="string"&&U){const E=Object.keys(U.appContext.components);E&&E.includes(P)&&(G=Zg(P,!1))}return G&&typeof G!="string"?G:(o.error(new Wt(Ht.EDGE_TYPE_MISSING,G)),!1)}),{handlePointerDown:k}=s_({nodeId:H,handleId:N,type:I,isValidConnection:d,edgeUpdaterType:I,onEdgeUpdate:fe,onEdgeUpdateEnd:_e});return()=>{const P=f(v.value.source),B=f(v.value.target),G="pathOptions"in v.value?v.value.pathOptions:{};if(!P&&!B)return o.error(new Wt(Ht.EDGE_SOURCE_TARGET_MISSING,v.value.id,v.value.source,v.value.target)),null;if(!P)return o.error(new Wt(Ht.EDGE_SOURCE_MISSING,v.value.id,v.value.source)),null;if(!B)return o.error(new Wt(Ht.EDGE_TARGET_MISSING,v.value.id,v.value.target)),null;if(!v.value||v.value.hidden||P.hidden||B.hidden)return null;let E;i.value===Rr.Strict?E=P.handleBounds.source:E=[...P.handleBounds.source||[],...P.handleBounds.target||[]];const ie=Nm(E,v.value.sourceHandle);let Q;i.value===Rr.Strict?Q=B.handleBounds.target:Q=[...B.handleBounds.target||[],...B.handleBounds.source||[]];const J=Nm(Q,v.value.targetHandle),te=ie?.position||Ve.Bottom,A=J?.position||Ve.Top,{x:S,y:W}=Qo(P,ie,te),{x:re,y:ue}=Qo(B,J,A);return v.value.sourceX=S,v.value.sourceY=W,v.value.targetX=re,v.value.targetY=ue,_t("g",{ref:q,key:t.id,"data-id":t.id,class:["vue-flow__edge",`vue-flow__edge-${X.value===!1?"default":v.value.type||"default"}`,a.value,C.value,{updating:y.value,selected:v.value.selected,animated:v.value.animated,inactive:!M.value&&!b.value.edgeClick.hasListeners()}],tabIndex:T.value?0:void 0,"aria-label":v.value.ariaLabel===null?void 0:v.value.ariaLabel??`Edge from ${v.value.source} to ${v.value.target}`,"aria-describedby":T.value?`${H0}-${e}`:void 0,"aria-roledescription":"edge",role:T.value?"group":"img",...v.value.domAttributes,onClick:K,onContextmenu:ne,onDblclick:le,onMouseenter:Te,onMousemove:xe,onMouseleave:Re,onKeyDown:T.value?R:void 0},[w.value?null:_t(X.value===!1?l.value.default:X.value,{id:t.id,sourceNode:P,targetNode:B,source:v.value.source,target:v.value.target,type:v.value.type,updatable:L.value,selected:v.value.selected,animated:v.value.animated,label:v.value.label,labelStyle:v.value.labelStyle,labelShowBg:v.value.labelShowBg,labelBgStyle:v.value.labelBgStyle,labelBgPadding:v.value.labelBgPadding,labelBgBorderRadius:v.value.labelBgBorderRadius,data:v.value.data,events:{...v.value.events,...D},style:V.value,markerStart:`url('#${ta(v.value.markerStart,e)}')`,markerEnd:`url('#${ta(v.value.markerEnd,e)}')`,sourcePosition:te,targetPosition:A,sourceX:S,sourceY:W,targetX:re,targetY:ue,sourceHandleId:v.value.sourceHandle,targetHandleId:v.value.targetHandle,interactionWidth:v.value.interactionWidth,...G}),[L.value==="source"||L.value===!0?[_t("g",{onMousedown:z,onMouseenter:Y,onMouseout:j},_t($m,{position:te,centerX:S,centerY:W,radius:r.value,type:"source","data-type":"source"}))]:null,L.value==="target"||L.value===!0?[_t("g",{onMousedown:$,onMouseenter:Y,onMouseout:j},_t($m,{position:A,centerX:re,centerY:ue,radius:r.value,type:"target","data-type":"target"}))]:null]])};function Y(){y.value=!0}function j(){y.value=!1}function fe(P,B){x.update({event:P,edge:v.value,connection:B})}function _e(P){x.updateEnd({event:P,edge:v.value}),w.value=!1}function he(P,B){P.button===0&&(w.value=!0,H.value=B?v.value.target:v.value.source,N.value=(B?v.value.targetHandle:v.value.sourceHandle)??null,I.value=B?"target":"source",x.updateStart({event:P,edge:v.value}),k(P))}function K(P){var B;const G={event:P,edge:v.value};M.value&&(s.value=!1,v.value.selected&&h.value?(c([v.value]),(B=q.value)==null||B.blur()):n([v.value])),x.click(G)}function ne(P){x.contextMenu({event:P,edge:v.value})}function le(P){x.doubleClick({event:P,edge:v.value})}function Te(P){x.mouseEnter({event:P,edge:v.value})}function xe(P){x.mouseMove({event:P,edge:v.value})}function Re(P){x.mouseLeave({event:P,edge:v.value})}function z(P){he(P,!0)}function $(P){he(P,!1)}function R(P){var B;!g.value&&G0.includes(P.key)&&M.value&&(P.key==="Escape"?((B=q.value)==null||B.blur(),c([u(t.id)])):n([u(t.id)]))}}}),HI=VI,GI=Dt({name:"ConnectionLine",compatConfig:{MODE:3},setup(){var t;const{id:e,connectionMode:n,connectionStartHandle:i,connectionEndHandle:r,connectionPosition:o,connectionLineType:s,connectionLineStyle:a,connectionLineOptions:l,connectionStatus:c,viewport:u,findNode:f}=Lt(),d=(t=Nn(Rc))==null?void 0:t["connection-line"],h=He(()=>{var b;return f((b=i.value)==null?void 0:b.nodeId)}),g=He(()=>{var b;return f((b=r.value)==null?void 0:b.nodeId)??null}),_=He(()=>({x:(o.value.x-u.value.x)/u.value.zoom,y:(o.value.y-u.value.y)/u.value.zoom})),m=He(()=>l.value.markerStart?`url(#${ta(l.value.markerStart,e)})`:""),p=He(()=>l.value.markerEnd?`url(#${ta(l.value.markerEnd,e)})`:"");return()=>{var b,v,x;if(!h.value||!i.value)return null;const D=i.value.id,O=i.value.type,U=h.value.handleBounds;let y=U?.[O]??[];if(n.value===Rr.Loose){const V=U?.[O==="source"?"target":"source"]??[];y=[...y,...V]}if(!y)return null;const w=(D?y.find(V=>V.id===D):y[0])??null,H=w?.position??Ve.Top,{x:N,y:I}=Qo(h.value,w,H);let q=null;g.value&&(n.value===Rr.Strict?q=((b=g.value.handleBounds[O==="source"?"target":"source"])==null?void 0:b.find(V=>{var X;return V.id===((X=r.value)==null?void 0:X.id)}))||null:q=((v=[...g.value.handleBounds.source??[],...g.value.handleBounds.target??[]])==null?void 0:v.find(V=>{var X;return V.id===((X=r.value)==null?void 0:X.id)}))||null);const M=((x=r.value)==null?void 0:x.position)??(H?ld[H]:null);if(!H||!M)return null;const L=s.value??l.value.type??Wr.Bezier;let T="";const C={sourceX:N,sourceY:I,sourcePosition:H,targetX:_.value.x,targetY:_.value.y,targetPosition:M};return L===Wr.Bezier?[T]=d_(C):L===Wr.Step?[T]=ud({...C,borderRadius:0}):L===Wr.SmoothStep?[T]=ud(C):L===Wr.SimpleBezier?[T]=h_(C):T=`M${N},${I} ${_.value.x},${_.value.y}`,_t("svg",{class:"vue-flow__edges vue-flow__connectionline vue-flow__container"},_t("g",{class:"vue-flow__connection"},d?_t(d,{sourceX:N,sourceY:I,sourcePosition:H,targetX:_.value.x,targetY:_.value.y,targetPosition:M,sourceNode:h.value,sourceHandle:w,targetNode:g.value,targetHandle:q,markerEnd:p.value,markerStart:m.value,connectionStatus:c.value}):_t("path",{d:T,class:[l.value.class,c.value,"vue-flow__connection-path"],style:{...a.value,...l.value.style},"marker-end":p.value,"marker-start":m.value})))}}}),$I=GI,WI=["id","markerWidth","markerHeight","markerUnits","orient"],XI={name:"MarkerType",compatConfig:{MODE:3}},YI=Dt({...XI,props:{id:{},type:{},color:{default:"none"},width:{default:12.5},height:{default:12.5},markerUnits:{default:"strokeWidth"},orient:{default:"auto-start-reverse"},strokeWidth:{default:1}},setup(t){return(e,n)=>(Se(),Ce("marker",{id:e.id,class:"vue-flow__arrowhead",viewBox:"-10 -10 20 20",refX:"0",refY:"0",markerWidth:`${e.width}`,markerHeight:`${e.height}`,markerUnits:e.markerUnits,orient:e.orient},[e.type===me(od).ArrowClosed?(Se(),Ce("polyline",{key:0,style:It({stroke:e.color,fill:e.color,strokeWidth:e.strokeWidth}),"stroke-linecap":"round","stroke-linejoin":"round",points:"-5,-4 0,0 -5,4 -5,-4"},null,4)):lt("",!0),e.type===me(od).Arrow?(Se(),Ce("polyline",{key:1,style:It({stroke:e.color,strokeWidth:e.strokeWidth}),"stroke-linecap":"round","stroke-linejoin":"round",fill:"none",points:"-5,-4 0,0 -5,4"},null,4)):lt("",!0)],8,WI))}}),qI={class:"vue-flow__marker vue-flow__container","aria-hidden":"true"},KI={name:"MarkerDefinitions",compatConfig:{MODE:3}},ZI=Dt({...KI,setup(t){const{id:e,edges:n,connectionLineOptions:i,defaultMarkerColor:r}=Lt(),o=He(()=>{const s=new Set,a=[],l=c=>{if(c){const u=ta(c,e);s.has(u)||(typeof c=="object"?a.push({...c,id:u,color:c.color||r.value}):a.push({id:u,color:r.value,type:c}),s.add(u))}};for(const c of[i.value.markerEnd,i.value.markerStart])l(c);for(const c of n.value)for(const u of[c.markerStart,c.markerEnd])l(u);return a.sort((c,u)=>c.id.localeCompare(u.id))});return(s,a)=>(Se(),Ce("svg",qI,[ge("defs",null,[(Se(!0),Ce(ft,null,Sn(o.value,l=>(Se(),_n(YI,{id:l.id,key:l.id,type:l.type,color:l.color,width:l.width,height:l.height,markerUnits:l.markerUnits,"stroke-width":l.strokeWidth,orient:l.orient},null,8,["id","type","color","width","height","markerUnits","stroke-width","orient"]))),128))])]))}}),jI={name:"Edges",compatConfig:{MODE:3}},JI=Dt({...jI,setup(t){const{findNode:e,getEdges:n,elevateEdgesOnSelect:i}=Lt();return(r,o)=>(Se(),Ce(ft,null,[st(ZI),(Se(!0),Ce(ft,null,Sn(me(n),s=>(Se(),Ce("svg",{key:s.id,class:"vue-flow__edges vue-flow__container",style:It({zIndex:me(gP)(s,me(e),me(i))})},[st(me(HI),{id:s.id},null,8,["id"])],4))),128)),st(me($I))],64))}}),QI=Dt({name:"Node",compatConfig:{MODE:3},props:["id","resizeObserver"],setup(t){const{id:e,noPanClassName:n,selectNodesOnDrag:i,nodesSelectionActive:r,multiSelectionActive:o,emits:s,removeSelectedNodes:a,addSelectedNodes:l,updateNodeDimensions:c,onUpdateNodeInternals:u,getNodeTypes:f,nodeExtent:d,elevateNodesOnSelect:h,disableKeyboardA11y:g,ariaLiveMessage:_,snapToGrid:m,snapGrid:p,nodeDragThreshold:b,nodesDraggable:v,elementsSelectable:x,nodesConnectable:D,nodesFocusable:O,hooks:U}=Lt(),y=Ke(null);Tr(r_,y),Tr(i_,t.id);const w=Nn(Rc),H=nr(),N=l_(),{node:I,parentNode:q}=a_(t.id),{emit:M,on:L}=UP(I,s),T=wt(()=>typeof I.draggable>"u"?v.value:I.draggable),C=wt(()=>typeof I.selectable>"u"?x.value:I.selectable),V=wt(()=>typeof I.connectable>"u"?D.value:I.connectable),X=wt(()=>typeof I.focusable>"u"?O.value:I.focusable),k=He(()=>C.value||T.value||U.value.nodeClick.hasListeners()||U.value.nodeDoubleClick.hasListeners()||U.value.nodeMouseEnter.hasListeners()||U.value.nodeMouseMove.hasListeners()||U.value.nodeMouseLeave.hasListeners()),Y=wt(()=>!!I.dimensions.width&&!!I.dimensions.height),j=He(()=>{const B=I.type||"default",G=w?.[`node-${B}`];if(G)return G;let E=I.template||f.value[B];if(typeof E=="string"&&H){const ie=Object.keys(H.appContext.components);ie&&ie.includes(B)&&(E=Zg(B,!1))}return E&&typeof E!="string"?E:(s.error(new Wt(Ht.NODE_TYPE_MISSING,E)),!1)}),fe=o_({id:t.id,el:y,disabled:()=>!T.value,selectable:C,dragHandle:()=>I.dragHandle,onStart(B){M.dragStart(B)},onDrag(B){M.drag(B)},onStop(B){M.dragStop(B)},onClick(B){R(B)}}),_e=He(()=>I.class instanceof Function?I.class(I):I.class),he=He(()=>{const B=(I.style instanceof Function?I.style(I):I.style)||{},G=I.width instanceof Function?I.width(I):I.width,E=I.height instanceof Function?I.height(I):I.height;return!B.width&&G&&(B.width=typeof G=="string"?G:`${G}px`),!B.height&&E&&(B.height=typeof E=="string"?E:`${E}px`),B}),K=wt(()=>Number(I.zIndex??he.value.zIndex??0));return u(B=>{(B.includes(t.id)||!B.length)&&le()}),Kn(()=>{ut(()=>I.hidden,(B=!1,G,E)=>{!B&&y.value&&(t.resizeObserver.observe(y.value),E(()=>{y.value&&t.resizeObserver.unobserve(y.value)}))},{immediate:!0,flush:"post"})}),ut([()=>I.type,()=>I.sourcePosition,()=>I.targetPosition],()=>{In(()=>{c([{id:t.id,nodeElement:y.value,forceUpdate:!0}])})}),ut([()=>I.position.x,()=>I.position.y,()=>{var B;return(B=q.value)==null?void 0:B.computedPosition.x},()=>{var B;return(B=q.value)==null?void 0:B.computedPosition.y},()=>{var B;return(B=q.value)==null?void 0:B.computedPosition.z},K,()=>I.selected,()=>I.dimensions.height,()=>I.dimensions.width,()=>{var B;return(B=q.value)==null?void 0:B.dimensions.height},()=>{var B;return(B=q.value)==null?void 0:B.dimensions.width}],([B,G,E,ie,Q,J])=>{const te={x:B,y:G,z:J+(h.value&&I.selected?1e3:0)};typeof E<"u"&&typeof ie<"u"?I.computedPosition=uP({x:E,y:ie,z:Q},te):I.computedPosition=te},{flush:"post",immediate:!0}),ut([()=>I.extent,d],([B,G],[E,ie])=>{(B!==E||G!==ie)&&ne()}),I.extent==="parent"||typeof I.extent=="object"&&"range"in I.extent&&I.extent.range==="parent"?Zf(()=>Y).toBe(!0).then(ne):ne(),()=>I.hidden?null:_t("div",{ref:y,"data-id":I.id,class:["vue-flow__node",`vue-flow__node-${j.value===!1?"default":I.type||"default"}`,{[n.value]:T.value,dragging:fe?.value,draggable:T.value,selected:I.selected,selectable:C.value,parent:I.isParent},_e.value],style:{visibility:Y.value?"visible":"hidden",zIndex:I.computedPosition.z??K.value,transform:`translate(${I.computedPosition.x}px,${I.computedPosition.y}px)`,pointerEvents:k.value?"all":"none",...he.value},tabIndex:X.value?0:void 0,role:X.value?"group":void 0,"aria-describedby":g.value?void 0:`${V0}-${e}`,"aria-label":I.ariaLabel,"aria-roledescription":"node",...I.domAttributes,onMouseenter:Te,onMousemove:xe,onMouseleave:Re,onContextmenu:z,onClick:R,onDblclick:$,onKeydown:P},[_t(j.value===!1?f.value.default:j.value,{id:I.id,type:I.type,data:I.data,events:{...I.events,...L},selected:I.selected,resizing:I.resizing,dragging:fe.value,connectable:V.value,position:I.computedPosition,dimensions:I.dimensions,isValidTargetPos:I.isValidTargetPos,isValidSourcePos:I.isValidSourcePos,parent:I.parentNode,parentNodeId:I.parentNode,zIndex:I.computedPosition.z??K.value,targetPosition:I.targetPosition,sourcePosition:I.sourcePosition,label:I.label,dragHandle:I.dragHandle,onUpdateNodeInternals:le})]);function ne(){const B=I.computedPosition,{computedPosition:G,position:E}=lh(I,m.value?Cc(B,p.value):B,s.error,d.value,q.value);(I.computedPosition.x!==G.x||I.computedPosition.y!==G.y)&&(I.computedPosition={...I.computedPosition,...G}),(I.position.x!==E.x||I.position.y!==E.y)&&(I.position=E)}function le(){y.value&&c([{id:t.id,nodeElement:y.value,forceUpdate:!0}])}function Te(B){fe?.value||M.mouseEnter({event:B,node:I})}function xe(B){fe?.value||M.mouseMove({event:B,node:I})}function Re(B){fe?.value||M.mouseLeave({event:B,node:I})}function z(B){return M.contextMenu({event:B,node:I})}function $(B){return M.doubleClick({event:B,node:I})}function R(B){C.value&&(!i.value||!T.value||b.value>0)&&cd(I,o.value,l,a,r,!1,y.value),M.click({event:B,node:I})}function P(B){if(!(sd(B)||g.value))if(G0.includes(B.key)&&C.value){const G=B.key==="Escape";cd(I,o.value,l,a,r,G,y.value)}else T.value&&I.selected&&Vo[B.key]&&(B.preventDefault(),_.value=`Moved selected node ${B.key.replace("Arrow","").toLowerCase()}. New position, x: ${~~I.position.x}, y: ${~~I.position.y}`,N({x:Vo[B.key].x,y:Vo[B.key].y},B.shiftKey))}}}),e3=QI;function t3(t={includeHiddenNodes:!1}){const{nodes:e}=Lt();return He(()=>{if(e.value.length===0)return!1;for(const n of e.value)if((t.includeHiddenNodes||!n.hidden)&&(n?.handleBounds===void 0||n.dimensions.width===0||n.dimensions.height===0))return!1;return!0})}const n3={class:"vue-flow__nodes vue-flow__container"},i3={name:"Nodes",compatConfig:{MODE:3}},r3=Dt({...i3,setup(t){const{getNodes:e,updateNodeDimensions:n,emits:i}=Lt(),r=t3(),o=Ke();return ut(r,s=>{s&&In(()=>{i.nodesInitialized(e.value)})},{immediate:!0}),Kn(()=>{o.value=new ResizeObserver(s=>{const a=s.map(l=>({id:l.target.getAttribute("data-id"),nodeElement:l.target,forceUpdate:!0}));In(()=>n(a))})}),ca(()=>{var s;return(s=o.value)==null?void 0:s.disconnect()}),(s,a)=>(Se(),Ce("div",n3,[o.value?(Se(!0),Ce(ft,{key:0},Sn(me(e),(l,c,u,f)=>{const d=[l.id];if(f&&f.key===l.id&&Xy(f,d))return f;const h=(Se(),_n(me(e3),{id:l.id,key:l.id,"resize-observer":o.value},null,8,["id","resize-observer"]));return h.memo=d,h},a,0),128)):lt("",!0)]))}});function o3(){const{emits:t}=Lt();Kn(()=>{if(n_()){const e=document.querySelector(".vue-flow__pane");e&&window.getComputedStyle(e).zIndex!=="1"&&t.error(new Wt(Ht.MISSING_STYLES))}})}const s3=ge("div",{class:"vue-flow__edge-labels"},null,-1),a3={name:"VueFlow",compatConfig:{MODE:3}},l3=Dt({...a3,props:{id:{},modelValue:{},nodes:{},edges:{},edgeTypes:{},nodeTypes:{},connectionMode:{},connectionLineType:{},connectionLineStyle:{default:void 0},connectionLineOptions:{default:void 0},connectionRadius:{},isValidConnection:{type:[Function,null],default:void 0},deleteKeyCode:{default:void 0},selectionKeyCode:{type:[Boolean,null],default:void 0},multiSelectionKeyCode:{default:void 0},zoomActivationKeyCode:{default:void 0},panActivationKeyCode:{default:void 0},snapToGrid:{type:Boolean,default:void 0},snapGrid:{},onlyRenderVisibleElements:{type:Boolean,default:void 0},edgesUpdatable:{type:[Boolean,String],default:void 0},nodesDraggable:{type:Boolean,default:void 0},nodesConnectable:{type:Boolean,default:void 0},nodeDragThreshold:{},elementsSelectable:{type:Boolean,default:void 0},selectNodesOnDrag:{type:Boolean,default:void 0},panOnDrag:{type:[Boolean,Array],default:void 0},minZoom:{},maxZoom:{},defaultViewport:{},translateExtent:{},nodeExtent:{},defaultMarkerColor:{},zoomOnScroll:{type:Boolean,default:void 0},zoomOnPinch:{type:Boolean,default:void 0},panOnScroll:{type:Boolean,default:void 0},panOnScrollSpeed:{},panOnScrollMode:{},paneClickDistance:{},zoomOnDoubleClick:{type:Boolean,default:void 0},preventScrolling:{type:Boolean,default:void 0},selectionMode:{},edgeUpdaterRadius:{},fitViewOnInit:{type:Boolean,default:void 0},connectOnClick:{type:Boolean,default:void 0},applyDefault:{type:Boolean,default:void 0},autoConnect:{type:[Boolean,Function],default:void 0},noDragClassName:{},noWheelClassName:{},noPanClassName:{},defaultEdgeOptions:{},elevateEdgesOnSelect:{type:Boolean,default:void 0},elevateNodesOnSelect:{type:Boolean,default:void 0},disableKeyboardA11y:{type:Boolean,default:void 0},edgesFocusable:{type:Boolean,default:void 0},nodesFocusable:{type:Boolean,default:void 0},autoPanOnConnect:{type:Boolean,default:void 0},autoPanOnNodeDrag:{type:Boolean,default:void 0},autoPanSpeed:{}},emits:["nodesChange","edgesChange","nodesInitialized","paneReady","init","updateNodeInternals","error","connect","connectStart","connectEnd","clickConnectStart","clickConnectEnd","moveStart","move","moveEnd","selectionDragStart","selectionDrag","selectionDragStop","selectionContextMenu","selectionStart","selectionEnd","viewportChangeStart","viewportChange","viewportChangeEnd","paneScroll","paneClick","paneContextMenu","paneMouseEnter","paneMouseMove","paneMouseLeave","edgeUpdate","edgeContextMenu","edgeMouseEnter","edgeMouseMove","edgeMouseLeave","edgeDoubleClick","edgeClick","edgeUpdateStart","edgeUpdateEnd","nodeContextMenu","nodeMouseEnter","nodeMouseMove","nodeMouseLeave","nodeDoubleClick","nodeClick","nodeDragStart","nodeDrag","nodeDragStop","miniMapNodeClick","miniMapNodeDoubleClick","miniMapNodeMouseEnter","miniMapNodeMouseMove","miniMapNodeMouseLeave","update:modelValue","update:nodes","update:edges"],setup(t,{expose:e,emit:n}){const i=t,r=tv(),o=Iu(i,"modelValue",n),s=Iu(i,"nodes",n),a=Iu(i,"edges",n),l=Lt(i),c=kP({modelValue:o,nodes:s,edges:a},i,l);return VP(n,l.hooks),BI(),o3(),Tr(Rc,r),Ld(c),e(l),(u,f)=>(Se(),Ce("div",{ref:me(l).vueFlowRef,class:"vue-flow"},[st(NI,null,{default:Bn(()=>[st(JI),s3,st(r3),Wn(u.$slots,"zoom-pane")]),_:3}),Wn(u.$slots,"default"),st(OI)],512))}}),c3={name:"Panel",compatConfig:{MODE:3}},u3=Dt({...c3,props:{position:{}},setup(t){const e=t,{userSelectionActive:n}=Lt(),i=He(()=>`${e.position}`.split("-"));return(r,o)=>(Se(),Ce("div",{class:Gt(["vue-flow__panel",i.value]),style:It({pointerEvents:me(n)?"none":"all"})},[Wn(r.$slots,"default")],6))}});var ki=(t=>(t.Lines="lines",t.Dots="dots",t))(ki||{});const m_=function({dimensions:t,size:e,color:n}){return _t("path",{stroke:n,"stroke-width":e,d:`M${t[0]/2} 0 V${t[1]} M0 ${t[1]/2} H${t[0]}`})},g_=function({radius:t,color:e}){return _t("circle",{cx:t,cy:t,r:t,fill:e})};ki.Lines+"",ki.Dots+"";const f3={[ki.Dots]:"#81818a",[ki.Lines]:"#eee"},d3=["id","x","y","width","height","patternTransform"],h3={key:2,height:"100",width:"100"},p3=["fill"],m3=["x","y","fill"],g3={name:"Background",compatConfig:{MODE:3}},v3=Dt({...g3,props:{id:{},variant:{default:()=>ki.Dots},gap:{default:20},size:{default:1},lineWidth:{default:1},patternColor:{},color:{},bgColor:{},height:{default:100},width:{default:100},x:{default:0},y:{default:0},offset:{default:0}},setup(t){const{id:e,viewport:n}=Lt(),i=He(()=>{const s=n.value.zoom,[a,l]=Array.isArray(t.gap)?t.gap:[t.gap,t.gap],c=[a*s||1,l*s||1],u=t.size*s,[f,d]=Array.isArray(t.offset)?t.offset:[t.offset,t.offset],h=[f*s||1+c[0]/2,d*s||1+c[1]/2];return{scaledGap:c,offset:h,size:u}}),r=wt(()=>`pattern-${e}${t.id?`-${t.id}`:""}`),o=wt(()=>t.color||t.patternColor||f3[t.variant||ki.Dots]);return(s,a)=>(Se(),Ce("svg",{class:"vue-flow__background vue-flow__container",style:It({height:`${s.height>100?100:s.height}%`,width:`${s.width>100?100:s.width}%`})},[Wn(s.$slots,"pattern-container",{id:r.value},()=>[ge("pattern",{id:r.value,x:me(n).x%i.value.scaledGap[0],y:me(n).y%i.value.scaledGap[1],width:i.value.scaledGap[0],height:i.value.scaledGap[1],patternTransform:`translate(-${i.value.offset[0]},-${i.value.offset[1]})`,patternUnits:"userSpaceOnUse"},[Wn(s.$slots,"pattern",{},()=>[s.variant===me(ki).Lines?(Se(),_n(me(m_),{key:0,size:s.lineWidth,color:o.value,dimensions:i.value.scaledGap},null,8,["size","color","dimensions"])):s.variant===me(ki).Dots?(Se(),_n(me(g_),{key:1,color:o.value,radius:i.value.size/2},null,8,["color","radius"])):lt("",!0),s.bgColor?(Se(),Ce("svg",h3,[ge("rect",{width:"100%",height:"100%",fill:s.bgColor},null,8,p3)])):lt("",!0)])],8,d3)]),ge("rect",{x:s.x,y:s.y,width:"100%",height:"100%",fill:`url(#${r.value})`},null,8,m3),Wn(s.$slots,"default",{id:r.value})],4))}});var _3={value:()=>{}};function fh(){for(var t=0,e=arguments.length,n={},i;t<e;++t){if(!(i=arguments[t]+"")||i in n||/[\s.]/.test(i))throw new Error("illegal type: "+i);n[i]=[]}return new bl(n)}function bl(t){this._=t}function x3(t,e){return t.trim().split(/^|\s+/).map(function(n){var i="",r=n.indexOf(".");if(r>=0&&(i=n.slice(r+1),n=n.slice(0,r)),n&&!e.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:i}})}bl.prototype=fh.prototype={constructor:bl,on:function(t,e){var n=this._,i=x3(t+"",n),r,o=-1,s=i.length;if(arguments.length<2){for(;++o<s;)if((r=(t=i[o]).type)&&(r=y3(n[r],t.name)))return r;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++o<s;)if(r=(t=i[o]).type)n[r]=Wm(n[r],t.name,e);else if(e==null)for(r in n)n[r]=Wm(n[r],t.name,null);return this},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new bl(t)},call:function(t,e){if((r=arguments.length-2)>0)for(var n=new Array(r),i=0,r,o;i<r;++i)n[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(o=this._[t],i=0,r=o.length;i<r;++i)o[i].value.apply(e,n)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],r=0,o=i.length;r<o;++r)i[r].value.apply(e,n)}};function y3(t,e){for(var n=0,i=t.length,r;n<i;++n)if((r=t[n]).name===e)return r.value}function Wm(t,e,n){for(var i=0,r=t.length;i<r;++i)if(t[i].name===e){t[i]=_3,t=t.slice(0,i).concat(t.slice(i+1));break}return n!=null&&t.push({name:e,value:n}),t}var fd="http://www.w3.org/1999/xhtml";const Xm={svg:"http://www.w3.org/2000/svg",xhtml:fd,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function Lc(t){var e=t+="",n=e.indexOf(":");return n>=0&&(e=t.slice(0,n))!=="xmlns"&&(t=t.slice(n+1)),Xm.hasOwnProperty(e)?{space:Xm[e],local:t}:t}function b3(t){return function(){var e=this.ownerDocument,n=this.namespaceURI;return n===fd&&e.documentElement.namespaceURI===fd?e.createElement(t):e.createElementNS(n,t)}}function S3(t){return function(){return this.ownerDocument.createElementNS(t.space,t.local)}}function v_(t){var e=Lc(t);return(e.local?S3:b3)(e)}function M3(){}function dh(t){return t==null?M3:function(){return this.querySelector(t)}}function E3(t){typeof t!="function"&&(t=dh(t));for(var e=this._groups,n=e.length,i=new Array(n),r=0;r<n;++r)for(var o=e[r],s=o.length,a=i[r]=new Array(s),l,c,u=0;u<s;++u)(l=o[u])&&(c=t.call(l,l.__data__,u,o))&&("__data__"in l&&(c.__data__=l.__data__),a[u]=c);return new Cn(i,this._parents)}function w3(t){return t==null?[]:Array.isArray(t)?t:Array.from(t)}function T3(){return[]}function __(t){return t==null?T3:function(){return this.querySelectorAll(t)}}function A3(t){return function(){return w3(t.apply(this,arguments))}}function C3(t){typeof t=="function"?t=A3(t):t=__(t);for(var e=this._groups,n=e.length,i=[],r=[],o=0;o<n;++o)for(var s=e[o],a=s.length,l,c=0;c<a;++c)(l=s[c])&&(i.push(t.call(l,l.__data__,c,s)),r.push(l));return new Cn(i,r)}function x_(t){return function(){return this.matches(t)}}function y_(t){return function(e){return e.matches(t)}}var R3=Array.prototype.find;function P3(t){return function(){return R3.call(this.children,t)}}function I3(){return this.firstElementChild}function N3(t){return this.select(t==null?I3:P3(typeof t=="function"?t:y_(t)))}var D3=Array.prototype.filter;function L3(){return Array.from(this.children)}function U3(t){return function(){return D3.call(this.children,t)}}function F3(t){return this.selectAll(t==null?L3:U3(typeof t=="function"?t:y_(t)))}function O3(t){typeof t!="function"&&(t=x_(t));for(var e=this._groups,n=e.length,i=new Array(n),r=0;r<n;++r)for(var o=e[r],s=o.length,a=i[r]=[],l,c=0;c<s;++c)(l=o[c])&&t.call(l,l.__data__,c,o)&&a.push(l);return new Cn(i,this._parents)}function b_(t){return new Array(t.length)}function B3(){return new Cn(this._enter||this._groups.map(b_),this._parents)}function jl(t,e){this.ownerDocument=t.ownerDocument,this.namespaceURI=t.namespaceURI,this._next=null,this._parent=t,this.__data__=e}jl.prototype={constructor:jl,appendChild:function(t){return this._parent.insertBefore(t,this._next)},insertBefore:function(t,e){return this._parent.insertBefore(t,e)},querySelector:function(t){return this._parent.querySelector(t)},querySelectorAll:function(t){return this._parent.querySelectorAll(t)}};function k3(t){return function(){return t}}function z3(t,e,n,i,r,o){for(var s=0,a,l=e.length,c=o.length;s<c;++s)(a=e[s])?(a.__data__=o[s],i[s]=a):n[s]=new jl(t,o[s]);for(;s<l;++s)(a=e[s])&&(r[s]=a)}function V3(t,e,n,i,r,o,s){var a,l,c=new Map,u=e.length,f=o.length,d=new Array(u),h;for(a=0;a<u;++a)(l=e[a])&&(d[a]=h=s.call(l,l.__data__,a,e)+"",c.has(h)?r[a]=l:c.set(h,l));for(a=0;a<f;++a)h=s.call(t,o[a],a,o)+"",(l=c.get(h))?(i[a]=l,l.__data__=o[a],c.delete(h)):n[a]=new jl(t,o[a]);for(a=0;a<u;++a)(l=e[a])&&c.get(d[a])===l&&(r[a]=l)}function H3(t){return t.__data__}function G3(t,e){if(!arguments.length)return Array.from(this,H3);var n=e?V3:z3,i=this._parents,r=this._groups;typeof t!="function"&&(t=k3(t));for(var o=r.length,s=new Array(o),a=new Array(o),l=new Array(o),c=0;c<o;++c){var u=i[c],f=r[c],d=f.length,h=$3(t.call(u,u&&u.__data__,c,i)),g=h.length,_=a[c]=new Array(g),m=s[c]=new Array(g),p=l[c]=new Array(d);n(u,f,_,m,p,h,e);for(var b=0,v=0,x,D;b<g;++b)if(x=_[b]){for(b>=v&&(v=b+1);!(D=m[v])&&++v<g;);x._next=D||null}}return s=new Cn(s,i),s._enter=a,s._exit=l,s}function $3(t){return typeof t=="object"&&"length"in t?t:Array.from(t)}function W3(){return new Cn(this._exit||this._groups.map(b_),this._parents)}function X3(t,e,n){var i=this.enter(),r=this,o=this.exit();return typeof t=="function"?(i=t(i),i&&(i=i.selection())):i=i.append(t+""),e!=null&&(r=e(r),r&&(r=r.selection())),n==null?o.remove():n(o),i&&r?i.merge(r).order():r}function Y3(t){for(var e=t.selection?t.selection():t,n=this._groups,i=e._groups,r=n.length,o=i.length,s=Math.min(r,o),a=new Array(r),l=0;l<s;++l)for(var c=n[l],u=i[l],f=c.length,d=a[l]=new Array(f),h,g=0;g<f;++g)(h=c[g]||u[g])&&(d[g]=h);for(;l<r;++l)a[l]=n[l];return new Cn(a,this._parents)}function q3(){for(var t=this._groups,e=-1,n=t.length;++e<n;)for(var i=t[e],r=i.length-1,o=i[r],s;--r>=0;)(s=i[r])&&(o&&s.compareDocumentPosition(o)^4&&o.parentNode.insertBefore(s,o),o=s);return this}function K3(t){t||(t=Z3);function e(f,d){return f&&d?t(f.__data__,d.__data__):!f-!d}for(var n=this._groups,i=n.length,r=new Array(i),o=0;o<i;++o){for(var s=n[o],a=s.length,l=r[o]=new Array(a),c,u=0;u<a;++u)(c=s[u])&&(l[u]=c);l.sort(e)}return new Cn(r,this._parents).order()}function Z3(t,e){return t<e?-1:t>e?1:t>=e?0:NaN}function j3(){var t=arguments[0];return arguments[0]=this,t.apply(null,arguments),this}function J3(){return Array.from(this)}function Q3(){for(var t=this._groups,e=0,n=t.length;e<n;++e)for(var i=t[e],r=0,o=i.length;r<o;++r){var s=i[r];if(s)return s}return null}function eN(){let t=0;for(const e of this)++t;return t}function tN(){return!this.node()}function nN(t){for(var e=this._groups,n=0,i=e.length;n<i;++n)for(var r=e[n],o=0,s=r.length,a;o<s;++o)(a=r[o])&&t.call(a,a.__data__,o,r);return this}function iN(t){return function(){this.removeAttribute(t)}}function rN(t){return function(){this.removeAttributeNS(t.space,t.local)}}function oN(t,e){return function(){this.setAttribute(t,e)}}function sN(t,e){return function(){this.setAttributeNS(t.space,t.local,e)}}function aN(t,e){return function(){var n=e.apply(this,arguments);n==null?this.removeAttribute(t):this.setAttribute(t,n)}}function lN(t,e){return function(){var n=e.apply(this,arguments);n==null?this.removeAttributeNS(t.space,t.local):this.setAttributeNS(t.space,t.local,n)}}function cN(t,e){var n=Lc(t);if(arguments.length<2){var i=this.node();return n.local?i.getAttributeNS(n.space,n.local):i.getAttribute(n)}return this.each((e==null?n.local?rN:iN:typeof e=="function"?n.local?lN:aN:n.local?sN:oN)(n,e))}function S_(t){return t.ownerDocument&&t.ownerDocument.defaultView||t.document&&t||t.defaultView}function uN(t){return function(){this.style.removeProperty(t)}}function fN(t,e,n){return function(){this.style.setProperty(t,e,n)}}function dN(t,e,n){return function(){var i=e.apply(this,arguments);i==null?this.style.removeProperty(t):this.style.setProperty(t,i,n)}}function hN(t,e,n){return arguments.length>1?this.each((e==null?uN:typeof e=="function"?dN:fN)(t,e,n??"")):es(this.node(),t)}function es(t,e){return t.style.getPropertyValue(e)||S_(t).getComputedStyle(t,null).getPropertyValue(e)}function pN(t){return function(){delete this[t]}}function mN(t,e){return function(){this[t]=e}}function gN(t,e){return function(){var n=e.apply(this,arguments);n==null?delete this[t]:this[t]=n}}function vN(t,e){return arguments.length>1?this.each((e==null?pN:typeof e=="function"?gN:mN)(t,e)):this.node()[t]}function M_(t){return t.trim().split(/^|\s+/)}function hh(t){return t.classList||new E_(t)}function E_(t){this._node=t,this._names=M_(t.getAttribute("class")||"")}E_.prototype={add:function(t){var e=this._names.indexOf(t);e<0&&(this._names.push(t),this._node.setAttribute("class",this._names.join(" ")))},remove:function(t){var e=this._names.indexOf(t);e>=0&&(this._names.splice(e,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(t){return this._names.indexOf(t)>=0}};function w_(t,e){for(var n=hh(t),i=-1,r=e.length;++i<r;)n.add(e[i])}function T_(t,e){for(var n=hh(t),i=-1,r=e.length;++i<r;)n.remove(e[i])}function _N(t){return function(){w_(this,t)}}function xN(t){return function(){T_(this,t)}}function yN(t,e){return function(){(e.apply(this,arguments)?w_:T_)(this,t)}}function bN(t,e){var n=M_(t+"");if(arguments.length<2){for(var i=hh(this.node()),r=-1,o=n.length;++r<o;)if(!i.contains(n[r]))return!1;return!0}return this.each((typeof e=="function"?yN:e?_N:xN)(n,e))}function SN(){this.textContent=""}function MN(t){return function(){this.textContent=t}}function EN(t){return function(){var e=t.apply(this,arguments);this.textContent=e??""}}function wN(t){return arguments.length?this.each(t==null?SN:(typeof t=="function"?EN:MN)(t)):this.node().textContent}function TN(){this.innerHTML=""}function AN(t){return function(){this.innerHTML=t}}function CN(t){return function(){var e=t.apply(this,arguments);this.innerHTML=e??""}}function RN(t){return arguments.length?this.each(t==null?TN:(typeof t=="function"?CN:AN)(t)):this.node().innerHTML}function PN(){this.nextSibling&&this.parentNode.appendChild(this)}function IN(){return this.each(PN)}function NN(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function DN(){return this.each(NN)}function LN(t){var e=typeof t=="function"?t:v_(t);return this.select(function(){return this.appendChild(e.apply(this,arguments))})}function UN(){return null}function FN(t,e){var n=typeof t=="function"?t:v_(t),i=e==null?UN:typeof e=="function"?e:dh(e);return this.select(function(){return this.insertBefore(n.apply(this,arguments),i.apply(this,arguments)||null)})}function ON(){var t=this.parentNode;t&&t.removeChild(this)}function BN(){return this.each(ON)}function kN(){var t=this.cloneNode(!1),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function zN(){var t=this.cloneNode(!0),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function VN(t){return this.select(t?zN:kN)}function HN(t){return arguments.length?this.property("__data__",t):this.node().__data__}function GN(t){return function(e){t.call(this,e,this.__data__)}}function $N(t){return t.trim().split(/^|\s+/).map(function(e){var n="",i=e.indexOf(".");return i>=0&&(n=e.slice(i+1),e=e.slice(0,i)),{type:e,name:n}})}function WN(t){return function(){var e=this.__on;if(e){for(var n=0,i=-1,r=e.length,o;n<r;++n)o=e[n],(!t.type||o.type===t.type)&&o.name===t.name?this.removeEventListener(o.type,o.listener,o.options):e[++i]=o;++i?e.length=i:delete this.__on}}}function XN(t,e,n){return function(){var i=this.__on,r,o=GN(e);if(i){for(var s=0,a=i.length;s<a;++s)if((r=i[s]).type===t.type&&r.name===t.name){this.removeEventListener(r.type,r.listener,r.options),this.addEventListener(r.type,r.listener=o,r.options=n),r.value=e;return}}this.addEventListener(t.type,o,n),r={type:t.type,name:t.name,value:e,listener:o,options:n},i?i.push(r):this.__on=[r]}}function YN(t,e,n){var i=$N(t+""),r,o=i.length,s;if(arguments.length<2){var a=this.node().__on;if(a){for(var l=0,c=a.length,u;l<c;++l)for(r=0,u=a[l];r<o;++r)if((s=i[r]).type===u.type&&s.name===u.name)return u.value}return}for(a=e?XN:WN,r=0;r<o;++r)this.each(a(i[r],e,n));return this}function A_(t,e,n){var i=S_(t),r=i.CustomEvent;typeof r=="function"?r=new r(e,n):(r=i.document.createEvent("Event"),n?(r.initEvent(e,n.bubbles,n.cancelable),r.detail=n.detail):r.initEvent(e,!1,!1)),t.dispatchEvent(r)}function qN(t,e){return function(){return A_(this,t,e)}}function KN(t,e){return function(){return A_(this,t,e.apply(this,arguments))}}function ZN(t,e){return this.each((typeof e=="function"?KN:qN)(t,e))}function*jN(){for(var t=this._groups,e=0,n=t.length;e<n;++e)for(var i=t[e],r=0,o=i.length,s;r<o;++r)(s=i[r])&&(yield s)}var C_=[null];function Cn(t,e){this._groups=t,this._parents=e}function _a(){return new Cn([[document.documentElement]],C_)}function JN(){return this}Cn.prototype=_a.prototype={constructor:Cn,select:E3,selectAll:C3,selectChild:N3,selectChildren:F3,filter:O3,data:G3,enter:B3,exit:W3,join:X3,merge:Y3,selection:JN,order:q3,sort:K3,call:j3,nodes:J3,node:Q3,size:eN,empty:tN,each:nN,attr:cN,style:hN,property:vN,classed:bN,text:wN,html:RN,raise:IN,lower:DN,append:LN,insert:FN,remove:BN,clone:VN,datum:HN,on:YN,dispatch:ZN,[Symbol.iterator]:jN};function br(t){return typeof t=="string"?new Cn([[document.querySelector(t)]],[document.documentElement]):new Cn([[t]],C_)}function QN(t){let e;for(;e=t.sourceEvent;)t=e;return t}function mr(t,e){if(t=QN(t),e===void 0&&(e=t.currentTarget),e){var n=e.ownerSVGElement||e;if(n.createSVGPoint){var i=n.createSVGPoint();return i.x=t.clientX,i.y=t.clientY,i=i.matrixTransform(e.getScreenCTM().inverse()),[i.x,i.y]}if(e.getBoundingClientRect){var r=e.getBoundingClientRect();return[t.clientX-r.left-e.clientLeft,t.clientY-r.top-e.clientTop]}}return[t.pageX,t.pageY]}const dd={capture:!0,passive:!1};function hd(t){t.preventDefault(),t.stopImmediatePropagation()}function eD(t){var e=t.document.documentElement,n=br(t).on("dragstart.drag",hd,dd);"onselectstart"in e?n.on("selectstart.drag",hd,dd):(e.__noselect=e.style.MozUserSelect,e.style.MozUserSelect="none")}function tD(t,e){var n=t.document.documentElement,i=br(t).on("dragstart.drag",null);e&&(i.on("click.drag",hd,dd),setTimeout(function(){i.on("click.drag",null)},0)),"onselectstart"in n?i.on("selectstart.drag",null):(n.style.MozUserSelect=n.__noselect,delete n.__noselect)}function ph(t,e,n){t.prototype=e.prototype=n,n.constructor=t}function R_(t,e){var n=Object.create(t.prototype);for(var i in e)n[i]=e[i];return n}function xa(){}var ia=.7,Jl=1/ia,Ho="\\s*([+-]?\\d+)\\s*",ra="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",mi="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",nD=/^#([0-9a-f]{3,8})$/,iD=new RegExp(`^rgb\\(${Ho},${Ho},${Ho}\\)$`),rD=new RegExp(`^rgb\\(${mi},${mi},${mi}\\)$`),oD=new RegExp(`^rgba\\(${Ho},${Ho},${Ho},${ra}\\)$`),sD=new RegExp(`^rgba\\(${mi},${mi},${mi},${ra}\\)$`),aD=new RegExp(`^hsl\\(${ra},${mi},${mi}\\)$`),lD=new RegExp(`^hsla\\(${ra},${mi},${mi},${ra}\\)$`),Ym={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};ph(xa,oa,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:qm,formatHex:qm,formatHex8:cD,formatHsl:uD,formatRgb:Km,toString:Km});function qm(){return this.rgb().formatHex()}function cD(){return this.rgb().formatHex8()}function uD(){return P_(this).formatHsl()}function Km(){return this.rgb().formatRgb()}function oa(t){var e,n;return t=(t+"").trim().toLowerCase(),(e=nD.exec(t))?(n=e[1].length,e=parseInt(e[1],16),n===6?Zm(e):n===3?new gn(e>>8&15|e>>4&240,e>>4&15|e&240,(e&15)<<4|e&15,1):n===8?il(e>>24&255,e>>16&255,e>>8&255,(e&255)/255):n===4?il(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|e&240,((e&15)<<4|e&15)/255):null):(e=iD.exec(t))?new gn(e[1],e[2],e[3],1):(e=rD.exec(t))?new gn(e[1]*255/100,e[2]*255/100,e[3]*255/100,1):(e=oD.exec(t))?il(e[1],e[2],e[3],e[4]):(e=sD.exec(t))?il(e[1]*255/100,e[2]*255/100,e[3]*255/100,e[4]):(e=aD.exec(t))?Qm(e[1],e[2]/100,e[3]/100,1):(e=lD.exec(t))?Qm(e[1],e[2]/100,e[3]/100,e[4]):Ym.hasOwnProperty(t)?Zm(Ym[t]):t==="transparent"?new gn(NaN,NaN,NaN,0):null}function Zm(t){return new gn(t>>16&255,t>>8&255,t&255,1)}function il(t,e,n,i){return i<=0&&(t=e=n=NaN),new gn(t,e,n,i)}function fD(t){return t instanceof xa||(t=oa(t)),t?(t=t.rgb(),new gn(t.r,t.g,t.b,t.opacity)):new gn}function pd(t,e,n,i){return arguments.length===1?fD(t):new gn(t,e,n,i??1)}function gn(t,e,n,i){this.r=+t,this.g=+e,this.b=+n,this.opacity=+i}ph(gn,pd,R_(xa,{brighter(t){return t=t==null?Jl:Math.pow(Jl,t),new gn(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=t==null?ia:Math.pow(ia,t),new gn(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new gn(ro(this.r),ro(this.g),ro(this.b),Ql(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:jm,formatHex:jm,formatHex8:dD,formatRgb:Jm,toString:Jm}));function jm(){return`#${jr(this.r)}${jr(this.g)}${jr(this.b)}`}function dD(){return`#${jr(this.r)}${jr(this.g)}${jr(this.b)}${jr((isNaN(this.opacity)?1:this.opacity)*255)}`}function Jm(){const t=Ql(this.opacity);return`${t===1?"rgb(":"rgba("}${ro(this.r)}, ${ro(this.g)}, ${ro(this.b)}${t===1?")":`, ${t})`}`}function Ql(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function ro(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function jr(t){return t=ro(t),(t<16?"0":"")+t.toString(16)}function Qm(t,e,n,i){return i<=0?t=e=n=NaN:n<=0||n>=1?t=e=NaN:e<=0&&(t=NaN),new Gn(t,e,n,i)}function P_(t){if(t instanceof Gn)return new Gn(t.h,t.s,t.l,t.opacity);if(t instanceof xa||(t=oa(t)),!t)return new Gn;if(t instanceof Gn)return t;t=t.rgb();var e=t.r/255,n=t.g/255,i=t.b/255,r=Math.min(e,n,i),o=Math.max(e,n,i),s=NaN,a=o-r,l=(o+r)/2;return a?(e===o?s=(n-i)/a+(n<i)*6:n===o?s=(i-e)/a+2:s=(e-n)/a+4,a/=l<.5?o+r:2-o-r,s*=60):a=l>0&&l<1?0:s,new Gn(s,a,l,t.opacity)}function hD(t,e,n,i){return arguments.length===1?P_(t):new Gn(t,e,n,i??1)}function Gn(t,e,n,i){this.h=+t,this.s=+e,this.l=+n,this.opacity=+i}ph(Gn,hD,R_(xa,{brighter(t){return t=t==null?Jl:Math.pow(Jl,t),new Gn(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?ia:Math.pow(ia,t),new Gn(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+(this.h<0)*360,e=isNaN(t)||isNaN(this.s)?0:this.s,n=this.l,i=n+(n<.5?n:1-n)*e,r=2*n-i;return new gn(Hu(t>=240?t-240:t+120,r,i),Hu(t,r,i),Hu(t<120?t+240:t-120,r,i),this.opacity)},clamp(){return new Gn(eg(this.h),rl(this.s),rl(this.l),Ql(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=Ql(this.opacity);return`${t===1?"hsl(":"hsla("}${eg(this.h)}, ${rl(this.s)*100}%, ${rl(this.l)*100}%${t===1?")":`, ${t})`}`}}));function eg(t){return t=(t||0)%360,t<0?t+360:t}function rl(t){return Math.max(0,Math.min(1,t||0))}function Hu(t,e,n){return(t<60?e+(n-e)*t/60:t<180?n:t<240?e+(n-e)*(240-t)/60:e)*255}const I_=t=>()=>t;function pD(t,e){return function(n){return t+n*e}}function mD(t,e,n){return t=Math.pow(t,n),e=Math.pow(e,n)-t,n=1/n,function(i){return Math.pow(t+i*e,n)}}function gD(t){return(t=+t)==1?N_:function(e,n){return n-e?mD(e,n,t):I_(isNaN(e)?n:e)}}function N_(t,e){var n=e-t;return n?pD(t,n):I_(isNaN(t)?e:t)}const tg=(function t(e){var n=gD(e);function i(r,o){var s=n((r=pd(r)).r,(o=pd(o)).r),a=n(r.g,o.g),l=n(r.b,o.b),c=N_(r.opacity,o.opacity);return function(u){return r.r=s(u),r.g=a(u),r.b=l(u),r.opacity=c(u),r+""}}return i.gamma=t,i})(1);function xr(t,e){return t=+t,e=+e,function(n){return t*(1-n)+e*n}}var md=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Gu=new RegExp(md.source,"g");function vD(t){return function(){return t}}function _D(t){return function(e){return t(e)+""}}function xD(t,e){var n=md.lastIndex=Gu.lastIndex=0,i,r,o,s=-1,a=[],l=[];for(t=t+"",e=e+"";(i=md.exec(t))&&(r=Gu.exec(e));)(o=r.index)>n&&(o=e.slice(n,o),a[s]?a[s]+=o:a[++s]=o),(i=i[0])===(r=r[0])?a[s]?a[s]+=r:a[++s]=r:(a[++s]=null,l.push({i:s,x:xr(i,r)})),n=Gu.lastIndex;return n<e.length&&(o=e.slice(n),a[s]?a[s]+=o:a[++s]=o),a.length<2?l[0]?_D(l[0].x):vD(e):(e=l.length,function(c){for(var u=0,f;u<e;++u)a[(f=l[u]).i]=f.x(c);return a.join("")})}var ng=180/Math.PI,gd={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function D_(t,e,n,i,r,o){var s,a,l;return(s=Math.sqrt(t*t+e*e))&&(t/=s,e/=s),(l=t*n+e*i)&&(n-=t*l,i-=e*l),(a=Math.sqrt(n*n+i*i))&&(n/=a,i/=a,l/=a),t*i<e*n&&(t=-t,e=-e,l=-l,s=-s),{translateX:r,translateY:o,rotate:Math.atan2(e,t)*ng,skewX:Math.atan(l)*ng,scaleX:s,scaleY:a}}var ol;function yD(t){const e=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(t+"");return e.isIdentity?gd:D_(e.a,e.b,e.c,e.d,e.e,e.f)}function bD(t){return t==null||(ol||(ol=document.createElementNS("http://www.w3.org/2000/svg","g")),ol.setAttribute("transform",t),!(t=ol.transform.baseVal.consolidate()))?gd:(t=t.matrix,D_(t.a,t.b,t.c,t.d,t.e,t.f))}function L_(t,e,n,i){function r(c){return c.length?c.pop()+" ":""}function o(c,u,f,d,h,g){if(c!==f||u!==d){var _=h.push("translate(",null,e,null,n);g.push({i:_-4,x:xr(c,f)},{i:_-2,x:xr(u,d)})}else(f||d)&&h.push("translate("+f+e+d+n)}function s(c,u,f,d){c!==u?(c-u>180?u+=360:u-c>180&&(c+=360),d.push({i:f.push(r(f)+"rotate(",null,i)-2,x:xr(c,u)})):u&&f.push(r(f)+"rotate("+u+i)}function a(c,u,f,d){c!==u?d.push({i:f.push(r(f)+"skewX(",null,i)-2,x:xr(c,u)}):u&&f.push(r(f)+"skewX("+u+i)}function l(c,u,f,d,h,g){if(c!==f||u!==d){var _=h.push(r(h)+"scale(",null,",",null,")");g.push({i:_-4,x:xr(c,f)},{i:_-2,x:xr(u,d)})}else(f!==1||d!==1)&&h.push(r(h)+"scale("+f+","+d+")")}return function(c,u){var f=[],d=[];return c=t(c),u=t(u),o(c.translateX,c.translateY,u.translateX,u.translateY,f,d),s(c.rotate,u.rotate,f,d),a(c.skewX,u.skewX,f,d),l(c.scaleX,c.scaleY,u.scaleX,u.scaleY,f,d),c=u=null,function(h){for(var g=-1,_=d.length,m;++g<_;)f[(m=d[g]).i]=m.x(h);return f.join("")}}}var SD=L_(yD,"px, ","px)","deg)"),MD=L_(bD,", ",")",")"),ED=1e-12;function ig(t){return((t=Math.exp(t))+1/t)/2}function wD(t){return((t=Math.exp(t))-1/t)/2}function TD(t){return((t=Math.exp(2*t))-1)/(t+1)}const AD=(function t(e,n,i){function r(o,s){var a=o[0],l=o[1],c=o[2],u=s[0],f=s[1],d=s[2],h=u-a,g=f-l,_=h*h+g*g,m,p;if(_<ED)p=Math.log(d/c)/e,m=function(U){return[a+U*h,l+U*g,c*Math.exp(e*U*p)]};else{var b=Math.sqrt(_),v=(d*d-c*c+i*_)/(2*c*n*b),x=(d*d-c*c-i*_)/(2*d*n*b),D=Math.log(Math.sqrt(v*v+1)-v),O=Math.log(Math.sqrt(x*x+1)-x);p=(O-D)/e,m=function(U){var y=U*p,w=ig(D),H=c/(n*b)*(w*TD(e*y+D)-wD(D));return[a+H*h,l+H*g,c*w/ig(e*y+D)]}}return m.duration=p*1e3*e/Math.SQRT2,m}return r.rho=function(o){var s=Math.max(.001,+o),a=s*s,l=a*a;return t(s,a,l)},r})(Math.SQRT2,2,4);var ts=0,Ts=0,vs=0,U_=1e3,ec,As,tc=0,co=0,Uc=0,sa=typeof performance=="object"&&performance.now?performance:Date,F_=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function mh(){return co||(F_(CD),co=sa.now()+Uc)}function CD(){co=0}function nc(){this._call=this._time=this._next=null}nc.prototype=O_.prototype={constructor:nc,restart:function(t,e,n){if(typeof t!="function")throw new TypeError("callback is not a function");n=(n==null?mh():+n)+(e==null?0:+e),!this._next&&As!==this&&(As?As._next=this:ec=this,As=this),this._call=t,this._time=n,vd()},stop:function(){this._call&&(this._call=null,this._time=1/0,vd())}};function O_(t,e,n){var i=new nc;return i.restart(t,e,n),i}function RD(){mh(),++ts;for(var t=ec,e;t;)(e=co-t._time)>=0&&t._call.call(void 0,e),t=t._next;--ts}function rg(){co=(tc=sa.now())+Uc,ts=Ts=0;try{RD()}finally{ts=0,ID(),co=0}}function PD(){var t=sa.now(),e=t-tc;e>U_&&(Uc-=e,tc=t)}function ID(){for(var t,e=ec,n,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(n=e._next,e._next=null,e=t?t._next=n:ec=n);As=t,vd(i)}function vd(t){if(!ts){Ts&&(Ts=clearTimeout(Ts));var e=t-co;e>24?(t<1/0&&(Ts=setTimeout(rg,t-sa.now()-Uc)),vs&&(vs=clearInterval(vs))):(vs||(tc=sa.now(),vs=setInterval(PD,U_)),ts=1,F_(rg))}}function og(t,e,n){var i=new nc;return e=e==null?0:+e,i.restart(r=>{i.stop(),t(r+e)},e,n),i}var ND=fh("start","end","cancel","interrupt"),DD=[],B_=0,sg=1,_d=2,Sl=3,ag=4,xd=5,Ml=6;function Fc(t,e,n,i,r,o){var s=t.__transition;if(!s)t.__transition={};else if(n in s)return;LD(t,n,{name:e,index:i,group:r,on:ND,tween:DD,time:o.time,delay:o.delay,duration:o.duration,ease:o.ease,timer:null,state:B_})}function gh(t,e){var n=jn(t,e);if(n.state>B_)throw new Error("too late; already scheduled");return n}function yi(t,e){var n=jn(t,e);if(n.state>Sl)throw new Error("too late; already running");return n}function jn(t,e){var n=t.__transition;if(!n||!(n=n[e]))throw new Error("transition not found");return n}function LD(t,e,n){var i=t.__transition,r;i[e]=n,n.timer=O_(o,0,n.time);function o(c){n.state=sg,n.timer.restart(s,n.delay,n.time),n.delay<=c&&s(c-n.delay)}function s(c){var u,f,d,h;if(n.state!==sg)return l();for(u in i)if(h=i[u],h.name===n.name){if(h.state===Sl)return og(s);h.state===ag?(h.state=Ml,h.timer.stop(),h.on.call("interrupt",t,t.__data__,h.index,h.group),delete i[u]):+u<e&&(h.state=Ml,h.timer.stop(),h.on.call("cancel",t,t.__data__,h.index,h.group),delete i[u])}if(og(function(){n.state===Sl&&(n.state=ag,n.timer.restart(a,n.delay,n.time),a(c))}),n.state=_d,n.on.call("start",t,t.__data__,n.index,n.group),n.state===_d){for(n.state=Sl,r=new Array(d=n.tween.length),u=0,f=-1;u<d;++u)(h=n.tween[u].value.call(t,t.__data__,n.index,n.group))&&(r[++f]=h);r.length=f+1}}function a(c){for(var u=c<n.duration?n.ease.call(null,c/n.duration):(n.timer.restart(l),n.state=xd,1),f=-1,d=r.length;++f<d;)r[f].call(t,u);n.state===xd&&(n.on.call("end",t,t.__data__,n.index,n.group),l())}function l(){n.state=Ml,n.timer.stop(),delete i[e];for(var c in i)return;delete t.__transition}}function El(t,e){var n=t.__transition,i,r,o=!0,s;if(n){e=e==null?null:e+"";for(s in n){if((i=n[s]).name!==e){o=!1;continue}r=i.state>_d&&i.state<xd,i.state=Ml,i.timer.stop(),i.on.call(r?"interrupt":"cancel",t,t.__data__,i.index,i.group),delete n[s]}o&&delete t.__transition}}function UD(t){return this.each(function(){El(this,t)})}function FD(t,e){var n,i;return function(){var r=yi(this,t),o=r.tween;if(o!==n){i=n=o;for(var s=0,a=i.length;s<a;++s)if(i[s].name===e){i=i.slice(),i.splice(s,1);break}}r.tween=i}}function OD(t,e,n){var i,r;if(typeof n!="function")throw new Error;return function(){var o=yi(this,t),s=o.tween;if(s!==i){r=(i=s).slice();for(var a={name:e,value:n},l=0,c=r.length;l<c;++l)if(r[l].name===e){r[l]=a;break}l===c&&r.push(a)}o.tween=r}}function BD(t,e){var n=this._id;if(t+="",arguments.length<2){for(var i=jn(this.node(),n).tween,r=0,o=i.length,s;r<o;++r)if((s=i[r]).name===t)return s.value;return null}return this.each((e==null?FD:OD)(n,t,e))}function vh(t,e,n){var i=t._id;return t.each(function(){var r=yi(this,i);(r.value||(r.value={}))[e]=n.apply(this,arguments)}),function(r){return jn(r,i).value[e]}}function k_(t,e){var n;return(typeof e=="number"?xr:e instanceof oa?tg:(n=oa(e))?(e=n,tg):xD)(t,e)}function kD(t){return function(){this.removeAttribute(t)}}function zD(t){return function(){this.removeAttributeNS(t.space,t.local)}}function VD(t,e,n){var i,r=n+"",o;return function(){var s=this.getAttribute(t);return s===r?null:s===i?o:o=e(i=s,n)}}function HD(t,e,n){var i,r=n+"",o;return function(){var s=this.getAttributeNS(t.space,t.local);return s===r?null:s===i?o:o=e(i=s,n)}}function GD(t,e,n){var i,r,o;return function(){var s,a=n(this),l;return a==null?void this.removeAttribute(t):(s=this.getAttribute(t),l=a+"",s===l?null:s===i&&l===r?o:(r=l,o=e(i=s,a)))}}function $D(t,e,n){var i,r,o;return function(){var s,a=n(this),l;return a==null?void this.removeAttributeNS(t.space,t.local):(s=this.getAttributeNS(t.space,t.local),l=a+"",s===l?null:s===i&&l===r?o:(r=l,o=e(i=s,a)))}}function WD(t,e){var n=Lc(t),i=n==="transform"?MD:k_;return this.attrTween(t,typeof e=="function"?(n.local?$D:GD)(n,i,vh(this,"attr."+t,e)):e==null?(n.local?zD:kD)(n):(n.local?HD:VD)(n,i,e))}function XD(t,e){return function(n){this.setAttribute(t,e.call(this,n))}}function YD(t,e){return function(n){this.setAttributeNS(t.space,t.local,e.call(this,n))}}function qD(t,e){var n,i;function r(){var o=e.apply(this,arguments);return o!==i&&(n=(i=o)&&YD(t,o)),n}return r._value=e,r}function KD(t,e){var n,i;function r(){var o=e.apply(this,arguments);return o!==i&&(n=(i=o)&&XD(t,o)),n}return r._value=e,r}function ZD(t,e){var n="attr."+t;if(arguments.length<2)return(n=this.tween(n))&&n._value;if(e==null)return this.tween(n,null);if(typeof e!="function")throw new Error;var i=Lc(t);return this.tween(n,(i.local?qD:KD)(i,e))}function jD(t,e){return function(){gh(this,t).delay=+e.apply(this,arguments)}}function JD(t,e){return e=+e,function(){gh(this,t).delay=e}}function QD(t){var e=this._id;return arguments.length?this.each((typeof t=="function"?jD:JD)(e,t)):jn(this.node(),e).delay}function eL(t,e){return function(){yi(this,t).duration=+e.apply(this,arguments)}}function tL(t,e){return e=+e,function(){yi(this,t).duration=e}}function nL(t){var e=this._id;return arguments.length?this.each((typeof t=="function"?eL:tL)(e,t)):jn(this.node(),e).duration}function iL(t,e){if(typeof e!="function")throw new Error;return function(){yi(this,t).ease=e}}function rL(t){var e=this._id;return arguments.length?this.each(iL(e,t)):jn(this.node(),e).ease}function oL(t,e){return function(){var n=e.apply(this,arguments);if(typeof n!="function")throw new Error;yi(this,t).ease=n}}function sL(t){if(typeof t!="function")throw new Error;return this.each(oL(this._id,t))}function aL(t){typeof t!="function"&&(t=x_(t));for(var e=this._groups,n=e.length,i=new Array(n),r=0;r<n;++r)for(var o=e[r],s=o.length,a=i[r]=[],l,c=0;c<s;++c)(l=o[c])&&t.call(l,l.__data__,c,o)&&a.push(l);return new er(i,this._parents,this._name,this._id)}function lL(t){if(t._id!==this._id)throw new Error;for(var e=this._groups,n=t._groups,i=e.length,r=n.length,o=Math.min(i,r),s=new Array(i),a=0;a<o;++a)for(var l=e[a],c=n[a],u=l.length,f=s[a]=new Array(u),d,h=0;h<u;++h)(d=l[h]||c[h])&&(f[h]=d);for(;a<i;++a)s[a]=e[a];return new er(s,this._parents,this._name,this._id)}function cL(t){return(t+"").trim().split(/^|\s+/).every(function(e){var n=e.indexOf(".");return n>=0&&(e=e.slice(0,n)),!e||e==="start"})}function uL(t,e,n){var i,r,o=cL(e)?gh:yi;return function(){var s=o(this,t),a=s.on;a!==i&&(r=(i=a).copy()).on(e,n),s.on=r}}function fL(t,e){var n=this._id;return arguments.length<2?jn(this.node(),n).on.on(t):this.each(uL(n,t,e))}function dL(t){return function(){var e=this.parentNode;for(var n in this.__transition)if(+n!==t)return;e&&e.removeChild(this)}}function hL(){return this.on("end.remove",dL(this._id))}function pL(t){var e=this._name,n=this._id;typeof t!="function"&&(t=dh(t));for(var i=this._groups,r=i.length,o=new Array(r),s=0;s<r;++s)for(var a=i[s],l=a.length,c=o[s]=new Array(l),u,f,d=0;d<l;++d)(u=a[d])&&(f=t.call(u,u.__data__,d,a))&&("__data__"in u&&(f.__data__=u.__data__),c[d]=f,Fc(c[d],e,n,d,c,jn(u,n)));return new er(o,this._parents,e,n)}function mL(t){var e=this._name,n=this._id;typeof t!="function"&&(t=__(t));for(var i=this._groups,r=i.length,o=[],s=[],a=0;a<r;++a)for(var l=i[a],c=l.length,u,f=0;f<c;++f)if(u=l[f]){for(var d=t.call(u,u.__data__,f,l),h,g=jn(u,n),_=0,m=d.length;_<m;++_)(h=d[_])&&Fc(h,e,n,_,d,g);o.push(d),s.push(u)}return new er(o,s,e,n)}var gL=_a.prototype.constructor;function vL(){return new gL(this._groups,this._parents)}function _L(t,e){var n,i,r;return function(){var o=es(this,t),s=(this.style.removeProperty(t),es(this,t));return o===s?null:o===n&&s===i?r:r=e(n=o,i=s)}}function z_(t){return function(){this.style.removeProperty(t)}}function xL(t,e,n){var i,r=n+"",o;return function(){var s=es(this,t);return s===r?null:s===i?o:o=e(i=s,n)}}function yL(t,e,n){var i,r,o;return function(){var s=es(this,t),a=n(this),l=a+"";return a==null&&(l=a=(this.style.removeProperty(t),es(this,t))),s===l?null:s===i&&l===r?o:(r=l,o=e(i=s,a))}}function bL(t,e){var n,i,r,o="style."+e,s="end."+o,a;return function(){var l=yi(this,t),c=l.on,u=l.value[o]==null?a||(a=z_(e)):void 0;(c!==n||r!==u)&&(i=(n=c).copy()).on(s,r=u),l.on=i}}function SL(t,e,n){var i=(t+="")=="transform"?SD:k_;return e==null?this.styleTween(t,_L(t,i)).on("end.style."+t,z_(t)):typeof e=="function"?this.styleTween(t,yL(t,i,vh(this,"style."+t,e))).each(bL(this._id,t)):this.styleTween(t,xL(t,i,e),n).on("end.style."+t,null)}function ML(t,e,n){return function(i){this.style.setProperty(t,e.call(this,i),n)}}function EL(t,e,n){var i,r;function o(){var s=e.apply(this,arguments);return s!==r&&(i=(r=s)&&ML(t,s,n)),i}return o._value=e,o}function wL(t,e,n){var i="style."+(t+="");if(arguments.length<2)return(i=this.tween(i))&&i._value;if(e==null)return this.tween(i,null);if(typeof e!="function")throw new Error;return this.tween(i,EL(t,e,n??""))}function TL(t){return function(){this.textContent=t}}function AL(t){return function(){var e=t(this);this.textContent=e??""}}function CL(t){return this.tween("text",typeof t=="function"?AL(vh(this,"text",t)):TL(t==null?"":t+""))}function RL(t){return function(e){this.textContent=t.call(this,e)}}function PL(t){var e,n;function i(){var r=t.apply(this,arguments);return r!==n&&(e=(n=r)&&RL(r)),e}return i._value=t,i}function IL(t){var e="text";if(arguments.length<1)return(e=this.tween(e))&&e._value;if(t==null)return this.tween(e,null);if(typeof t!="function")throw new Error;return this.tween(e,PL(t))}function NL(){for(var t=this._name,e=this._id,n=V_(),i=this._groups,r=i.length,o=0;o<r;++o)for(var s=i[o],a=s.length,l,c=0;c<a;++c)if(l=s[c]){var u=jn(l,e);Fc(l,t,n,c,s,{time:u.time+u.delay+u.duration,delay:0,duration:u.duration,ease:u.ease})}return new er(i,this._parents,t,n)}function DL(){var t,e,n=this,i=n._id,r=n.size();return new Promise(function(o,s){var a={value:s},l={value:function(){--r===0&&o()}};n.each(function(){var c=yi(this,i),u=c.on;u!==t&&(e=(t=u).copy(),e._.cancel.push(a),e._.interrupt.push(a),e._.end.push(l)),c.on=e}),r===0&&o()})}var LL=0;function er(t,e,n,i){this._groups=t,this._parents=e,this._name=n,this._id=i}function V_(){return++LL}var Pi=_a.prototype;er.prototype={constructor:er,select:pL,selectAll:mL,selectChild:Pi.selectChild,selectChildren:Pi.selectChildren,filter:aL,merge:lL,selection:vL,transition:NL,call:Pi.call,nodes:Pi.nodes,node:Pi.node,size:Pi.size,empty:Pi.empty,each:Pi.each,on:fL,attr:WD,attrTween:ZD,style:SL,styleTween:wL,text:CL,textTween:IL,remove:hL,tween:BD,delay:QD,duration:nL,ease:rL,easeVarying:sL,end:DL,[Symbol.iterator]:Pi[Symbol.iterator]};function UL(t){return((t*=2)<=1?t*t*t:(t-=2)*t*t+2)/2}var FL={time:null,delay:0,duration:250,ease:UL};function OL(t,e){for(var n;!(n=t.__transition)||!(n=n[e]);)if(!(t=t.parentNode))throw new Error(`transition ${e} not found`);return n}function BL(t){var e,n;t instanceof er?(e=t._id,t=t._name):(e=V_(),(n=FL).time=mh(),t=t==null?null:t+"");for(var i=this._groups,r=i.length,o=0;o<r;++o)for(var s=i[o],a=s.length,l,c=0;c<a;++c)(l=s[c])&&Fc(l,t,e,c,s,n||OL(l,e));return new er(i,this._parents,t,e)}_a.prototype.interrupt=UD;_a.prototype.transition=BL;const sl=t=>()=>t;function kL(t,{sourceEvent:e,target:n,transform:i,dispatch:r}){Object.defineProperties(this,{type:{value:t,enumerable:!0,configurable:!0},sourceEvent:{value:e,enumerable:!0,configurable:!0},target:{value:n,enumerable:!0,configurable:!0},transform:{value:i,enumerable:!0,configurable:!0},_:{value:r}})}function zi(t,e,n){this.k=t,this.x=e,this.y=n}zi.prototype={constructor:zi,scale:function(t){return t===1?this:new zi(this.k*t,this.x,this.y)},translate:function(t,e){return t===0&e===0?this:new zi(this.k,this.x+this.k*t,this.y+this.k*e)},apply:function(t){return[t[0]*this.k+this.x,t[1]*this.k+this.y]},applyX:function(t){return t*this.k+this.x},applyY:function(t){return t*this.k+this.y},invert:function(t){return[(t[0]-this.x)/this.k,(t[1]-this.y)/this.k]},invertX:function(t){return(t-this.x)/this.k},invertY:function(t){return(t-this.y)/this.k},rescaleX:function(t){return t.copy().domain(t.range().map(this.invertX,this).map(t.invert,t))},rescaleY:function(t){return t.copy().domain(t.range().map(this.invertY,this).map(t.invert,t))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};var _h=new zi(1,0,0);zi.prototype;function $u(t){t.stopImmediatePropagation()}function _s(t){t.preventDefault(),t.stopImmediatePropagation()}function zL(t){return(!t.ctrlKey||t.type==="wheel")&&!t.button}function VL(){var t=this;return t instanceof SVGElement?(t=t.ownerSVGElement||t,t.hasAttribute("viewBox")?(t=t.viewBox.baseVal,[[t.x,t.y],[t.x+t.width,t.y+t.height]]):[[0,0],[t.width.baseVal.value,t.height.baseVal.value]]):[[0,0],[t.clientWidth,t.clientHeight]]}function lg(){return this.__zoom||_h}function HL(t){return-t.deltaY*(t.deltaMode===1?.05:t.deltaMode?1:.002)*(t.ctrlKey?10:1)}function GL(){return navigator.maxTouchPoints||"ontouchstart"in this}function $L(t,e,n){var i=t.invertX(e[0][0])-n[0][0],r=t.invertX(e[1][0])-n[1][0],o=t.invertY(e[0][1])-n[0][1],s=t.invertY(e[1][1])-n[1][1];return t.translate(r>i?(i+r)/2:Math.min(0,i)||Math.max(0,r),s>o?(o+s)/2:Math.min(0,o)||Math.max(0,s))}function WL(){var t=zL,e=VL,n=$L,i=HL,r=GL,o=[0,1/0],s=[[-1/0,-1/0],[1/0,1/0]],a=250,l=AD,c=fh("start","zoom","end"),u,f,d,h=500,g=150,_=0,m=10;function p(M){M.property("__zoom",lg).on("wheel.zoom",y,{passive:!1}).on("mousedown.zoom",w).on("dblclick.zoom",H).filter(r).on("touchstart.zoom",N).on("touchmove.zoom",I).on("touchend.zoom touchcancel.zoom",q).style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}p.transform=function(M,L,T,C){var V=M.selection?M.selection():M;V.property("__zoom",lg),M!==V?D(M,L,T,C):V.interrupt().each(function(){O(this,arguments).event(C).start().zoom(null,typeof L=="function"?L.apply(this,arguments):L).end()})},p.scaleBy=function(M,L,T,C){p.scaleTo(M,function(){var V=this.__zoom.k,X=typeof L=="function"?L.apply(this,arguments):L;return V*X},T,C)},p.scaleTo=function(M,L,T,C){p.transform(M,function(){var V=e.apply(this,arguments),X=this.__zoom,k=T==null?x(V):typeof T=="function"?T.apply(this,arguments):T,Y=X.invert(k),j=typeof L=="function"?L.apply(this,arguments):L;return n(v(b(X,j),k,Y),V,s)},T,C)},p.translateBy=function(M,L,T,C){p.transform(M,function(){return n(this.__zoom.translate(typeof L=="function"?L.apply(this,arguments):L,typeof T=="function"?T.apply(this,arguments):T),e.apply(this,arguments),s)},null,C)},p.translateTo=function(M,L,T,C,V){p.transform(M,function(){var X=e.apply(this,arguments),k=this.__zoom,Y=C==null?x(X):typeof C=="function"?C.apply(this,arguments):C;return n(_h.translate(Y[0],Y[1]).scale(k.k).translate(typeof L=="function"?-L.apply(this,arguments):-L,typeof T=="function"?-T.apply(this,arguments):-T),X,s)},C,V)};function b(M,L){return L=Math.max(o[0],Math.min(o[1],L)),L===M.k?M:new zi(L,M.x,M.y)}function v(M,L,T){var C=L[0]-T[0]*M.k,V=L[1]-T[1]*M.k;return C===M.x&&V===M.y?M:new zi(M.k,C,V)}function x(M){return[(+M[0][0]+ +M[1][0])/2,(+M[0][1]+ +M[1][1])/2]}function D(M,L,T,C){M.on("start.zoom",function(){O(this,arguments).event(C).start()}).on("interrupt.zoom end.zoom",function(){O(this,arguments).event(C).end()}).tween("zoom",function(){var V=this,X=arguments,k=O(V,X).event(C),Y=e.apply(V,X),j=T==null?x(Y):typeof T=="function"?T.apply(V,X):T,fe=Math.max(Y[1][0]-Y[0][0],Y[1][1]-Y[0][1]),_e=V.__zoom,he=typeof L=="function"?L.apply(V,X):L,K=l(_e.invert(j).concat(fe/_e.k),he.invert(j).concat(fe/he.k));return function(ne){if(ne===1)ne=he;else{var le=K(ne),Te=fe/le[2];ne=new zi(Te,j[0]-le[0]*Te,j[1]-le[1]*Te)}k.zoom(null,ne)}})}function O(M,L,T){return!T&&M.__zooming||new U(M,L)}function U(M,L){this.that=M,this.args=L,this.active=0,this.sourceEvent=null,this.extent=e.apply(M,L),this.taps=0}U.prototype={event:function(M){return M&&(this.sourceEvent=M),this},start:function(){return++this.active===1&&(this.that.__zooming=this,this.emit("start")),this},zoom:function(M,L){return this.mouse&&M!=="mouse"&&(this.mouse[1]=L.invert(this.mouse[0])),this.touch0&&M!=="touch"&&(this.touch0[1]=L.invert(this.touch0[0])),this.touch1&&M!=="touch"&&(this.touch1[1]=L.invert(this.touch1[0])),this.that.__zoom=L,this.emit("zoom"),this},end:function(){return--this.active===0&&(delete this.that.__zooming,this.emit("end")),this},emit:function(M){var L=br(this.that).datum();c.call(M,this.that,new kL(M,{sourceEvent:this.sourceEvent,target:p,transform:this.that.__zoom,dispatch:c}),L)}};function y(M,...L){if(!t.apply(this,arguments))return;var T=O(this,L).event(M),C=this.__zoom,V=Math.max(o[0],Math.min(o[1],C.k*Math.pow(2,i.apply(this,arguments)))),X=mr(M);if(T.wheel)(T.mouse[0][0]!==X[0]||T.mouse[0][1]!==X[1])&&(T.mouse[1]=C.invert(T.mouse[0]=X)),clearTimeout(T.wheel);else{if(C.k===V)return;T.mouse=[X,C.invert(X)],El(this),T.start()}_s(M),T.wheel=setTimeout(k,g),T.zoom("mouse",n(v(b(C,V),T.mouse[0],T.mouse[1]),T.extent,s));function k(){T.wheel=null,T.end()}}function w(M,...L){if(d||!t.apply(this,arguments))return;var T=M.currentTarget,C=O(this,L,!0).event(M),V=br(M.view).on("mousemove.zoom",j,!0).on("mouseup.zoom",fe,!0),X=mr(M,T),k=M.clientX,Y=M.clientY;eD(M.view),$u(M),C.mouse=[X,this.__zoom.invert(X)],El(this),C.start();function j(_e){if(_s(_e),!C.moved){var he=_e.clientX-k,K=_e.clientY-Y;C.moved=he*he+K*K>_}C.event(_e).zoom("mouse",n(v(C.that.__zoom,C.mouse[0]=mr(_e,T),C.mouse[1]),C.extent,s))}function fe(_e){V.on("mousemove.zoom mouseup.zoom",null),tD(_e.view,C.moved),_s(_e),C.event(_e).end()}}function H(M,...L){if(t.apply(this,arguments)){var T=this.__zoom,C=mr(M.changedTouches?M.changedTouches[0]:M,this),V=T.invert(C),X=T.k*(M.shiftKey?.5:2),k=n(v(b(T,X),C,V),e.apply(this,L),s);_s(M),a>0?br(this).transition().duration(a).call(D,k,C,M):br(this).call(p.transform,k,C,M)}}function N(M,...L){if(t.apply(this,arguments)){var T=M.touches,C=T.length,V=O(this,L,M.changedTouches.length===C).event(M),X,k,Y,j;for($u(M),k=0;k<C;++k)Y=T[k],j=mr(Y,this),j=[j,this.__zoom.invert(j),Y.identifier],V.touch0?!V.touch1&&V.touch0[2]!==j[2]&&(V.touch1=j,V.taps=0):(V.touch0=j,X=!0,V.taps=1+!!u);u&&(u=clearTimeout(u)),X&&(V.taps<2&&(f=j[0],u=setTimeout(function(){u=null},h)),El(this),V.start())}}function I(M,...L){if(this.__zooming){var T=O(this,L).event(M),C=M.changedTouches,V=C.length,X,k,Y,j;for(_s(M),X=0;X<V;++X)k=C[X],Y=mr(k,this),T.touch0&&T.touch0[2]===k.identifier?T.touch0[0]=Y:T.touch1&&T.touch1[2]===k.identifier&&(T.touch1[0]=Y);if(k=T.that.__zoom,T.touch1){var fe=T.touch0[0],_e=T.touch0[1],he=T.touch1[0],K=T.touch1[1],ne=(ne=he[0]-fe[0])*ne+(ne=he[1]-fe[1])*ne,le=(le=K[0]-_e[0])*le+(le=K[1]-_e[1])*le;k=b(k,Math.sqrt(ne/le)),Y=[(fe[0]+he[0])/2,(fe[1]+he[1])/2],j=[(_e[0]+K[0])/2,(_e[1]+K[1])/2]}else if(T.touch0)Y=T.touch0[0],j=T.touch0[1];else return;T.zoom("touch",n(v(k,Y,j),T.extent,s))}}function q(M,...L){if(this.__zooming){var T=O(this,L).event(M),C=M.changedTouches,V=C.length,X,k;for($u(M),d&&clearTimeout(d),d=setTimeout(function(){d=null},h),X=0;X<V;++X)k=C[X],T.touch0&&T.touch0[2]===k.identifier?delete T.touch0:T.touch1&&T.touch1[2]===k.identifier&&delete T.touch1;if(T.touch1&&!T.touch0&&(T.touch0=T.touch1,delete T.touch1),T.touch0)T.touch0[1]=this.__zoom.invert(T.touch0[0]);else if(T.end(),T.taps===2&&(k=mr(k,this),Math.hypot(f[0]-k[0],f[1]-k[1])<m)){var Y=br(this).on("dblclick.zoom");Y&&Y.apply(this,arguments)}}}return p.wheelDelta=function(M){return arguments.length?(i=typeof M=="function"?M:sl(+M),p):i},p.filter=function(M){return arguments.length?(t=typeof M=="function"?M:sl(!!M),p):t},p.touchable=function(M){return arguments.length?(r=typeof M=="function"?M:sl(!!M),p):r},p.extent=function(M){return arguments.length?(e=typeof M=="function"?M:sl([[+M[0][0],+M[0][1]],[+M[1][0],+M[1][1]]]),p):e},p.scaleExtent=function(M){return arguments.length?(o[0]=+M[0],o[1]=+M[1],p):[o[0],o[1]]},p.translateExtent=function(M){return arguments.length?(s[0][0]=+M[0][0],s[1][0]=+M[1][0],s[0][1]=+M[0][1],s[1][1]=+M[1][1],p):[[s[0][0],s[0][1]],[s[1][0],s[1][1]]]},p.constrain=function(M){return arguments.length?(n=M,p):n},p.duration=function(M){return arguments.length?(a=+M,p):a},p.interpolate=function(M){return arguments.length?(l=M,p):l},p.on=function(){var M=c.on.apply(c,arguments);return M===c?p:M},p.clickDistance=function(M){return arguments.length?(_=(M=+M)*M,p):Math.sqrt(_)},p.tapDistance=function(M){return arguments.length?(m=+M,p):m},p}const H_=Symbol("MiniMapSlots"),XL=["id","x","y","rx","ry","width","height","fill","stroke","stroke-width","shape-rendering"],YL={name:"MiniMapNode",compatConfig:{MODE:3},inheritAttrs:!1},qL=Dt({...YL,props:{id:{},type:{},selected:{type:Boolean},dragging:{type:Boolean},position:{},dimensions:{},borderRadius:{},color:{},shapeRendering:{},strokeColor:{},strokeWidth:{},hidden:{type:Boolean}},emits:["click","dblclick","mouseenter","mousemove","mouseleave"],setup(t,{emit:e}){const n=t,i=Nn(H_),r=Ud(),o=wt(()=>r.style??{});function s(f){e("click",f)}function a(f){e("dblclick",f)}function l(f){e("mouseenter",f)}function c(f){e("mousemove",f)}function u(f){e("mouseleave",f)}return(f,d)=>!f.hidden&&f.dimensions.width!==0&&f.dimensions.height!==0?(Se(),Ce(ft,{key:0},[me(i)[`node-${n.type}`]?(Se(),_n(Jg(me(i)[`node-${n.type}`]),ax(Gs({key:0},{...n,...f.$attrs})),null,16)):(Se(),Ce("rect",Gs({key:1,id:f.id},f.$attrs,{class:["vue-flow__minimap-node",{selected:f.selected,dragging:f.dragging}],x:f.position.x,y:f.position.y,rx:f.borderRadius,ry:f.borderRadius,width:f.dimensions.width,height:f.dimensions.height,fill:f.color||o.value.background||o.value.backgroundColor,stroke:f.strokeColor,"stroke-width":f.strokeWidth,"shape-rendering":f.shapeRendering,onClick:s,onDblclick:a,onMouseenter:l,onMousemove:c,onMouseleave:u}),null,16,XL))],64)):lt("",!0)}}),KL=["width","height","viewBox","aria-labelledby"],ZL=["id"],jL=["d","fill","stroke","stroke-width"],JL={name:"MiniMap",compatConfig:{MODE:3}},QL=Dt({...JL,props:{nodeColor:{type:[String,Function],default:"#e2e2e2"},nodeStrokeColor:{type:[String,Function],default:"transparent"},nodeClassName:{type:[String,Function]},nodeBorderRadius:{default:5},nodeStrokeWidth:{default:2},maskColor:{default:"rgb(240, 240, 240, 0.6)"},maskStrokeColor:{default:"none"},maskStrokeWidth:{default:1},position:{default:"bottom-right"},pannable:{type:Boolean,default:!1},zoomable:{type:Boolean,default:!1},width:{},height:{},ariaLabel:{default:"Vue Flow mini map"},inversePan:{type:Boolean,default:!1},zoomStep:{default:1},offsetScale:{default:5},maskBorderRadius:{default:0}},emits:["click","nodeClick","nodeDblclick","nodeMouseenter","nodeMousemove","nodeMouseleave"],setup(t,{emit:e}){const n=tv(),i=Ud(),r=200,o=150,{id:s,edges:a,viewport:l,translateExtent:c,dimensions:u,emits:f,d3Selection:d,d3Zoom:h,getNodesInitialized:g}=Lt(),_=Ke();Tr(H_,n);const m=wt(()=>{var V;return t.width??((V=i.style)==null?void 0:V.width)??r}),p=wt(()=>{var V;return t.height??((V=i.style)==null?void 0:V.height)??o}),b=typeof window>"u"||window.chrome?"crispEdges":"geometricPrecision",v=He(()=>typeof t.nodeColor=="string"?()=>t.nodeColor:t.nodeColor),x=He(()=>typeof t.nodeStrokeColor=="string"?()=>t.nodeStrokeColor:t.nodeStrokeColor),D=He(()=>typeof t.nodeClassName=="string"?()=>t.nodeClassName:typeof t.nodeClassName=="function"?t.nodeClassName:()=>""),O=He(()=>ah(g.value.filter(V=>!V.hidden))),U=He(()=>({x:-l.value.x/l.value.zoom,y:-l.value.y/l.value.zoom,width:u.value.width/l.value.zoom,height:u.value.height/l.value.zoom})),y=He(()=>g.value&&g.value.length?aP(O.value,U.value):U.value),w=He(()=>{const V=y.value.width/m.value,X=y.value.height/p.value;return Math.max(V,X)}),H=He(()=>{const V=w.value*m.value,X=w.value*p.value,k=t.offsetScale*w.value;return{offset:k,x:y.value.x-(V-y.value.width)/2-k,y:y.value.y-(X-y.value.height)/2-k,width:V+k*2,height:X+k*2}}),N=He(()=>!H.value.x||!H.value.y?"":`
    ...
    M${U.value.x+t.maskBorderRadius},${U.value.y}
    h${U.value.width-2*t.maskBorderRadius}
    a${t.maskBorderRadius},${t.maskBorderRadius} 0 0 1 ${t.maskBorderRadius},${t.maskBorderRadius}
    v${U.value.height-2*t.maskBorderRadius}
    a${t.maskBorderRadius},${t.maskBorderRadius} 0 0 1 -${t.maskBorderRadius},${t.maskBorderRadius}
    h${-(U.value.width-2*t.maskBorderRadius)}
    a${t.maskBorderRadius},${t.maskBorderRadius} 0 0 1 -${t.maskBorderRadius},-${t.maskBorderRadius}
    v${-(U.value.height-2*t.maskBorderRadius)}
    a${t.maskBorderRadius},${t.maskBorderRadius} 0 0 1 ${t.maskBorderRadius},-${t.maskBorderRadius}z`);Yx(V=>{if(_.value){const X=br(_.value),k=fe=>{if(fe.sourceEvent.type!=="wheel"||!d.value||!h.value)return;const _e=fe.sourceEvent.ctrlKey&&na()?10:1,he=-fe.sourceEvent.deltaY*(fe.sourceEvent.deltaMode===1?.05:fe.sourceEvent.deltaMode?1:.002)*t.zoomStep,K=l.value.zoom*2**(he*_e);h.value.scaleTo(d.value,K)},Y=fe=>{if(fe.sourceEvent.type!=="mousemove"||!d.value||!h.value)return;const _e=w.value*Math.max(1,l.value.zoom)*(t.inversePan?-1:1),he={x:l.value.x-fe.sourceEvent.movementX*_e,y:l.value.y-fe.sourceEvent.movementY*_e},K=[[0,0],[u.value.width,u.value.height]],ne=_h.translate(he.x,he.y).scale(l.value.zoom),le=h.value.constrain()(ne,K,c.value);h.value.transform(d.value,le)},j=WL().wheelDelta(fe=>ad(fe)*(t.zoomStep/10)).on("zoom",t.pannable?Y:()=>{}).on("zoom.wheel",t.zoomable?k:()=>{});X.call(j),V(()=>{X.on("zoom",null)})}},{flush:"post"});function I(V){const[X,k]=mr(V);e("click",{event:V,position:{x:X,y:k}})}function q(V,X){const k={event:V,node:X,connectedEdges:Xr([X],a.value)};f.miniMapNodeClick(k),e("nodeClick",k)}function M(V,X){const k={event:V,node:X,connectedEdges:Xr([X],a.value)};f.miniMapNodeDoubleClick(k),e("nodeDblclick",k)}function L(V,X){const k={event:V,node:X,connectedEdges:Xr([X],a.value)};f.miniMapNodeMouseEnter(k),e("nodeMouseenter",k)}function T(V,X){const k={event:V,node:X,connectedEdges:Xr([X],a.value)};f.miniMapNodeMouseMove(k),e("nodeMousemove",k)}function C(V,X){const k={event:V,node:X,connectedEdges:Xr([X],a.value)};f.miniMapNodeMouseLeave(k),e("nodeMouseleave",k)}return(V,X)=>(Se(),_n(me(u3),{position:V.position,class:Gt(["vue-flow__minimap",{pannable:V.pannable,zoomable:V.zoomable}])},{default:Bn(()=>[(Se(),Ce("svg",{ref_key:"el",ref:_,width:m.value,height:p.value,viewBox:[H.value.x,H.value.y,H.value.width,H.value.height].join(" "),role:"img","aria-labelledby":`vue-flow__minimap-${me(s)}`,onClick:I},[V.ariaLabel?(Se(),Ce("title",{key:0,id:`vue-flow__minimap-${me(s)}`},Ze(V.ariaLabel),9,ZL)):lt("",!0),(Se(!0),Ce(ft,null,Sn(me(g),k=>(Se(),_n(qL,{id:k.id,key:k.id,f:"",position:k.computedPosition,dimensions:k.dimensions,selected:k.selected,dragging:k.dragging,style:It(k.style),class:Gt(D.value(k)),color:v.value(k),"border-radius":V.nodeBorderRadius,"stroke-color":x.value(k),"stroke-width":V.nodeStrokeWidth,"shape-rendering":me(b),type:k.type,hidden:k.hidden,onClick:Y=>q(Y,k),onDblclick:Y=>M(Y,k),onMouseenter:Y=>L(Y,k),onMousemove:Y=>T(Y,k),onMouseleave:Y=>C(Y,k)},null,8,["id","position","dimensions","selected","dragging","style","class","color","border-radius","stroke-color","stroke-width","shape-rendering","type","hidden","onClick","onDblclick","onMouseenter","onMousemove","onMouseleave"]))),128)),ge("path",{class:"vue-flow__minimap-mask",d:N.value,fill:V.maskColor,stroke:V.maskStrokeColor,"stroke-width":V.maskStrokeWidth,"fill-rule":"evenodd"},null,8,jL)],8,KL))]),_:1},8,["position","class"]))}}),eU=(t,e)=>{const n=t.__vccOpts||t;for(const[i,r]of e)n[i]=r;return n},tU={class:"flow-node__header"},nU={class:"flow-node__title"},iU=["title"],rU=["title"],oU={class:"flow-node__body"},sU={class:"flow-node__handles"},aU={class:"flow-node__handle-label"},lU={class:"flow-node__handle-type"},cU=["title"],uU={class:"flow-node__handle-label flow-node__handle-label--exposed"},fU={class:"flow-node__handle-type"},dU=["src"],hU=["min","max","step","value"],pU={class:"flow-node__slider-value"},mU={class:"flow-node__inline-param-row"},gU=["value"],vU=["value"],_U={class:"flow-node__inline-param-row"},xU=["value"],yU={class:"flow-node__inline-param-val"},bU={class:"flow-node__inline-param-row"},SU=["value"],MU={class:"flow-node__inline-param-val"},EU={key:6,class:"flow-node__monitor"},wU=["title"],TU={key:7,class:"flow-node__preview-inline"},AU={class:"flow-node__handles"},CU={class:"flow-node__handle-type"},RU={class:"flow-node__handle-label"},PU=["title"],cg=100,IU={__name:"FlowNode",props:{nodeType:{type:String,required:!0},def:{type:Object,required:!0},params:{type:Object,default:()=>({})},selected:{type:Boolean,default:!1},inputValues:{type:Object,default:()=>({})},outputValues:{type:Object,default:()=>({})},monitorValue:{type:Number,default:null},exposedHandles:{type:Array,default:()=>[]},perfMs:{type:Number,default:null}},emits:["select","imageLoaded","export","trigger","paramChange"],setup(t,{emit:e}){const n=t,i=e,r=He(()=>zl[n.def.category]?.color||"#888"),o=Ke(null),s=Ke(!1),a=Ke(null),l=He(()=>!!a.value);Kn(()=>{if(n.nodeType==="imageInput"&&!a.value){const b="/default_img.jpg";a.value=b;const v=new Image;v.crossOrigin="anonymous",v.src=b,v.onload=()=>{i("imageLoaded",{url:b,width:v.naturalWidth,height:v.naturalHeight,img:v})}}});const c=Ke(null),u=Ke([]),f=Ke(null);function d(){o.value?.click()}function h(b){const v=b.target.files?.[0];v&&_(v)}function g(b){s.value=!1;const v=b.dataTransfer.files?.[0];v&&v.type.startsWith("image/")&&_(v)}function _(b){const v=URL.createObjectURL(b);a.value=v;const x=new Image;x.onload=()=>{i("imageLoaded",{url:v,width:x.naturalWidth,height:x.naturalHeight,img:x})},x.src=v}function m(b){return b==null?"":typeof b=="number"?b.toFixed(2):String(b)}ut(()=>n.monitorValue,b=>{b!=null&&(u.value.push(b),u.value.length>cg&&u.value.shift(),p())});function p(){const b=c.value;if(!b)return;const v=b.getContext("2d"),x=b.width,D=b.height,O=u.value;if(v.clearRect(0,0,x,D),O.length<2)return;const U=Math.min(...O),y=Math.max(...O),w=y-U||1;v.strokeStyle="#00d4ff",v.lineWidth=1.5,v.beginPath();for(let H=0;H<O.length;H++){const N=H/(cg-1)*x,I=D-(O[H]-U)/w*(D-4)-2;H===0?v.moveTo(N,I):v.lineTo(N,I)}if(v.stroke(),U<=0&&y>=0){const H=D-(0-U)/w*(D-4)-2;v.strokeStyle="#ffffff30",v.lineWidth=.5,v.beginPath(),v.moveTo(0,H),v.lineTo(x,H),v.stroke()}}return(b,v)=>(Se(),Ce("div",{class:Gt(["flow-node",{"flow-node--selected":t.selected},{"flow-node--compact":t.def.compact},{"flow-node--bypassed":t.params._bypass}]),onClick:v[29]||(v[29]=x=>b.$emit("select"))},[ge("div",tU,[ge("div",{class:"flow-node__category-dot",style:It({background:r.value})},null,4),ge("div",nU,Ze(t.def.label),1),t.def.shaderKey||t.def.category==="image"||t.def.category==="uv"?(Se(),Ce("button",{key:0,class:Gt(["flow-node__bypass-btn",{"flow-node__bypass-btn--active":t.params._bypass}]),onClick:v[0]||(v[0]=dt(x=>b.$emit("paramChange","_bypass",!t.params._bypass),["stop"])),title:t.params._bypass?"Enable (bypassed)":"Bypass"},Ze(t.params._bypass?"⊘":"⏵"),11,iU)):lt("",!0),t.perfMs!==null?(Se(),Ce("span",{key:1,class:"flow-node__perf-badge",title:t.perfMs+"ms"},Ze(t.perfMs<1?"<1":t.perfMs.toFixed(1))+"ms ",9,rU)):lt("",!0)]),ge("div",oU,[ge("div",sU,[(Se(!0),Ce(ft,null,Sn(t.def.inputs,x=>(Se(),Ce("div",{key:"in-"+x.id,class:"flow-node__handle-row flow-node__handle-row--input"},[st(me(io),{type:"target",id:x.id,position:me(Ve).Left,style:It({background:me(Pu)(x.type)})},null,8,["id","position","style"]),ge("span",aU,Ze(x.label),1),ge("span",lU,Ze(x.type),1),t.inputValues[x.id]!==void 0?(Se(),Ce("span",{key:0,class:"flow-node__handle-value",title:"Value: "+t.inputValues[x.id]},Ze(m(t.inputValues[x.id])),9,cU)):lt("",!0)]))),128)),(Se(!0),Ce(ft,null,Sn(t.exposedHandles,x=>(Se(),Ce("div",{key:"exp-"+x.id,class:"flow-node__handle-row flow-node__handle-row--input flow-node__handle-row--exposed"},[st(me(io),{type:"target",id:x.id,position:me(Ve).Left,style:It({background:me(Pu)(x.type)})},null,8,["id","position","style"]),ge("span",uU,"⊕ "+Ze(x.label),1),ge("span",fU,Ze(x.type),1)]))),128))]),t.nodeType==="imageInput"?(Se(),Ce("div",{key:0,class:"flow-node__controls",onPointerdown:v[3]||(v[3]=dt(()=>{},["stop"])),onMousedown:v[4]||(v[4]=dt(()=>{},["stop"]))},[ge("input",{ref_key:"fileInput",ref:o,type:"file",accept:"image/*",class:"file-input-hidden",onChange:h},null,544),l.value?(Se(),Ce("img",{key:1,src:a.value,class:"flow-node__image-preview"},null,8,dU)):(Se(),Ce("div",{key:0,class:Gt(["flow-node__drop-zone",{"flow-node__drop-zone--active":s.value}]),onClick:dt(d,["stop"]),onDragover:v[1]||(v[1]=dt(x=>s.value=!0,["prevent"])),onDragleave:v[2]||(v[2]=x=>s.value=!1),onDrop:dt(g,["prevent"])}," 📷 Drop image or click to browse ",34))],32)):lt("",!0),t.nodeType==="imageOutput"?(Se(),Ce("div",{key:1,class:"flow-node__controls",onPointerdown:v[6]||(v[6]=dt(()=>{},["stop"])),onMousedown:v[7]||(v[7]=dt(()=>{},["stop"]))},[ge("button",{class:"flow-node__inline-btn",onClick:v[5]||(v[5]=dt(x=>b.$emit("export"),["stop"]))}," ⬇ Export "+Ze(t.params.format||"PNG"),1)],32)):lt("",!0),t.nodeType==="button"?(Se(),Ce("div",{key:2,class:"flow-node__controls",onPointerdown:v[9]||(v[9]=dt(()=>{},["stop"])),onMousedown:v[10]||(v[10]=dt(()=>{},["stop"]))},[ge("button",{class:"flow-node__inline-btn",onClick:v[8]||(v[8]=dt(x=>b.$emit("trigger"),["stop"]))},Ze(t.params.label||"Press"),1)],32)):lt("",!0),t.nodeType==="slider"?(Se(),Ce("div",{key:3,class:"flow-node__slider-container",onPointerdown:v[14]||(v[14]=dt(()=>{},["stop"])),onMousedown:v[15]||(v[15]=dt(()=>{},["stop"]))},[ge("input",{type:"range",class:"flow-node__inline-slider",min:t.params.min??0,max:t.params.max??1,step:t.params.step??.01,value:t.params.value??.5,onInput:v[11]||(v[11]=dt(x=>b.$emit("paramChange","value",Number(x.target.value)),["stop"])),onPointerdown:v[12]||(v[12]=dt(()=>{},["stop"])),onMousedown:v[13]||(v[13]=dt(()=>{},["stop"]))},null,40,hU),ge("div",pU,Ze((t.params.value??.5).toFixed(3)),1)],32)):lt("",!0),t.nodeType==="lfo"?(Se(),Ce("div",{key:4,class:"flow-node__inline-params",onPointerdown:v[25]||(v[25]=dt(()=>{},["stop"])),onMousedown:v[26]||(v[26]=dt(()=>{},["stop"]))},[ge("div",mU,[v[30]||(v[30]=ge("span",{class:"flow-node__inline-param-label"},"wave",-1)),ge("select",{class:"flow-node__inline-select",value:t.params.waveform??"sine",onChange:v[16]||(v[16]=dt(x=>b.$emit("paramChange","waveform",x.target.value),["stop"])),onPointerdown:v[17]||(v[17]=dt(()=>{},["stop"])),onMousedown:v[18]||(v[18]=dt(()=>{},["stop"]))},[(Se(),Ce(ft,null,Sn(["sine","saw","square","triangle"],x=>ge("option",{key:x,value:x},Ze(x),9,vU)),64))],40,gU)]),ge("div",_U,[v[31]||(v[31]=ge("span",{class:"flow-node__inline-param-label"},"freq",-1)),ge("input",{type:"range",class:"flow-node__inline-slider-sm",min:"0.01",max:"20",step:"0.01",value:t.params.frequency??1,onInput:v[19]||(v[19]=dt(x=>b.$emit("paramChange","frequency",Number(x.target.value)),["stop"])),onPointerdown:v[20]||(v[20]=dt(()=>{},["stop"])),onMousedown:v[21]||(v[21]=dt(()=>{},["stop"]))},null,40,xU),ge("span",yU,Ze((t.params.frequency??1).toFixed(2)),1)]),ge("div",bU,[v[32]||(v[32]=ge("span",{class:"flow-node__inline-param-label"},"amp",-1)),ge("input",{type:"range",class:"flow-node__inline-slider-sm",min:"0",max:"10",step:"0.01",value:t.params.amplitude??1,onInput:v[22]||(v[22]=dt(x=>b.$emit("paramChange","amplitude",Number(x.target.value)),["stop"])),onPointerdown:v[23]||(v[23]=dt(()=>{},["stop"])),onMousedown:v[24]||(v[24]=dt(()=>{},["stop"]))},null,40,SU),ge("span",MU,Ze((t.params.amplitude??1).toFixed(2)),1)])],32)):lt("",!0),t.nodeType==="fft"?(Se(),Ce("div",{key:5,class:"flow-node__fft-container",onPointerdown:v[27]||(v[27]=dt(()=>{},["stop"])),onMousedown:v[28]||(v[28]=dt(()=>{},["stop"]))},[ge("div",{class:"flow-node__fft-bar flow-node__fft-bar--bass",style:It({height:Math.max(2,(t.outputValues.bass||0)*40)+"px"})},null,4),ge("div",{class:"flow-node__fft-bar flow-node__fft-bar--low-mid",style:It({height:Math.max(2,(t.outputValues.lowMid||0)*40)+"px"})},null,4),ge("div",{class:"flow-node__fft-bar flow-node__fft-bar--mid",style:It({height:Math.max(2,(t.outputValues.mid||0)*40)+"px"})},null,4),ge("div",{class:"flow-node__fft-bar flow-node__fft-bar--high",style:It({height:Math.max(2,(t.outputValues.high||0)*40)+"px"})},null,4)],32)):lt("",!0),t.nodeType==="numberMonitor"?(Se(),Ce("div",EU,[ge("div",{class:"flow-node__monitor-value",title:"Value: "+(t.monitorValue??0)},Ze(t.monitorValue!==null&&t.monitorValue!==void 0?t.monitorValue.toFixed(t.params.decimals??3):"—"),9,wU),t.params.showGraph!==!1?(Se(),Ce("canvas",{key:0,ref_key:"monitorCanvas",ref:c,class:"flow-node__monitor-graph",width:"176",height:"40"},null,512)):lt("",!0)])):lt("",!0),t.nodeType==="preview"?(Se(),Ce("div",TU,[ge("canvas",{ref_key:"previewCanvas",ref:f,class:"flow-node__preview-canvas",width:"176",height:"100"},null,512),v[33]||(v[33]=ge("div",{class:"flow-node__preview-label"},"Preview Node",-1))])):lt("",!0),ge("div",AU,[(Se(!0),Ce(ft,null,Sn(t.def.outputs,x=>(Se(),Ce("div",{key:"out-"+x.id,class:"flow-node__handle-row flow-node__handle-row--output"},[ge("span",CU,Ze(x.type),1),ge("span",RU,Ze(x.label),1),t.outputValues[x.id]!==void 0?(Se(),Ce("span",{key:0,class:"flow-node__handle-value",title:"Value: "+t.outputValues[x.id]},Ze(m(t.outputValues[x.id])),9,PU)):lt("",!0),st(me(io),{type:"source",id:x.id,position:me(Ve).Right,style:It({background:me(Pu)(x.type)})},null,8,["id","position","style"])]))),128))])])],2))}},xs=eU(IU,[["__scopeId","data-v-7d6f43f8"]]);let yd=0;function NU(){return`node_${++yd}_${Date.now().toString(36)}`}const xh=Tb("graph",()=>{const t=Ke([]),e=Ke([]),n=wr({}),i=Ke(null),r=Ke(!0),o=Ke("panel"),s=Ke(null),a=Ke("Untitled Project"),l=Ke({}),c=Ke({});let u=null;const f=wr({}),d=He(()=>i.value&&t.value.find(k=>k.id===i.value)||null),h=He(()=>d.value?si(d.value.type):null),g=He(()=>i.value?n[i.value]||{}:{});function _(k){u=k}function m(k,Y={x:200,y:200}){const j=si(k);if(!j)return console.warn(`Unknown node type: ${k}`),null;const fe=NU(),_e={};for(const[K,ne]of Object.entries(j.params))_e[K]=ne.default;n[fe]=_e;const he={id:fe,type:k,position:Y,data:{label:j.label,category:j.category,def:j}};return t.value=[...t.value,he],fe}function p(k){u&&u(k),t.value=t.value.filter(Y=>Y.id!==k),e.value=e.value.filter(Y=>Y.source!==k&&Y.target!==k),delete n[k],delete f[k],i.value===k&&(i.value=null),s.value===k&&(s.value=null)}function b(k){const Y=t.value.find(le=>le.id===k.source),j=t.value.find(le=>le.id===k.target);if(!Y||!j)return!1;const fe=si(Y.type),_e=si(j.type);if(!fe||!_e)return!1;const he=fe.outputs.find(le=>le.id===k.sourceHandle);let K=_e.inputs.find(le=>le.id===k.targetHandle);if(!K){const le=f[j.id];if(le&&le[k.targetHandle]){const Te=_e.params[k.targetHandle];if(Te){const xe=Te.type==="int"?ve.INT:(Te.type==="float",ve.FLOAT);K={id:k.targetHandle,type:xe}}}}if(!he||!K)return!1;if(!YT(he.type,K.type))return console.warn(`Type mismatch: ${he.type} → ${K.type}`),!1;e.value=e.value.filter(le=>!(le.target===k.target&&le.targetHandle===k.targetHandle));const ne={id:`e_${k.source}_${k.sourceHandle}-${k.target}_${k.targetHandle}`,source:k.source,sourceHandle:k.sourceHandle,target:k.target,targetHandle:k.targetHandle};return e.value=[...e.value,ne],!0}function v(k){e.value=e.value.filter(Y=>Y.id!==k)}function x(k,Y,j){n[k]||(n[k]={}),n[k][Y]=j}function D(k,Y){f[k]||(f[k]={}),f[k][Y]=!f[k][Y],f[k][Y]||(e.value=e.value.filter(j=>!(j.target===k&&j.targetHandle===Y)))}function O(k,Y){return!!f[k]?.[Y]}function U(k){const Y=t.value.find(_e=>_e.id===k);if(!Y)return[];const j=si(Y.type);if(!j)return[];const fe=f[k]||{};return Object.entries(fe).filter(([_e,he])=>he).map(([_e])=>{const he=j.params[_e];if(!he)return null;const K=he.type==="int"?ve.INT:(he.type==="float",ve.FLOAT);return{id:_e,label:he.label,type:K}}).filter(Boolean)}function y(k){i.value=k}function w(){r.value=!r.value}function H(){r.value=!1}function N(){r.value=!0}function I(){o.value=o.value==="panel"?"background":"panel"}function q(){for(const k of t.value)u&&u(k.id);t.value=[],e.value=[],Object.keys(n).forEach(k=>delete n[k]),Object.keys(f).forEach(k=>delete f[k]),i.value=null,s.value=null,yd=0}function M(){const k={version:1,title:a.value,timestamp:Date.now(),nodes:t.value.map(Y=>({id:Y.id,type:Y.type,position:Y.position})),edges:e.value.map(Y=>({id:Y.id,source:Y.source,sourceHandle:Y.sourceHandle,target:Y.target,targetHandle:Y.targetHandle})),params:{...n},exposedParams:{...f},settings:{previewMode:o.value}};return JSON.stringify(k,null,2)}function L(){const k=M(),Y=`image-mangler-graph-${a.value||"default"}`;return localStorage.setItem(Y,k),!0}function T(k){try{const Y=JSON.parse(k);Y.version!==1&&console.warn("Unknown graph version:",Y.version),q(),a.value=Y.title||"Untitled Project";for(const fe of Y.nodes){const _e=si(fe.type);if(!_e){console.warn(`Skipping unknown node type: ${fe.type}`);continue}const he={id:fe.id,type:fe.type,position:fe.position,data:{label:_e.label,category:_e.category,def:_e}};t.value.push(he);const K={};for(const[ne,le]of Object.entries(_e.params))K[ne]=Y.params?.[fe.id]?.[ne]??le.default;n[fe.id]=K}if(Y.exposedParams)for(const[fe,_e]of Object.entries(Y.exposedParams))f[fe]={..._e};for(const fe of Y.edges)e.value.push(fe);return Y.settings&&(o.value=Y.settings.previewMode||"panel"),yd=Y.nodes.reduce((fe,_e)=>{const he=_e.id.match(/node_(\d+)_/);return he?Math.max(fe,parseInt(he[1])):fe},0),!0}catch(Y){return console.error("Failed to load graph:",Y),!1}}function C(k=null){try{const Y=k?`mangleditor-graph-${k}`:`mangleditor-graph-${a.value||"default"}`,j=localStorage.getItem(Y);if(j)return T(j);if(!k&&(!a.value||a.value==="Untitled Project")){let fe=null,_e=0;for(let he=0;he<localStorage.length;he++){const K=localStorage.key(he);if(K.startsWith("mangleditor-graph-"))try{const ne=JSON.parse(localStorage.getItem(K));ne.timestamp&&ne.timestamp>_e&&(_e=ne.timestamp,fe=K)}catch{}}if(fe)return T(localStorage.getItem(fe))}return!1}catch(Y){return console.error("Failed to load from localStorage:",Y),!1}}function V(){const k=M(),Y=new Blob([k],{type:"application/json"}),j=URL.createObjectURL(Y),fe=document.createElement("a");fe.href=j;const _e=(a.value||"mangleditor").replace(/[^a-zA-Z0-9_-]/g,"_");fe.download=`${_e}.json`,fe.click(),URL.revokeObjectURL(j)}function X(k){const Y=t.value.find(j=>j.id===k);Y&&Y.type==="button"&&(Y._triggered=!0)}return{nodes:t,edges:e,nodeParams:n,selectedNodeId:i,isRendering:r,previewMode:o,previewNodeId:s,projectTitle:a,exposedParams:f,selectedNode:d,selectedNodeDef:h,selectedNodeParams:g,dataOutputs:l,perfTimings:c,getDataOutput(k,Y){return l.value[k]?.[Y]},addNode:m,removeNode:p,addEdge:b,removeEdge:v,setParam:x,selectNode:y,toggleRendering:w,stopRendering:H,startRendering:N,togglePreviewMode:I,resetGraph:q,saveGraph:M,saveToLocalStorage:L,loadGraph:T,loadFromLocalStorage:C,downloadGraph:V,triggerButton:X,onNodeRemoved:_,toggleExposeParam:D,isParamExposed:O,getExposedHandles:U}}),DU={__name:"EditorCanvas",emits:["imageLoaded","exportImage"],setup(t,{expose:e,emit:n}){const i=xh(),{viewport:r,dimensions:o,project:s}=Lt();function a(p){const{x:b,y:v,zoom:x}=r.value,{width:D,height:O}=o.value,U=D||800,y=O||600,w=(U/2-b)/x,H=(y/2-v)/x;i.addNode(p,{x:w+(Math.random()-.5)*60,y:H+(Math.random()-.5)*60})}e({addNodeAtCenter:a});const l=["imageInput","imageOutput","button","slider"],c=He(()=>Object.keys(qT()).filter(p=>!l.includes(p)));function u(p){for(const b of p)if(b.type==="position"&&b.position){const v=i.nodes.find(x=>x.id===b.id);v&&(v.position=b.position)}else b.type==="remove"&&i.removeNode(b.id)}function f(p){for(const b of p)b.type==="remove"&&i.removeEdge(b.id)}function d(p){i.addEdge(p)}function h({node:p}){i.selectNode(p.id)}function g(){i.selectNode(null)}function _({edge:p}){}function m(p){const b=p.dataTransfer.getData("application/node-type");if(!b)return;const v=p.currentTarget.getBoundingClientRect(),{x,y:D,zoom:O}=r.value,U=(p.clientX-v.left-x)/O,y=(p.clientY-v.top-D)/O;i.addNode(b,{x:U,y})}return(p,b)=>(Se(),Ce("div",{class:"editor-canvas",onDrop:dt(m,["prevent"]),onDragover:b[0]||(b[0]=dt(()=>{},["prevent"]))},[st(me(l3),{nodes:me(i).nodes,edges:me(i).edges,"default-viewport":{zoom:1,x:0,y:0},"min-zoom":.2,"max-zoom":3,"fit-view-on-init":"",onNodesChange:u,onEdgesChange:f,onConnect:d,onNodeClick:h,onPaneClick:g,onEdgeClick:_},ay({"node-imageInput":Bn(v=>[st(xs,{"node-type":v.type,def:v.data.def,params:me(i).nodeParams[v.id]||{},selected:me(i).selectedNodeId===v.id,onSelect:x=>me(i).selectNode(v.id),onImageLoaded:x=>p.$emit("imageLoaded",v.id,x)},null,8,["node-type","def","params","selected","onSelect","onImageLoaded"])]),"node-imageOutput":Bn(v=>[st(xs,{"node-type":v.type,def:v.data.def,params:me(i).nodeParams[v.id]||{},selected:me(i).selectedNodeId===v.id,onSelect:x=>me(i).selectNode(v.id),onExport:x=>p.$emit("exportImage",v.id)},null,8,["node-type","def","params","selected","onSelect","onExport"])]),"node-button":Bn(v=>[st(xs,{"node-type":v.type,def:v.data.def,params:me(i).nodeParams[v.id]||{},selected:me(i).selectedNodeId===v.id,onSelect:x=>me(i).selectNode(v.id),onTrigger:x=>me(i).triggerButton(v.id)},null,8,["node-type","def","params","selected","onSelect","onTrigger"])]),"node-slider":Bn(v=>[st(xs,{"node-type":v.type,def:v.data.def,params:me(i).nodeParams[v.id]||{},selected:me(i).selectedNodeId===v.id,onSelect:x=>me(i).selectNode(v.id),onParamChange:(x,D)=>me(i).setParam(v.id,x,D)},null,8,["node-type","def","params","selected","onSelect","onParamChange"])]),default:Bn(()=>[st(me(v3),{variant:"dots",gap:20,size:2,"pattern-color":"#2a2a40"}),st(me(QL),{pannable:"",zoomable:"",position:"bottom-right"})]),_:2},[Sn(c.value,v=>({name:`node-${v}`,fn:Bn(x=>[st(xs,{"node-type":x.type,def:x.data.def,params:me(i).nodeParams[x.id]||{},selected:me(i).selectedNodeId===x.id,"exposed-handles":me(i).getExposedHandles(x.id),"monitor-value":x.type==="numberMonitor"?me(i).getDataOutput(x.id,"out"):null,"perf-ms":me(i).perfTimings[x.id]??null,onSelect:D=>me(i).selectNode(x.id),onParamChange:(D,O)=>me(i).setParam(x.id,D,O)},null,8,["node-type","def","params","selected","exposed-handles","monitor-value","perf-ms","onSelect","onParamChange"])])}))]),1032,["nodes","edges"])],32))}},LU={class:"preview-panel__toolbar"},UU={class:"preview-panel__zoom-level"},FU={class:"preview-panel__overlay"},OU={class:"preview-panel__badge"},BU={key:0,class:"preview-panel__badge",style:{color:"var(--accent-primary)"}},kU={key:1,class:"preview-panel__badge",style:{color:"var(--accent-danger)"}},zU={key:0,class:"preview-panel__histogram"},VU={class:"preview-panel__info-row"},HU={key:0},GU={__name:"PreviewPanel",props:{hidden:{type:Boolean,default:!1},isRendering:{type:Boolean,default:!0},pipeline:{type:Object,default:null},fps:{type:Number,default:0}},setup(t,{expose:e}){const n=Ke(null),i=Ke(null),r=Ke(null),o=Ke(512),s=Ke(512),a=Ke(1),l=Ke(0),c=Ke(0),u=Ke(!1),f=Ke({x:0,y:0}),d=Ke(!1);let h=null;function g(){return n.value}e({canvasRef:n,width:o,height:s,getCanvas:g}),ut(d,w=>{w?(U(),h=setInterval(U,500)):(h&&clearInterval(h),h=null)}),ca(()=>{h&&clearInterval(h)});function _(){a.value=Math.min(a.value*1.25,10)}function m(){a.value=Math.max(a.value/1.25,.1)}function p(){a.value=1,l.value=0,c.value=0}function b(){if(!r.value)return;const w=r.value.clientWidth,H=r.value.clientHeight,N=w/o.value,I=H/s.value;a.value=Math.min(N,I,1)*.95,l.value=(w-o.value*a.value)/2,c.value=(H-s.value*a.value)/2}function v(w){const H=w.deltaY>0?.9:1.1,N=Math.max(.1,Math.min(10,a.value*H)),I=r.value.getBoundingClientRect(),q=w.clientX-I.left,M=w.clientY-I.top;l.value=q-(q-l.value)*(N/a.value),c.value=M-(M-c.value)*(N/a.value),a.value=N}function x(w){(w.button===0||w.button===1)&&(u.value=!0,f.value={x:w.clientX,y:w.clientY},r.value?.setPointerCapture(w.pointerId))}function D(w){if(!u.value)return;const H=w.clientX-f.value.x,N=w.clientY-f.value.y;l.value+=H,c.value+=N,f.value={x:w.clientX,y:w.clientY}}function O(w){u.value=!1,r.value?.releasePointerCapture(w.pointerId)}function U(){if(!d.value||!i.value)return;const w=n.value;if(!w)return;const H=w.getContext("webgl2",{preserveDrawingBuffer:!0})||w.getContext("webgl",{preserveDrawingBuffer:!0});if(!H)return;const N=w.width,I=w.height;if(N===0||I===0)return;const q=new Uint8Array(N*I*4);H.readPixels(0,0,N,I,H.RGBA,H.UNSIGNED_BYTE,q);const M=new Uint32Array(256),L=new Uint32Array(256),T=new Uint32Array(256);for(let Y=0;Y<q.length;Y+=4)M[q[Y]]++,L[q[Y+1]]++,T[q[Y+2]]++;const C=i.value.getContext("2d"),V=256,X=80;C.clearRect(0,0,V,X);const k=Math.max(...M.slice(1,255),...L.slice(1,255),...T.slice(1,255),1);y(C,M,k,V,X,"rgba(255,80,80,0.5)"),y(C,L,k,V,X,"rgba(80,255,80,0.5)"),y(C,T,k,V,X,"rgba(80,80,255,0.5)")}function y(w,H,N,I,q,M){w.fillStyle=M,w.beginPath(),w.moveTo(0,q);for(let L=0;L<256;L++){const T=H[L]/N*(q-2);w.lineTo(L,q-T)}w.lineTo(255,q),w.closePath(),w.fill()}return(w,H)=>(Se(),Ce("div",{class:Gt(["preview-panel",{hidden:t.hidden}])},[ge("div",LU,[ge("button",{class:"preview-panel__tool-btn",onClick:_,title:"Zoom In"},"+"),ge("button",{class:"preview-panel__tool-btn",onClick:m,title:"Zoom Out"},"−"),ge("button",{class:"preview-panel__tool-btn",onClick:b,title:"Fit"},"⊡"),ge("button",{class:"preview-panel__tool-btn",onClick:p,title:"Reset Zoom"},"1:1"),ge("span",UU,Ze(Math.round(a.value*100))+"%",1),ge("button",{class:Gt(["preview-panel__tool-btn",{active:d.value}]),onClick:H[0]||(H[0]=N=>d.value=!d.value),title:"Toggle Histogram"},"📊",2)]),ge("div",{class:"preview-panel__viewport",ref_key:"viewportRef",ref:r,onWheel:dt(v,["prevent"]),onPointerdown:x,onPointermove:D,onPointerup:O},[ge("div",{class:"preview-panel__canvas-wrap",style:It({transform:`translate(${l.value}px, ${c.value}px) scale(${a.value})`,transformOrigin:"0 0"})},[ge("canvas",{ref_key:"canvasRef",ref:n,class:"preview-panel__canvas"},null,512)],4)],544),ge("div",FU,[ge("span",OU,Ze(o.value)+"×"+Ze(s.value),1),t.fps&&t.isRendering?(Se(),Ce("span",BU,Ze(t.fps)+" FPS ",1)):lt("",!0),t.isRendering?lt("",!0):(Se(),Ce("span",kU," STOPPED "))]),d.value?(Se(),Ce("div",zU,[ge("canvas",{ref_key:"histCanvas",ref:i,class:"preview-panel__hist-canvas",width:"256",height:"80"},null,512),ge("div",VU,[ge("span",null,"Resolution: "+Ze(o.value)+"×"+Ze(s.value),1),t.fps?(Se(),Ce("span",HU,Ze(t.fps)+" FPS",1)):lt("",!0)])])):lt("",!0)],2))}},$U={class:"param-panel"},WU={class:"param-panel__header"},XU={class:"param-panel__title"},YU={class:"param-panel__type"},qU={key:0,class:"param-panel__section"},KU={class:"param-field__header"},ZU={class:"param-field__label"},jU=["onClick","title"],JU=["min","max","step","value","onInput"],QU={class:"param-field__range-info"},eF=["step","value","onChange"],tF=["value","onChange"],nF=["value"],iF={key:2,class:"param-field__checkbox"},rF=["checked","onChange"],oF=["value","onInput"],sF={class:"param-panel__section"},aF={class:"param-field"},lF={class:"mono",style:{"font-size":"10px",color:"var(--text-muted)"}},cF={class:"param-field"},uF={style:{"font-size":"11px"}},fF={class:"param-field"},dF={style:{"font-size":"11px"}},hF={class:"param-field"},pF={style:{"font-size":"11px"}},mF={key:1,class:"param-panel__empty"},gF={__name:"ParameterPanel",setup(t){const e=xh(),n=He(()=>e.selectedNodeDef||{label:"",type:"",params:{},inputs:[],outputs:[],category:""}),i=He(()=>e.selectedNodeParams),r=He(()=>zl[n.value.category]?.color||"#888");function o(a,l){e.selectedNodeId&&e.setParam(e.selectedNodeId,a,l)}function s(a,l){return l==="int"?Math.round(a).toString():typeof a=="number"?a.toFixed(3):String(a)}return(a,l)=>(Se(),Ce("div",$U,[me(e).selectedNode?(Se(),Ce(ft,{key:0},[ge("div",WU,[ge("div",{class:"flow-node__category-dot",style:It({background:r.value})},null,4),ge("span",XU,Ze(n.value.label),1),ge("span",YU,Ze(n.value.type),1)]),Object.keys(n.value.params).length>0?(Se(),Ce("div",qU,[l[0]||(l[0]=ge("div",{class:"param-panel__section-title"},"Parameters",-1)),(Se(!0),Ce(ft,null,Sn(n.value.params,(c,u)=>(Se(),Ce("div",{key:u,class:"param-field"},[ge("div",KU,[ge("label",ZU,Ze(c.label),1),c.type==="float"||c.type==="int"?(Se(),Ce("button",{key:0,class:Gt(["param-field__expose-btn",{"param-field__expose-btn--active":me(e).isParamExposed(me(e).selectedNodeId,u)}]),onClick:f=>me(e).toggleExposeParam(me(e).selectedNodeId,u),title:me(e).isParamExposed(me(e).selectedNodeId,u)?"Unexpose input":"Expose as input handle"},Ze(me(e).isParamExposed(me(e).selectedNodeId,u)?"🔗":"⊕"),11,jU)):lt("",!0)]),c.type==="float"||c.type==="int"?(Se(),Ce(ft,{key:0},[ge("input",{type:"range",class:"param-field__input",min:c.min,max:c.max,step:c.step,value:i.value[u]??c.default,onInput:f=>o(u,c.type==="int"?parseInt(f.target.value):parseFloat(f.target.value))},null,40,JU),ge("div",QU,[ge("span",null,Ze(c.min),1),ge("input",{type:"number",class:"param-field__number-input mono",step:c.step,value:s(i.value[u]??c.default,c.type),onChange:f=>o(u,c.type==="int"?parseInt(f.target.value):parseFloat(f.target.value))},null,40,eF),ge("span",null,Ze(c.max),1)])],64)):c.type==="select"?(Se(),Ce("select",{key:1,class:"param-field__input",value:i.value[u]??c.default,onChange:f=>o(u,f.target.value)},[(Se(!0),Ce(ft,null,Sn(c.options,f=>(Se(),Ce("option",{key:f,value:f},Ze(f),9,nF))),128))],40,tF)):c.type==="bool"?(Se(),Ce("label",iF,[ge("input",{type:"checkbox",checked:i.value[u]??c.default,onChange:f=>o(u,f.target.checked)},null,40,rF),ge("span",null,Ze(c.label),1)])):c.type==="string"?(Se(),Ce("input",{key:3,type:"text",class:"param-field__input",value:i.value[u]??c.default,onInput:f=>o(u,f.target.value)},null,40,oF)):lt("",!0)]))),128))])):lt("",!0),ge("div",sF,[l[5]||(l[5]=ge("div",{class:"param-panel__section-title"},"Info",-1)),ge("div",aF,[l[1]||(l[1]=ge("span",{class:"param-field__label"},"ID",-1)),ge("span",lF,Ze(me(e).selectedNodeId),1)]),ge("div",cF,[l[2]||(l[2]=ge("span",{class:"param-field__label"},"Category",-1)),ge("span",uF,Ze(n.value.category),1)]),ge("div",fF,[l[3]||(l[3]=ge("span",{class:"param-field__label"},"Inputs",-1)),ge("span",dF,Ze(n.value.inputs.length),1)]),ge("div",hF,[l[4]||(l[4]=ge("span",{class:"param-field__label"},"Outputs",-1)),ge("span",pF,Ze(n.value.outputs.length),1)])])],64)):(Se(),Ce("div",mF," Select a node to edit its parameters "))]))}},vF=`// Passthrough — renders texture as-is\r
...
`,_F=`// Reeded Glass — ribbed/fluted glass refraction\r
precision highp float;\r
varying vec2 vUv;\r
...
`,xF=`// Chromatic Aberration — RGB channel offset\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
uniform float uIntensity;\r
...
`,yF=`// Heightmap Displacement — displace pixels using a heightmap image\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,bF=`// Levels — shadows/midtones/highlights per-channel adjustment\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,SF=`// Surface Blur — edge-preserving bilateral filter approximation\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,MF=`// Blend — combine two images with blend modes\r
precision highp float;\r
varying vec2 vUv;\r
...
`,EF=`// Feedback Loop — blend current frame with previous frame\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,wF=`// UV Generator — outputs UV coordinates as color (R=U, G=V)\r
precision highp float;\r
varying vec2 vUv;\r
\r
void main() {\r
...
`,TF=`// UV Transform — scale, rotate, translate UVs\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,AF=`// UV Repeat — tile image with mirror/offset options\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,CF=`// UV Glitch — random block displacement of UV coordinates\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,RF=`// UV Polar — cartesian to polar and polar to cartesian conversion\r
precision highp float;\r
varying vec2 vUv;\r
uniform sampler2D uIn;\r
...
`,FF={passthrough:vF,reededGlass:_F,chromaticAberration:xF,displacement:yF,levels:bF,surfaceBlur:SF,blend:MF,feedback:EF,uvGenerator:wF,uvTransform:TF,uvRepeat:AF,uvGlitch:CF,uvPolar:RF,diffusion:PF,xerox:IF,crt:NF,motionBlur:DF,dithering:LF},ug=20;class OF{constructor(){this.renderer=null,this.scene=null,this.camera=null,this.quad=null,this.fbos={},this.materials={},this.textures={},this.feedbackFBOs={},this.width=512,this.height=512,this.isInitialized=!1}init(e,n,i){this.width=n||512,this.height=i||512,this.renderer=new BT({canvas:e,alpha:!0,preserveDrawingBuffer:!0,antialias:!1}),this.renderer.setSize(this.width,this.height),this.renderer.autoClear=!1,this.camera=new jd(-1,1,1,-1,0,1);const r=new pa(2,2);this.scene=new ES,this.quad=new _i(r,null),this.scene.add(this.quad),this.isInitialized=!0}resize(e,n){this.width=e,this.height=n,this.renderer&&this.renderer.setSize(e,n);for(const[i,r]of Object.entries(this.fbos))r.setSize(e,n);for(const[i,r]of Object.entries(this.feedbackFBOs))r.current.setSize(e,n),r.previous.setSize(e,n)}setInputTexture(e,n){n.colorSpace=Cr,n.minFilter=Ft,n.magFilter=Ft,this.textures[e]=n}getOrCreateFBO(e){if(this.fbos[e])return this.fbos[e];if(Object.keys(this.fbos).length>=ug)return console.warn(`Max FBO count (${ug}) reached. Cannot create FBO for node ${e}`),null;const n=new wn(this.width,this.height,{minFilter:Ft,magFilter:Ft,format:Mn,type:pn,colorSpace:Cr});return this.fbos[e]=n,n}getOrCreateFeedbackFBOs(e){if(this.feedbackFBOs[e])return this.feedbackFBOs[e];const n={minFilter:Ft,magFilter:Ft,format:Mn,type:pn};return this.feedbackFBOs[e]={current:new wn(this.width,this.height,n),previous:new wn(this.width,this.height,n)},this.feedbackFBOs[e]}getOrCreateMaterial(e,n,i){const r=FF[n];if(!r)return this.getOrCreateMaterial(e,"passthrough",i);if(this.materials[e]&&this.materials[e]._shaderKey===n){const a=this.materials[e];let l=!1;for(const[c,u]of Object.entries(i))a.uniforms[c]?a.uniforms[c].value=u:(a.uniforms[c]={value:u},l=!0);return l&&(a.needsUpdate=!0),a}this.materials[e]&&this.materials[e].dispose();const o={};for(const[a,l]of Object.entries(i))o[a]={value:l};const s=new qn({vertexShader:UF,fragmentShader:r,uniforms:o,depthTest:!1,depthWrite:!1});return s._shaderKey=n,this.materials[e]=s,s}renderNode(e,n,i){this.quad.material=n,i?this.renderer.setRenderTarget(i):this.renderer.setRenderTarget(null),this.renderer.clear(),this.renderer.render(this.scene,this.camera)}removeNodeResources(e){this.fbos[e]&&(this.fbos[e].dispose(),delete this.fbos[e]),this.materials[e]&&(this.materials[e].dispose(),delete this.materials[e]),this.textures[e]&&(this.textures[e].dispose(),delete this.textures[e]),this.feedbackFBOs[e]&&(this.feedbackFBOs[e].current.dispose(),this.feedbackFBOs[e].previous.dispose(),delete this.feedbackFBOs[e])}execute(e,n,i,r,o,s,a){if(!this.isInitialized||!this.renderer)return;const l={};for(const h of n)l[h.id]=h;const c={};for(const h of i)c[h.target]||(c[h.target]=[]),c[h.target].push({sourceNodeId:h.source,sourceHandle:h.sourceHandle,targetHandle:h.targetHandle});let u=null;const f={};for(const h of e){const g=l[h];if(!g)continue;const _=si(g.type);if(!_)continue;const m=r[h]||{};if(g.type==="imageInput"||g.type==="imageOutput"||g.type==="pixelSort")continue;if(m._bypass){const y=c[h]||[];for(const w of y){const H=l[w.sourceNodeId];if(!H)continue;let N=null;if(H.type==="imageInput"?N=this.textures[w.sourceNodeId]||null:this.fbos[w.sourceNodeId]&&(N=this.fbos[w.sourceNodeId].texture),N){const I=this.getOrCreateFBO(h);if(I){const q=this.getOrCreateMaterial(h,"passthrough",{uTexture:N});this.renderNode(h,q,I),u=I}break}}f[h]=0;continue}const p=c[h]||[],b={uTime:a,uResolution:new St(this.width,this.height)};let v=!1;for(const y of p){const w=l[y.sourceNodeId];if(!w||!si(w.type))continue;let N=null;if(w.type==="imageInput"?N=this.textures[y.sourceNodeId]||null:this.fbos[y.sourceNodeId]&&(N=this.fbos[y.sourceNodeId].texture),N&&(v=!0,_.inputs.find(q=>q.id===y.targetHandle))){const q="u"+y.targetHandle.charAt(0).toUpperCase()+y.targetHandle.slice(1);b[q]=N,b[q+"Connected"]=!0}if(o[y.sourceNodeId]){const I=o[y.sourceNodeId][y.sourceHandle];if(I!==void 0){const q=_.inputs.find(L=>L.id===y.targetHandle),M=!q&&_.params[y.targetHandle];(q||M)&&(m[y.targetHandle]=I)}}}if(!v&&_.inputs.some(y=>y.type==="image"))continue;for(const[y,w]of Object.entries(m)){const H=_.params[y];if(!H)continue;const N="u"+y.charAt(0).toUpperCase()+y.slice(1);if(H.type==="float"||H.type==="int")b[N]=Number(w);else if(H.type==="bool")b[N]=w?1:0;else if(H.type==="select"){const I=H.options||[];b[N]=I.indexOf(w)}}if(g.type==="feedbackLoop"){const y=this.getOrCreateFeedbackFBOs(h);b.uPreviousFrame=y.previous.texture,b.uDecay=m.decay??.9,b.uBlendMode=["normal","add","multiply"].indexOf(m.blendMode??"normal");const w=this.getOrCreateMaterial(h,"feedback",b),H=Math.min(m.iterations??1,100);for(let N=0;N<H;N++){this.renderNode(h,w,y.current);const I=y.previous;y.previous=y.current,y.current=I,w.uniforms.uPreviousFrame.value=y.previous.texture}this.fbos[h]=y.previous,u=y.previous;continue}const x=_.shaderKey;if(!x)continue;const D=this.getOrCreateFBO(h);if(!D)continue;const O=performance.now(),U=this.getOrCreateMaterial(h,x,b);this.renderNode(h,U,D),f[h]=performance.now()-O,u=D}const d=s&&this.fbos[s]?this.fbos[s]:u;if(d){this.materials.__preview__&&(this.materials.__preview__.uniforms.uTexture.value=d.texture);const h=this.getOrCreateMaterial("__preview__","passthrough",{uTexture:d.texture});this.renderNode("__preview__",h,null)}return this.perfTimings=f,f}readPixels(e){const n=this.fbos[e];if(!n||!this.renderer)return null;const i=new Uint8Array(this.width*this.height*4);return this.renderer.readRenderTargetPixels(n,0,0,this.width,this.height,i),{pixels:i,width:this.width,height:this.height}}getNodeTexture(e){return this.textures[e]?this.textures[e]:this.fbos[e]?this.fbos[e].texture:null}removeNode(e){this.fbos[e]&&(this.fbos[e].dispose(),delete this.fbos[e]),this.materials[e]&&(this.materials[e].dispose(),delete this.materials[e]),this.textures[e]&&(this.textures[e].dispose(),delete this.textures[e]),this.feedbackFBOs[e]&&(this.feedbackFBOs[e].current.dispose(),this.feedbackFBOs[e].previous.dispose(),delete this.feedbackFBOs[e])}dispose(){for(const e of Object.values(this.fbos))e.dispose();for(const e of Object.values(this.materials))e.dispose();for(const e of Object.values(this.textures))e.dispose();for(const e of Object.values(this.feedbackFBOs))e.current.dispose(),e.previous.dispose();this.fbos={},this.materials={},this.textures={},this.feedbackFBOs={},this.renderer&&this.renderer.dispose()}}class BF{constructor(){this.isRunning=!1,this.startTime=0,this.lastTime=0,this.time=0,this.deltaTime=0,this.frameId=null,this.callbacks=[]}onFrame(e){return this.callbacks.push(e),()=>{this.callbacks=this.callbacks.filter(n=>n!==e)}}start(){this.isRunning||(this.isRunning=!0,this.startTime=performance.now()/1e3,this.lastTime=this.startTime,this._tick())}stop(){this.isRunning=!1,this.frameId!==null&&(cancelAnimationFrame(this.frameId),this.frameId=null)}reset(){this.startTime=performance.now()/1e3,this.time=0,this.deltaTime=0}_tick(){if(!this.isRunning)return;const e=performance.now()/1e3;this.deltaTime=e-this.lastTime,this.time=e-this.startTime,this.lastTime=e;for(const n of this.callbacks)n(this.time,this.deltaTime);this.frameId=requestAnimationFrame(()=>this._tick())}}let al=null,Sr=null,wl=null,bd=!1;function G_(){if(!al)try{const t=window.AudioContext||window.webkitAudioContext;al=new t,Sr=al.createAnalyser(),Sr.fftSize=512,Sr.smoothingTimeConstant=.8,wl=new Uint8Array(Sr.frequencyBinCount),navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(e=>{al.createMediaStreamSource(e).connect(Sr),bd=!0}).catch(e=>console.warn("Audio FFT access denied or error:",e))}catch(t){console.warn("Audio context not supported",t)}}function kF(t,e){const n={},i={};for(const s of t)n[s.id]=0,i[s.id]=[];for(const s of e)i[s.source]&&(i[s.source].push(s.target),n[s.target]=(n[s.target]||0)+1);const r=[];for(const s of t)n[s.id]===0&&r.push(s.id);const o=[];for(;r.length>0;){const s=r.shift();o.push(s);for(const a of i[s]||[])n[a]--,n[a]===0&&r.push(a)}return o.length!==t.length&&console.warn("Cycle detected in graph — some nodes skipped"),o}function zF(t,e,n){const i={};for(const r of e)if(r.target===t){const o=n[r.source];o&&(i[r.targetHandle]={sourceNodeId:r.source,sourceHandleId:r.sourceHandle,value:o[r.sourceHandle]})}return i}function VF(t,e,n,i,r,o){const s={};for(const l of e)s[l.id]=l;const a={};for(const l of t){const c=s[l];if(!c)continue;const u=si(c.type);if(!u||u.category==="image"||u.category==="uv"||c.type==="preview")continue;const f=i[l]||{},d=zF(l,n,a),h={};switch(c.type){case"lfo":{const g=f.frequency??1,_=f.amplitude??1,m=f.offset??0,p=(f.phase??0)*Math.PI/180,b=r*g*Math.PI*2+p,v=f.waveform??"sine";let x=0;v==="sine"?x=Math.sin(b):v==="saw"?x=2*(b/(Math.PI*2)%1)-1:v==="square"?x=Math.sin(b)>=0?1:-1:v==="triangle"&&(x=2*Math.abs(2*(b/(Math.PI*2)%1)-1)-1),h.out=x*_+m;break}case"timer":{const g=f.speed??1,_=f.loop??!1,m=f.loopDuration??5;let p=r*g;_&&m>0&&(p=p%m),h.out=p;break}case"random":{const g=f.min??0,_=f.max??1,m=f.seed??42,p=Math.sin(m+r*100)*43758.5453,b=p-Math.floor(p);h.out=g+b*(_-g);break}case"damper":{const g=d.target?.value??0,_=f.smoothing??.9,m=c._damperValue??g,p=m+(g-m)*(1-_);c._damperValue=p,h.out=p;break}case"fft":{bd||G_();const g=f.smoothing??.8,_=f.gain??1;if(bd&&Sr&&wl){Sr.smoothingTimeConstant=g,Sr.getByteFrequencyData(wl);let m=0,p=0,b=0,v=0;for(let x=0;x<256;x++){const D=wl[x]/255;x<=10?m+=D:x<=50?p+=D:x<=120?b+=D:v+=D}h.bass=Math.min(m/11*_,1),h.lowMid=Math.min(p/40*_,1),h.mid=Math.min(b/70*_,1),h.high=Math.min(v/135*_,1)}else h.bass=0,h.lowMid=0,h.mid=0,h.high=0;break}case"button":case"bang":{h.out=c._triggered?1:0,c._triggered=!1;break}case"toggle":{h.out=f.state?1:0;break}case"edgeTrigger":{const g=d.in?.value??!1,_=c._prevEdgeVal??!1,m=f.mode??"rising";let p=!1;m==="rising"&&!_&&g&&(p=!0),m==="falling"&&_&&!g&&(p=!0),m==="both"&&_!==g&&(p=!0),h.out=p?1:0,c._prevEdgeVal=g;break}case"slider":case"knob":{const g=f.value??.5,_=f.outputType??"float";h.out=_==="int"?Math.round(g):g;break}case"compare":{const g=d.a?.value??0,_=d.b?.value??0,m=f.op??">";let p=!1;switch(m){case">":p=g>_;break;case"<":p=g<_;break;case">=":p=g>=_;break;case"<=":p=g<=_;break;case"==":p=g===_;break;case"!=":p=g!==_;break}h.out=p;break}case"valueCondition":{const g=d.cond?.value??!1,_=d.trueVal?.value??f.defaultTrue??1,m=d.falseVal?.value??f.defaultFalse??0;h.out=g?_:m;break}case"mathAdd":{const g=d.a?.value??0,_=d.b?.value??0;h.out=g+_;break}case"mathMultiply":{const g=d.a?.value??0,_=d.b?.value??1;h.out=g*_;break}case"mathDivide":{const g=d.a?.value??0,_=d.b?.value??1;h.out=_!==0?g/_:0;break}case"mathSqrt":{const g=d.a?.value??0;h.out=Math.sqrt(Math.abs(g));break}case"mathMap":{const g=d.value?.value??0,_=f.inMin??0,m=f.inMax??1,p=f.outMin??0,b=f.outMax??1,v=m!==_?(g-_)/(m-_):0;h.out=p+v*(b-p);break}case"mathClamp":{const g=d.value?.value??0,_=f.min??0,m=f.max??1;h.out=Math.min(Math.max(g,_),m);break}case"mathWrap":{const g=d.value?.value??0,_=f.min??0,p=(f.max??1)-_;if(p<=0){h.out=_;break}h.out=_+((g-_)%p+p)%p;break}case"floatToInt":{const g=d.in?.value??0,_=f.mode??"round";let m;_==="floor"?m=Math.floor(g):_==="ceil"?m=Math.ceil(g):_==="truncate"?m=Math.trunc(g):m=Math.round(g);const p=f.clampMin??-2147483648,b=f.clampMax??2147483647;h.out=Math.min(Math.max(m,p),b);break}case"intToFloat":{h.out=Number(d.in?.value??0);break}case"numberMonitor":{h.out=d.in?.value??0;break}}a[l]=h}return a}function HF(t,e){const n={};for(const i of e)n[i.id]=i;return t.filter(i=>{const r=n[i];if(!r)return!1;const o=si(r.type);return o?o.category==="image"||o.category==="uv":!1})}const GF={id:"app"},$F={class:"main-layout"},WF={class:"editor-area"},XF={class:"preview-background"},YF={__name:"App",setup(t){const e=xh(),n=Ke(null),i=Ke(null),r=Ke(null);function o(){G_(),window.removeEventListener("click",o),window.removeEventListener("keydown",o)}let s=null,a=null,l=null;const c=Ke(0);let u=0,f=0;const d={};let h=null;Kn(async()=>{await In(),window.addEventListener("click",o),window.addEventListener("keydown",o);const O=i.value?.getCanvas?.();O&&(s=new OF,s.init(O,512,512)),r.value&&(h=r.value.getContext("2d")),e.onNodeRemoved(U=>{s&&s.removeNodeResources(U),delete d[U]}),f=performance.now(),a=new BF,l=a.onFrame((U,y)=>{if(!e.isRendering)return;u++;const w=performance.now();w-f>=500&&(c.value=Math.round(u/(w-f)*1e3),u=0,f=w),g(U)}),a.start(),e.loadFromLocalStorage()}),ca(()=>{l&&l(),a&&a.stop(),s&&s.dispose()});function g(O,U){if(!s?.isInitialized)return;const y=e.nodes,w=e.edges,H=e.nodeParams;if(y.length===0)return;const N=kF(y,w),I=VF(N,y,w,H,O);e.dataOutputs=I;const q=HF(N,y),M=s.execute(q,y,w,H,I,e.previewNodeId,O);if(e.perfTimings=M||{},e.previewMode==="background"&&h&&r.value){const L=i.value?.getCanvas?.();L&&L.width>0&&L.height>0&&(r.value.width=L.width,r.value.height=L.height,h.drawImage(L,0,0))}}function _(O){if(n.value&&n.value.addNodeAtCenter)n.value.addNodeAtCenter(O);else{const U=300+Math.random()*200,y=200+Math.random()*200;e.addNode(O,{x:U,y})}}function m(O,U){if(!s)return;d[O]=U;const y=new an(U.img);y.needsUpdate=!0,s.setInputTexture(O,y),s.resize(U.width,U.height),i.value&&(i.value.width=U.width,i.value.height=U.height)}function p(O){if(!s)return;const U=e.edges.filter(X=>X.target===O);let y=null;for(const X of U)if(X.targetHandle==="in"){y=X.source;break}if(!y){alert("No image connected to output node");return}const w=s.readPixels(y);if(!w){alert("Could not read pixels — make sure an image is connected and the pipeline has run");return}const{pixels:H,width:N,height:I}=w,M=(e.nodeParams[O]||{}).filename||e.projectTitle||"output",L=document.createElement("canvas");L.width=N,L.height=I;const T=L.getContext("2d"),C=T.createImageData(N,I);for(let X=0;X<I;X++)for(let k=0;k<N;k++){const Y=((I-1-X)*N+k)*4,j=(X*N+k)*4;C.data[j]=H[Y],C.data[j+1]=H[Y+1],C.data[j+2]=H[Y+2],C.data[j+3]=H[Y+3]}T.putImageData(C,0,0);const V=M.replace(/[^a-zA-Z0-9_-]/g,"_");L.toBlob(X=>{if(!X)return;const k=URL.createObjectURL(X),Y=document.createElement("a");Y.href=k,Y.download=`${V}.png`,Y.click(),URL.revokeObjectURL(k)},"image/png")}function b(){e.saveToLocalStorage()}function v(){e.loadFromLocalStorage()||alert("No saved graph found")}function x(O){e.loadGraph(O)||alert("Failed to import graph — invalid JSON")}function D(){confirm("Clear entire graph? This cannot be undone.")&&(e.resetGraph(),Object.keys(d).forEach(O=>delete d[O]))}return(O,U)=>(Se(),Ce("div",GF,[st($T,{"is-rendering":me(e).isRendering,"preview-mode":me(e).previewMode,"project-title":me(e).projectTitle,onSave:b,onLoad:v,onDownload:U[0]||(U[0]=y=>me(e).downloadGraph()),onImport:x,onReset:D,onToggleRender:U[1]||(U[1]=y=>me(e).toggleRendering()),onTogglePreview:U[2]||(U[2]=y=>me(e).togglePreviewMode()),onUpdateTitle:U[3]||(U[3]=y=>me(e).projectTitle=y)},null,8,["is-rendering","preview-mode","project-title"]),ge("div",$F,[st(nA,{onAddNode:_}),ge("div",WF,[Lh(ge("div",XF,[ge("canvas",{ref_key:"bgCanvasRef",ref:r},null,512)],512),[[Zh,me(e).previewMode==="background"]]),st(DU,{ref_key:"editorRef",ref:n,onImageLoaded:m,onExportImage:p},null,512),Lh(st(GU,{ref_key:"previewRef",ref:i,"is-rendering":me(e).isRendering,fps:c.value},null,8,["is-rendering","fps"]),[[Zh,me(e).previewMode==="panel"]])]),st(gF)])]))}},$_=vb(YF);$_.use(yb());$_.mount("#app");
